...
27 个 App-in-Skill 工作流 —— 每个都是一份 agent 操作手册，配一个本地浏览器 UI 用于 review、审批和看板。
...
[![Skills](https://img.shields.io/badge/skills-27-D97757)](https://mr-kelly.github.io/skills/?lang=zh)
