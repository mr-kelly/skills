...
| `kelly-portrait-retouch` | Retouches portraits naturally with a local face-aware CLI, non-destructive candidates, metadata stripping, before/after proofs, and a Busabase-backed review desk. | Use it for 美颜, portrait cleanup, profile-photo polish, subtle skin smoothing, headshot refinement, or batch candidate review without changing identity or overwriting originals. | [View ↗](https://mr-kelly.github.io/skills/s/kelly-portrait-retouch.html) |
...
<table>
  ...
  <tr>
    <td><strong>Next-action review</strong><br>Review an evidence-backed relationship move, edit guidance, and decide whether it is ready, needs revision, should wait, or is done.</td>
