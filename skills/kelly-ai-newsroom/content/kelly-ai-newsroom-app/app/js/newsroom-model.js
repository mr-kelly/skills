// Pure, storage-agnostic domain logic for kelly-ai-newsroom — no fs, no
...
export function parseBatchMeta(payload = "") {
  ...
  return {
    ...
    source: meta.source || "kelly-ai-newsroom",
    vertical: meta.vertical || "AI/news-source intelligence",
    buyer: meta.buyer || "",
    offer: meta.offer || "",
  };
}
