...
export const APP_NAME = "kelly-ai-newsroom";
export const DISPLAY_NAME = "Kelly AI Newsroom";
export const DEFAULT_HOST = "127.0.0.1";
export const DEFAULT_PORT = Number.parseInt(process.env.KELLY_AI_NEWSROOM_UI_PORT || process.env.PORT || "3000", 10);
