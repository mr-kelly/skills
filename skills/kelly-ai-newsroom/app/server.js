...
const AIRAPP_ID = "kelly-ai-newsroom";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-ai-newsroom" }));
...
app.onError((error, context) => {
  console.error("Kelly AI Newsroom server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3169", 10);
