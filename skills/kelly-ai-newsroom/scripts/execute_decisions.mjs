...
import { operationForDecision } from "../content/kelly-ai-newsroom-app/app/js/newsroom-model.js";
...
async function markDone(client, existing, fields, message) {
  return client.records.changeRequest({
    ...
    message,
    author: "kelly-ai-newsroom-execute-decisions",
...
async function main() {
  ...
  if (!resources.folder || resources.missing.length) {
    throw new Error("Kelly AI Newsroom Busabase resources are not provisioned yet; run the AirApp setup first.");
  }
