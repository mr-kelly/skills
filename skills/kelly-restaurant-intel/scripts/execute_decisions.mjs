...
import { operationForDecision } from "../content/kelly-restaurant-intel-app/app/js/restaurant-model.js";
...
async function markDone(client, existing, fields, message) {
  return client.records.changeRequest({
    ...
    message,
    author: "kelly-restaurant-intel-execute-decisions",
...
async function main() {
  ...
  if (!resources.folder || resources.missing.length) {
    throw new Error("Kelly Restaurant Intel Busabase resources are not provisioned yet; run the AirApp setup first.");
  }
