// Pure, storage-agnostic domain logic for kelly-restaurant-intel — no
...
export function parseBatchMeta(payload = "") {
  ...
  return {
    ...
    source: meta.source || "kelly-restaurant-intel",
    vertical: meta.vertical || "restaurants, cafes, and F&B groups",
    buyer: meta.buyer || "",
    offer: meta.offer || "",
  };
}
