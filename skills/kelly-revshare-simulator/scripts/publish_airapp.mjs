#!/usr/bin/env node
// Push this skill's current local content/kelly-revshare-simulator-app/ code to its deployed AirApp: creates it
...
// change takes effect. Use this after editing content/kelly-revshare-simulator-app/ files; scripts/setup.mjs
