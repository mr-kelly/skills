...
const AIRAPP_ID = "kelly-revshare-simulator";
...
app.onError((error, context) => {
  console.error("Kelly Revenue-Share Simulator server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3167", 10);
