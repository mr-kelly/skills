...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Revenue-Share Simulator must be Cloud-only");
if (/KELLY_REVSHARE_SIMULATOR_CONFIG|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Revenue-Share Simulator AirApp checks OK (${files.length} files)`);
