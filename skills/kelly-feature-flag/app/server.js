...
const AIRAPP_ID = "kelly-feature-flag";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-feature-flag" }));
...
app.onError((error, context) => {
  console.error(
    "Feature Flag Governance & Rollout Safety Desk server error",
