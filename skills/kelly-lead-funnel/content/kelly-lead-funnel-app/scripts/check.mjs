...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Lead Funnel must be Cloud-only");
if (/KELLY_LEAD_FUNNEL_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Lead Funnel AirApp checks OK (${files.length} files)`);
