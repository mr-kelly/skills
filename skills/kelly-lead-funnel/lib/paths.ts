...
// Shared path constants. lib/ sits directly under the skill root, so one
// ".." resolves to SKILL_DIR regardless of which module imports this file.
...
export const HANDOFF_LOG_PATH = path.join(DATA_DIR, "handoff_log.json");
