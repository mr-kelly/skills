...
const AIRAPP_ID = "kelly-agent-eval";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-agent-eval" }));
...
app.onError((error, context) => {
  console.error("Kelly Agent Eval server error", error instanceof Error ? error.message : error);
