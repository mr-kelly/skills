...
const SKILL_NAME = "kelly-ideas";
const ACCENTS = ["#0f766e", "#4f46e5"];
const VISUAL_DEFS = [
  {
    id: "kelly-ideas-visual-1",
    title: "Idea vault",
    caption: "Synthetic ideas at every rung of the ladder.",
    kind: "profile",
  },
  {
    id: "kelly-ideas-visual-2",
    title: "Consultant questions",
    caption: "Mock interrogation trail: question, why it was asked, answer.",
    kind: "timeline",
  },
  {
    id: "kelly-ideas-visual-3",
    title: "BRD / MRD / PRD",
    caption: "Visual document card produced once the rung above is answered.",
    kind: "document",
  },
];
