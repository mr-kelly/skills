...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-ideas" }));
...
app.onError((error, context) => {
  console.error("kelly-ideas server error", error instanceof Error ? error.message : error);
