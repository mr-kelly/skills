#!/usr/bin/env node
// Structural sanity check for a Kelly Ideas snapshot object (the shape
// content/kelly-ideas-app/app/js/ideas-model.js#buildSnapshot() returns). Useful before writing
