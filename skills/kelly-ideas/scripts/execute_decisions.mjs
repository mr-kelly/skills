#!/usr/bin/env node
// Trusted hand-off step. Kelly Ideas's AirApp only ever proposes a review
...
async function main() {
  ...
  if (!resources.folder || resources.missing.length) {
    throw new Error("Kelly Ideas Busabase resources are not provisioned yet; run the AirApp setup first.");
  }
