...
const AIRAPP_ID = "kelly-lab-lims";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-lab-lims" }));
...
app.onError((error, context) => {
  console.error("Clinical Laboratory LIMS Sample Desk server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "33305", 10);
