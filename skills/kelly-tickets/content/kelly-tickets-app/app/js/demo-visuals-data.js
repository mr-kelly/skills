...
// verbatim (same shape, same motif SVG technique) from the retired
// app/server/demo-visuals.ts pattern used across Kelly App-in-Skills; only
// the Hono response-middleware plumbing was dropped, since the new
// architecture pushes visuals to demo-visuals.js via a CustomEvent instead
// of augmenting a JSON response.
const SKILL_NAME = "kelly-tickets";
const ACCENTS = ["#dc2626", "#0f766e"];
const VISUAL_DEFS = [
  {
    id: "kelly-tickets-visual-1",
    title: "WeChat intake export",
    caption: "Synthetic WeChat group export with a raw complaint thread.",
    kind: "document",
  },
  {
    id: "kelly-tickets-visual-2",
    title: "Site photo",
    caption: "Mock site photo attached to a plumbing complaint.",
    kind: "receipt",
  },
  {
    id: "kelly-tickets-visual-3",
    title: "SLA board",
    caption: "Simulated ticket board with SLA risk indicators.",
    kind: "chart",
  },
];
