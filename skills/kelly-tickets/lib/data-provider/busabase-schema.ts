...
export const BUSABASE_SCHEMA = {
  provider: "busabase",
  schema_id: "kelly-tickets.storage",
  schema_version: "1",
  folder: {
    default_slug: "kelly-tickets-workspace",
    children: ["base", "drive"],
  },
  base: {
    id: "kelly-tickets",
    slug: "kelly-tickets",
    name: "Kelly Tickets Records",
    fields: [
      "record_id",
      "kind",
      "title",
  ...
  related_bases: [],
  drive: {
    id: "kelly-tickets-files",
    slug: "kelly-tickets-workspace-files",
