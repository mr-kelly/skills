...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Tickets must be Cloud-only");
if (/KELLY_TICKETS_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Tickets AirApp checks OK (${files.length} files)`);
