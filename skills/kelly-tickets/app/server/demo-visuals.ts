...
const ACCENTS = ["#7c3aed", "#2563eb"];
const VISUAL_DEFS = [
  {
    id: "kelly-tickets-visual-1",
    title: "Intake screenshot",
    caption: "Synthetic intake request with extracted category and urgency.",
    kind: "document",
  },
  {
    id: "kelly-tickets-visual-2",
    title: "Dispatch board",
    caption: "Mock routing proposal with team and SLA assignment.",
    kind: "board",
  },
  {
    id: "kelly-tickets-visual-3",
    title: "Kanban board",
    caption: "Visual ticket board with priority and blocked states.",
    kind: "dashboard",
  },
];
