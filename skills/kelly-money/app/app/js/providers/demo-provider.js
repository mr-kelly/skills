...
function demoSnapshot(scenario) {
  ...
  return {
    ...
    invoice_matches: demoInvoiceMatches(),
  ...
  async getState() {
    ...
    return {
      ...
      config_summary: {
        ...
        is_example: false,
        accounts: snapshot.accounts.map((acct) => ({
          account_id: acct.account_id,
          provider: acct.provider,
          display_name: acct.display_name,
          entity: acct.entity,
          currency: acct.currency,
          secret_envs: [`KELLY_MONEY_${acct.provider.toUpperCase()}_API_KEY_DEMO`],
          secrets_ready: true,
        })),
      },
      demo_visuals: demoVisualsForApp("kelly-money"),
      snapshot: { ...snapshot, demo_visuals: demoVisualsForApp("kelly-money") },
    };
  },
