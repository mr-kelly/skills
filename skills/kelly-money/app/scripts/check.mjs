...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Money must be Cloud-only");
if (/KELLY_MONEY_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Money AirApp checks OK (${files.length} files)`);
