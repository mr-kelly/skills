...
export const BUSABASE_SCHEMA = {
  provider: "busabase",
  schema_id: "kelly-family-fund.storage",
  schema_version: "1",
  folder: {
    default_slug: "kelly-family-fund-workspace",
    children: ["base", "drive"],
  },
  base: {
    id: "kelly-family-fund",
    slug: "kelly-family-fund",
    name: "Kelly Family Fund Records",
    fields: [
      "record_id",
      "kind",
      "title",
  ...
  related_bases: [],
  drive: {
    id: "kelly-family-fund-files",
    slug: "kelly-family-fund-workspace-files",
