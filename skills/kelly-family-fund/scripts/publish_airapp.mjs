#!/usr/bin/env node
// Push this skill's current local content/kelly-family-fund-app/ code to its deployed AirApp: creates it
...
// change takes effect. Use this after editing content/kelly-family-fund-app/ files; scripts/setup.mjs
