...
const AIRAPP_ID = "kelly-family-fund";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-family-fund" }));
...
app.onError((error, context) => {
  console.error("Kelly Family Fund server error", error instanceof Error ? error.message : error);
