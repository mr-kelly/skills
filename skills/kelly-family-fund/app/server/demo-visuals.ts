...
const SKILL_NAME = "kelly-family-fund";
const ACCENTS = ["#16a34a", "#2563eb"];
const VISUAL_DEFS = [
  {
    id: "kelly-family-fund-visual-1",
    title: "Allocation view",
    caption: "Synthetic family allocation snapshot by goal and category.",
    kind: "chart",
  },
  {
    id: "kelly-family-fund-visual-2",
    title: "Ledger receipt",
    caption: "Mock reimbursement receipt tied to a reviewed ledger row.",
    kind: "receipt",
  },
  {
    id: "kelly-family-fund-visual-3",
    title: "Family goal card",
    caption: "Visual savings goal with owner, cadence, and variance.",
    kind: "profile",
  },
];
