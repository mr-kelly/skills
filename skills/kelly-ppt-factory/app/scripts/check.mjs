...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly PPT Factory must be Cloud-only");
if (/KELLY_PPT_FACTORY_CONFIG|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly PPT Factory AirApp checks OK (${files.length} files)`);
