...
const AIRAPP_ID = "kelly-higher-ed-admissions";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-higher-ed-admissions" }));
...
app.onError((error, context) => {
  console.error("University Admissions Recruitment Desk server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "33297", 10);
