...
// of augmenting a JSON response. Only the "chart", "dashboard", and
// "document" (default) motifs are kept — the only kinds this skill's
// VISUAL_DEFS uses.
const SKILL_NAME = "kelly-legal-firm-radar";
const ACCENTS = ["#334155", "#0f766e"];
const VISUAL_DEFS = [
  {
    id: "kelly-legal-firm-radar-visual-1",
    title: "Matter map",
    caption: "Synthetic matter distribution by sector, court, and issue.",
    kind: "chart",
  },
  {
    id: "kelly-legal-firm-radar-visual-2",
    title: "Firm heatmap",
    caption: "Mock practice trend heatmap for radar review.",
    kind: "dashboard",
  },
  {
    id: "kelly-legal-firm-radar-visual-3",
    title: "Trend report",
    caption: "Visual research report page with safe aggregate examples.",
    kind: "document",
  },
];
