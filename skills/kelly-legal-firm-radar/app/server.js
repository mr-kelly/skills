...
const AIRAPP_ID = "kelly-legal-firm-radar";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-legal-firm-radar" }));
...
app.onError((error, context) => {
  console.error("Legal Firm Radar server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3161", 10);
