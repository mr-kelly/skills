...
if (!configText.includes('deployment: "cloud"')) throw new Error("Legal Firm Radar must be Cloud-only");
if (/KELLY_LEGAL_FIRM_RADAR_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Legal Firm Radar AirApp checks OK (${files.length} files)`);
