...
const AIRAPP_ID = "kelly-portfolio-health";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-portfolio-health" }));
...
app.onError((error, context) => {
  console.error("Portfolio Health server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3165", 10);
