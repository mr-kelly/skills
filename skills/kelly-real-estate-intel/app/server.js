...
const AIRAPP_ID = "kelly-real-estate-intel";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-real-estate-intel" }));
...
app.onError((error, context) => {
  console.error("Kelly Real Estate Intel server error", error instanceof Error ? error.message : error);
