// Pure, storage-agnostic domain logic for kelly-real-estate-intel — no
...
export function parseBatchMeta(payload = "") {
  ...
  return {
    ...
    source: meta.source || "kelly-real-estate-intel",
    vertical: meta.vertical || "real estate and property agencies",
    buyer: meta.buyer || "",
    offer: meta.offer || "",
  };
}
