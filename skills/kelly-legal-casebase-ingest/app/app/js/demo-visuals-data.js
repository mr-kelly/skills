...
// of augmenting a JSON response. Only the "document" (default), "board", and
// "sheet" motifs are kept — the only kinds this skill's VISUAL_DEFS uses.
const SKILL_NAME = "kelly-legal-casebase-ingest";
const ACCENTS = ["#1e40af", "#7c3aed"];
const VISUAL_DEFS = [
  {
    id: "kelly-legal-casebase-ingest-visual-1",
    title: "Case PDF scan",
    caption: "Synthetic judgment page with source and citation markers.",
    kind: "document",
  },
  {
    id: "kelly-legal-casebase-ingest-visual-2",
    title: "Entity graph",
    caption: "Mock parties, court, statute, and topic extraction map.",
    kind: "board",
  },
  {
    id: "kelly-legal-casebase-ingest-visual-3",
    title: "Dedupe queue",
    caption: "Visual near-duplicate cards prepared for review.",
    kind: "sheet",
  },
];
