...
if (!configText.includes('deployment: "cloud"')) throw new Error("Legal Casebase Ingest must be Cloud-only");
if (/KELLY_LEGAL_CASEBASE_INGEST_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Legal Casebase Ingest AirApp checks OK (${files.length} files)`);
