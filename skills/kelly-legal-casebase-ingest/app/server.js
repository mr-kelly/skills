...
const AIRAPP_ID = "kelly-legal-casebase-ingest";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-legal-casebase-ingest" }));
...
app.onError((error, context) => {
  console.error("Legal Casebase Ingest server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3160", 10);
