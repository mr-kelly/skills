...
const SKILL_NAME = "kelly-inquiry";
const ACCENTS = ["#dc2626", "#f59e0b"];
const VISUAL_DEFS = [
  {
    id: "kelly-inquiry-visual-1",
    title: "Product photo card",
    caption: "Synthetic SKU image, MOQ, and quote context.",
    kind: "gallery",
  },
  {
    id: "kelly-inquiry-visual-2",
    title: "Customer message",
    caption: "Mock buyer inquiry screenshot with extracted requirements.",
    kind: "mobile",
  },
  {
    id: "kelly-inquiry-visual-3",
    title: "Quote sheet",
    caption: "Visual quotation preview with price, freight, and margin bands.",
    kind: "sheet",
  },
];
