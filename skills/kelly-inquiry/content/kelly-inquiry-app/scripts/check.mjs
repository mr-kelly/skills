...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Inquiry must be Cloud-only");
if (/KELLY_INQUIRY_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Inquiry AirApp checks OK (${files.length} files)`);
