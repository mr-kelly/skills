// Core domain types shared across the kelly-inquiry data-provider layer, server,
// and scripts. These model the ACTUAL shapes produced by app/server/demo.ts and
// the local provider, and the normalized snapshot in references/inquiry-schema.md.
...
// kelly-inquiry base can serve the same review desk from a remote Busabase.
