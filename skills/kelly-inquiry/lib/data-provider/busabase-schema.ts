...
export const BUSABASE_SCHEMA = {
  provider: "busabase",
  schema_id: "kelly-inquiry.storage",
  schema_version: "1",
  folder: {
    default_slug: "kelly-inquiry-workspace",
    children: ["base", "drive"],
  },
  base: {
    id: "kelly-inquiry",
    slug: "kelly-inquiry",
    name: "Kelly Inquiry Records",
    fields: [
      "record_id",
      "kind",
      "title",
  ...
  related_bases: [],
  drive: {
    id: "kelly-inquiry-files",
    slug: "kelly-inquiry-workspace-files",
