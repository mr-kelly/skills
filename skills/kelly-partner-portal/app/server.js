...
const AIRAPP_ID = "kelly-partner-portal";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-partner-portal" }));
...
app.onError((error, context) => {
  console.error(
    "Channel Partner Portal & Deal Registration Desk server error",
