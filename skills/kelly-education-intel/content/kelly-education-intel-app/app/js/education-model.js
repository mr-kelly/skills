// Pure, storage-agnostic domain logic for kelly-education-intel — no fs, no
// network, safe in both the browser and the trusted skill-root script.
//
...
export function parseBatchMeta(payload = "") {
  ...
  return {
    ...
    source: meta.source || "kelly-education-intel",
    vertical: meta.vertical || "education, training, tutoring, and admissions services",
    buyer: meta.buyer || "",
    offer: meta.offer || "",
  };
}
