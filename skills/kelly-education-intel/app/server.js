...
const AIRAPP_ID = "kelly-education-intel";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-education-intel" }));
...
app.onError((error, context) => {
  console.error("Kelly Education Intel server error", error instanceof Error ? error.message : error);
