...
export const APP_NAME = "kelly-education-intel";
export const DISPLAY_NAME = "Kelly Education Intel";
export const DEFAULT_HOST = "127.0.0.1";
export const DEFAULT_PORT = Number.parseInt(
  process.env.KELLY_EDUCATION_INTEL_UI_PORT || process.env.PORT || "3000",
  10,
);
