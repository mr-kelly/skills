...
import { operationForDecision } from "../content/kelly-education-intel-app/app/js/education-model.js";
...
async function markDone(client, existing, fields, message) {
  return client.records.changeRequest({
    ...
    message,
    author: "kelly-education-intel-execute-decisions",
...
async function main() {
  ...
  if (!resources.folder || resources.missing.length) {
    throw new Error("Kelly Education Intel Busabase resources are not provisioned yet; run the AirApp setup first.");
  }
