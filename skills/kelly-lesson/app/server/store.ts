...
export async function readSnapshot(): Promise<LessonSnapshot> {
...
export async function applyDecision(payload: DecisionBody = {}): Promise<DecisionsFile> {
...
export async function readConfig(): Promise<ConfigResult> {
  for (const file of configSearchPaths()) {
    const config = await readJson<ConfigResult["config"]>(file, null);
