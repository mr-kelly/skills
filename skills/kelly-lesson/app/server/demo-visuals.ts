...
const SKILL_NAME = "kelly-lesson";
const ACCENTS = ["#ca8a04", "#2563eb"];
const VISUAL_DEFS = [
  {
    id: "kelly-lesson-visual-1",
    title: "Slide poster",
    caption: "Synthetic classroom slide with key concept and visual prompt.",
    kind: "gallery",
  },
  {
    id: "kelly-lesson-visual-2",
    title: "Worksheet preview",
    caption: "Mock student worksheet with differentiated tasks.",
    kind: "sheet",
  },
  {
    id: "kelly-lesson-visual-3",
    title: "Classroom activity",
    caption: "Visual lesson stage board with materials and timing.",
    kind: "board",
  },
];
