...
export const BUSABASE_SCHEMA = {
  provider: "busabase",
  schema_id: "kelly-lesson.storage",
  schema_version: "1",
  folder: {
    default_slug: "kelly-lesson-workspace",
    children: ["base", "drive"],
  },
  base: {
    id: "kelly-lesson",
    slug: "kelly-lesson",
    name: "Kelly Lesson Records",
    fields: [
      "record_id",
      "kind",
      "title",
  ...
  related_bases: [],
  drive: {
    id: "kelly-lesson-files",
    slug: "kelly-lesson-workspace-files",
