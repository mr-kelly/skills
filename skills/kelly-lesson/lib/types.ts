// Core domain types for the kelly-lesson data-provider layer, server, and
// scripts. These model the ACTUAL shapes flowing through the providers, demo.ts,
// and the ingest/check scripts, plus the lesson snapshot written to
// app/.data/lesson_snapshot.json.
...
// Aggregate payload returned by provider.getState() and served at /api/state.
