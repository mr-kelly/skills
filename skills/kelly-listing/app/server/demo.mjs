...
import { computeMetrics, evaluateDraft, ruleCatalog, scoreChecks } from "./rules.mjs";
  ...
  return [
    {
      ...
      locales: ["US", "DE"],
      specs: [
        { name: l("Material", "材质"), value: l("Food-grade silicone + BPA-free PP frame", "食品级硅胶 + 不含 BPA 的 PP 框架") },
      ...
      features: [
        l("Collapses to about one third of its height for bag-friendly storage", "可折叠至约三分之一高度，方便放入背包"),
      ...
      notes: l("Handoff brief from kelly-picks (pick #2, June batch).", "来自 kelly-picks 的交接简报（6 月批次选品 #2）。"),
    ...
    },
    {
      ...
      notes: l("Handoff brief from kelly-picks (pick #5, June batch).", "来自 kelly-picks 的交接简报（6 月批次选品 #5）。"),
      created_at: "2026-06-24T03:10:00.000Z",
  ...
  return [
    {
      ...
      fields: {
        title: "Nimbus Home Collapsible Silicone Lunch Box, 1.2L Leakproof 3-Compartment Bento Box with Folding Spork, Microwave Dishwasher Freezer Safe, BPA-Free Space Saving Lunch Container for Work Travel, Green",
        bullets: [
        ...
        description: "The Nimbus Home collapsible lunch box is built for people who carry lunch in, but hate carrying an empty box home. After eating, press the silicone body flat and it disappears into your bag. The snap-lock lid with silicone gasket keeps liquids in, the three compartments keep textures apart, and the whole set goes straight into the dishwasher at night.",
        search_terms: "collapsible bento lunchbox silicone foldable meal prep container leak proof adults work office travel camping portable compact kids school snack box microwavable freezer safe",
        aplus_outline: [
    ...
    },
    {
      ...
      fields: {
        title: "Nimbus Home Faltbare Lunchbox Silikon, 1,2L Auslaufsichere Bento Box mit 3 Fächern und Klappgabel, Mikrowellen- Spülmaschinen- Gefriergeeignet, BPA-frei Platzsparende Brotdose für Büro Reise, Grün",
        bullets: [
        ...
        description: "Die faltbare Nimbus Home Lunchbox ist für alle, die ihr Essen mitnehmen, aber keine leere Box nach Hause tragen wollen. Nach dem Essen den Silikonkörper flach drücken und in der Tasche verschwinden lassen. Der Deckel mit Silikondichtung hält Flüssigkeiten sicher, drei Fächer trennen die Portionen, und abends geht alles in die Spülmaschine.",
        search_terms: "faltbare lunchbox silikon bento box auslaufsicher brotdose erwachsene büro meal prep behälter mikrowelle gefrierfach platzsparend camping brotbox kinder schule",
        aplus_outline: [
    ...
    },
    {
      ...
      fields: {
        title: "Nimbus Home Magnetic Spice Rack for Refrigerator, 4-Tier Fridge Organizer Shelf with Paper Towel Holder and 6 Hooks, Strong Magnet Kitchen Space Saver, No Drilling",
        bullets: [
        ...
        description: "The Nimbus Home magnetic spice rack turns the side of your refrigerator into storage you can actually reach. Four shelves hold spice jars, oil bottles, and wraps; the bar takes a paper towel roll; six hooks catch utensils and mitts. Magnets keep it firm on fridges, washers, and steel doors — no tools, no holes.",
        search_terms: "magnetic spice rack fridge organizer refrigerator shelf kitchen storage magnet shelf paper towel holder fridge side rack seasoning organizer spice shelf metal rack kitchen gadgets rv camper organizer small apartment must haves pantry organization and storage",
        aplus_outline: []
      },
    ...
    },
    {
      ...
      fields: {
        ...
        description: "Turn the side of your fridge into a pantry wall. The Nimbus Home magnetic spice rack adds four shelves, a paper towel bar, and six hooks to any steel surface — no drilling, no residue. Strong neodymium strips hold up to 18 lb of jars and tools.",
        seo_title: "Magnetic Spice Rack | 4-Tier Fridge Organizer | Nimbus Home Co",
        seo_description: "Turn the side of your fridge into a pantry. 4-tier magnetic spice rack with towel bar and hooks. No drilling. Free US shipping over $35."
      },
    ...
    },
    {
      ...
      fields: {
        title: "Nimbus Home Foldable Laundry Basket, 60L Collapsible Hamper with Reinforced Handles, Folds Flat to 2 Inches for Wall Hook Storage, Machine-Washable Fabric for Dorm Small Spaces RV, Grey",
        bullets: [
        ...
        description: "The Nimbus Home foldable laundry basket works like a basket and stores like a folder. Snap the frame open for a sturdy 60L hamper; fold it flat to 2 inches and hang it up when the laundry is done. The fabric unclips and machine-washes, and the stitched handles are reinforced for full loads.",
        search_terms: "foldable laundry basket collapsible hamper space saving dorm rv small apartment wall hanging dirty clothes storage fabric washable camping travel",
        aplus_outline: [
    ...
    },
    {
      ...
      fields: {
        title: "Nimbus Home Digital Kitchen Scale, 22lb/10kg Food Scale with 1g Precision and Tare Function, USB Rechargeable, Slim Stainless Steel Baking Scale with 5 Units and Backlit LCD, Black",
        bullets: [
        ...
        description: "The Nimbus Home digital kitchen scale gives bakers and meal-preppers lab-style precision without the clutter: 1 g graduation to 10 kg, instant tare, five units, and a USB-rechargeable battery. The slim stainless platform stores in a drawer and cleans with one wipe.",
        search_terms: "digital kitchen scale food scale grams and ounces baking cooking usb rechargeable tare stainless steel precise 1g coffee espresso meal prep",
        aplus_outline: [
    ...
    },
    {
      ...
      fields: {
        ...
        description: "Slim stainless steel kitchen scale with 1 g graduation up to 10 kg. Instant tare, five units (g / kg / oz / lb / ml), backlit LCD, and a USB-rechargeable battery that lasts about three months per charge. Ships from a US warehouse; 18-month warranty.",
        item_specifics: [
  ...
  return [
    {
      ...
      suggestions: [
        l("Consider moving \"Green\" earlier — mobile truncates around 80 characters.", "可以把 \"Green\" 往前挪——移动端标题约 80 字符处截断。"),
        l("A+ outline is ready for the designer; confirm the comparison-chart claims against spec sheet.", "A+ 大纲可交设计；对比图的卖点请再对照规格表确认。")
      ],
    ...
    },
    {
      ...
      suggestions: [
        l("Replace \"FDA approved\" with \"food-contact safe 430 stainless steel\".", "把 \"FDA approved\" 改为 \"food-contact safe 430 stainless steel\"。"),
        l("Trim backend terms below 249 bytes — drop \"pantry organization and storage\".", "把后台搜索词裁到 249 字节以内——去掉 \"pantry organization and storage\"。"),
    ...
    },
    {
      ...
      suggestions: [
        l("Open with the fold-flat visual in the first five words.", "前五个词就要出现折平的画面。")
      ],
    ...
    results: [
      {
        ...
        detail: l("Markdown and CSV row written by scripts/export_listings.mjs.", "已由 scripts/export_listings.mjs 写出 Markdown 与 CSV 行。"),
        executed_at: "2026-07-01T10:00:00.000Z"
      },
      {
        review_id: "rv-basket-amazon-us",
...
function demoActivity(zh) {
  const l = L(zh);
  return [
    { id: "act-9", at: "2026-07-02T09:40:00.000Z", actor: "agent", detail: l("Drafted German locale variant for the collapsible silicone lunch box (Amazon DE).", "为可折叠硅胶饭盒起草了德语站变体（Amazon DE）。"), draft_id: "d-lunchbox-amazon-de" },
    { id: "act-8", at: "2026-07-02T07:20:00.000Z", actor: "agent", detail: l("Re-ran compliance checks: 3 failures on the magnetic spice rack Amazon US draft.", "重新运行合规检查：磁吸调料架 Amazon US 草稿有 3 项未通过。"), draft_id: "d-spicerack-amazon-us" },
    { id: "act-7", at: "2026-07-02T06:00:00.000Z", actor: "seller", detail: l("Requested changes on the laundry basket TikTok Shop hook (Draft #7).", "对洗衣篮 TikTok Shop 开头钩子提出修改要求（Draft #7）。"), draft_id: "d-basket-tiktok-us" },
    { id: "act-6", at: "2026-07-02T02:15:00.000Z", actor: "seller", detail: l("Approved the digital kitchen scale Amazon US draft (Draft #8).", "批准厨房电子秤 Amazon US 草稿（Draft #8）。"), draft_id: "d-scale-amazon-us" },
    { id: "act-5", at: "2026-07-01T10:00:00.000Z", actor: "agent", detail: l("Exported the foldable laundry basket Amazon US listing; publish handed off.", "导出可折叠洗衣篮 Amazon US 文案；发布已交接。"), draft_id: "d-basket-amazon-us" },
    { id: "act-4", at: "2026-06-30T06:00:00.000Z", actor: "agent", detail: l("Ingested lunch box drafts from the kelly-picks handoff brief.", "从 kelly-picks 交接简报生成了饭盒草稿。"), draft_id: "d-lunchbox-amazon-us" }
  ];
}
