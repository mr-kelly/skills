...
// app/demo-visuals.js's per-skill VISUAL_DEFS/motif; only the Hono
...
const SKILL_NAME = "kelly-listing";
const ACCENTS = ["#dc2626", "#0ea5e9"];
const VISUAL_DEFS = [
  {
    id: "kelly-listing-visual-1",
    title: "Product gallery",
    caption: "Synthetic marketplace image set for listing QA.",
    kind: "gallery",
  },
  {
    id: "kelly-listing-visual-2",
    title: "Listing preview",
    caption: "Mock product title, bullets, and mobile detail page.",
    kind: "mobile",
  },
  {
    id: "kelly-listing-visual-3",
    title: "Image checklist",
    caption: "Visual required-image audit with missing/ready states.",
    kind: "sheet",
  },
];
