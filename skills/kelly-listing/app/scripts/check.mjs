...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Listing must be Cloud-only");
if (/KELLY_LISTING_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Listing AirApp checks OK (${files.length} files)`);
