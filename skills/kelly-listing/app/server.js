...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-listing" }));
...
app.onError((error, context) => {
  console.error("Kelly Listing server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3149", 10);
