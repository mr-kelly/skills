...
export const BUSABASE_SCHEMA = {
  provider: "busabase",
  schema_id: "kelly-listing.storage",
  schema_version: "1",
  folder: {
    default_slug: "kelly-listing-workspace",
    children: ["base", "drive"],
  },
  base: {
    id: "kelly-listing",
    slug: "kelly-listing",
    name: "Kelly Listing Records",
    fields: [
      "record_id",
      "kind",
      "title",
  ...
  related_bases: [],
  drive: {
    id: "kelly-listing-files",
    slug: "kelly-listing-workspace-files",
