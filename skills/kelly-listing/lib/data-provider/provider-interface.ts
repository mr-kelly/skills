// The polymorphic contract every kelly-listing data provider implements. It
...
export interface DataProvider {
  ...
  /** Approved marketing claims + banned/restricted-phrase rules. */
