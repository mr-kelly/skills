...
const AIRAPP_ID = "kelly-instructor-sourcing";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-instructor-sourcing", mode: "sourcing-desk" }));
...
app.onError((error, context) => {
  console.error("kelly-instructor-sourcing server error", error instanceof Error ? error.message : error);
