...
if (resourceMap.resources?.length !== 2) {
  throw new Error("Resource map must declare exactly two Busabase Bases");
}
if ((resourceMap.vaultRequirements || []).length !== 0) {
  throw new Error("v1 has no messaging credential — the Vault requirement list must stay empty");
}
if (
