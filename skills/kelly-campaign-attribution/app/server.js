...
const AIRAPP_ID = "kelly-campaign-attribution";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-campaign-attribution" }));
...
app.onError((error, context) => {
  console.error("Multi-Touch Marketing Attribution Desk server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "33381", 10);
