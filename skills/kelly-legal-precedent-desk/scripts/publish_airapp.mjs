#!/usr/bin/env node
// Push this skill's current local content/kelly-legal-precedent-desk-app/ code to its deployed AirApp: creates it
...
// change takes effect. Use this after editing content/kelly-legal-precedent-desk-app/ files; scripts/setup.mjs
...
const appRoot = path.join(
  ...
  "..",
  "content",
  "kelly-legal-precedent-desk-app",
);
