...
const AIRAPP_ID = "kelly-legal-precedent-desk";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-legal-precedent-desk" }));
...
app.onError((error, context) => {
  console.error("Legal Precedent Desk server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3163", 10);
