...
// of augmenting a JSON response. Only the "document", "board", and "sheet"
// motifs are kept — the only kinds this skill's VISUAL_DEFS uses.
const SKILL_NAME = "kelly-legal-precedent-desk";
const ACCENTS = ["#1e40af", "#0f766e"];
const VISUAL_DEFS = [
  {
    id: "kelly-legal-precedent-desk-visual-1",
    title: "Case card",
    caption: "Synthetic precedent card with holding, court, and use note.",
    kind: "document",
  },
  {
    id: "kelly-legal-precedent-desk-visual-2",
    title: "Citation graph",
    caption: "Mock precedent citation and treatment network.",
    kind: "board",
  },
  {
    id: "kelly-legal-precedent-desk-visual-3",
    title: "Research pack",
    caption: "Visual export packet with checklist and authorities.",
    kind: "sheet",
  },
];
