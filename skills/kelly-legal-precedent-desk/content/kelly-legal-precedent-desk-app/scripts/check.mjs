...
if (!configText.includes('deployment: "cloud"')) throw new Error("Legal Precedent Desk must be Cloud-only");
if (/KELLY_LEGAL_PRECEDENT_DESK_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Legal Precedent Desk AirApp checks OK (${files.length} files)`);
