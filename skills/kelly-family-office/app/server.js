...
const AIRAPP_ID = "kelly-family-office";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-family-office" }));
...
app.onError((error, context) => {
  console.error("Kelly Family Office server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3127", 10);
