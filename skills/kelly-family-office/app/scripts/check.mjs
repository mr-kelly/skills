...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Family Office must be Cloud-only");
if (/KELLY_FAMILY_OFFICE_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Family Office AirApp checks OK (${files.length} files)`);
