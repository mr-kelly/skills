...
export const BUSABASE_SCHEMA = {
  provider: "busabase",
  schema_id: "kelly-family-office.storage",
  schema_version: "1",
  folder: {
    default_slug: "kelly-family-office-workspace",
    children: ["base", "drive"],
  },
  base: {
    id: "kelly-family-office",
    slug: "kelly-family-office",
    name: "Kelly Family Office Records",
    fields: [
      "record_id",
      "kind",
      "title",
  ...
  related_bases: [],
  drive: {
    id: "kelly-family-office-files",
    slug: "kelly-family-office-workspace-files",
