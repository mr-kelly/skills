...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-crm" }));
...
app.onError((error, context) => {
  console.error("Kelly CRM server error", error instanceof Error ? error.message : error);
