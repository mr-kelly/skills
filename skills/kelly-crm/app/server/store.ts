...
// CRM read/write logic now lives behind the data-provider layer in lib/ (see
// lib/data-provider/*); this file only ensures the data dir exists and loads
// .env files before the Hono app is served.
