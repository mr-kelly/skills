...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Feedback must be Cloud-only");
if (/KELLY_FEEDBACK_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Feedback AirApp checks OK (${files.length} files)`);
