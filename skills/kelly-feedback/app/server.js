...
const AIRAPP_ID = "kelly-feedback";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-feedback" }));
...
app.onError((error, context) => {
  console.error("Kelly Feedback server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3138", 10);
