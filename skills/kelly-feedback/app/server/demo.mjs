...
function localizeSnapshotZh(snapshot) {
  ...
  const proposalText = {
    ...
    "prop-decline-mobile": {
      ...
      reason: "共 3 条请求但加权仅 7 分，其中 2 位是查看者而非管理员。响应式 Web 优化能以原生 App 一小部分的成本满足八成诉求。"
    },
    "prop-merge-dark": {
...
function demoSnapshot(scenario) {
  ...
  const sources = [
    ...
    source("discord-community", "discord", "Discord #feedback", "kelly-messenger handoff", "2026-07-02T08:45:00.000Z", 6),
  ...
  const feedback = [
    fb("fb-email-101", "support-email", "email", "pulseboard", "maya@northstarlabs.io", "team", 14, 5, "neutral", "2026-06-29T10:12:00.000Z",
      ...
      "req-csv-export", "clustered", "Finance workflow; recurring weekly cost.", "https://mail.example.com/thread/8841"),
    fb("fb-email-102", "support-email", "email", "pulseboard", "finance@brightdesk.co", "pro", 9, 3, "negative", "2026-06-30T15:40:00.000Z",
      ...
      "req-csv-export", "clustered", "Compliance angle strengthens the export case.", "https://mail.example.com/thread/8867"),
    fb("fb-email-103", "support-email", "email", "formora", "ops@moonlittools.com", "pro", 7, 3, "negative", "2026-06-28T09:05:00.000Z",
      "Your pricing page says per-seat but we were billed per-workspace. Which is it? Took three support emails to figure out.",
      "req-pricing-clarity", "clustered", "Billing copy mismatch; churn risk.", "https://mail.example.com/thread/8802"),
    fb("fb-email-104", "support-email", "email", "pulseboard", "sam@renderbay.dev", "team", 11, 5, "negative", "2026-07-01T22:15:00.000Z",
      ...
      "req-api-rate-limits", "clustered", "Nightly batch job throttled; Team account.", "https://mail.example.com/thread/8890"),
    fb("fb-email-105", "support-email", "email", "formora", "hello@quietloop.studio", "free", 2, 1, "positive", "2026-06-25T08:30:00.000Z",
      ...
      "req-onboarding", "clustered", "Positive on templates, friction on setup.", "https://mail.example.com/thread/8763"),

    fb("fb-discord-201", "discord-community", "discord", "pulseboard", "@pixelnora", "pro", 6, 3, "neutral", "2026-06-30T23:55:00.000Z",
      "any plans for dark mode? my eyes at 1am reviewing launch metrics would like a word",
      "req-dark-mode", "clustered", "", "https://discord.com/channels/demo/feedback/1201"),
    fb("fb-discord-202", "discord-community", "discord", "pulseboard", "@drft.kai", "free", 3, 1, "neutral", "2026-07-01T02:10:00.000Z",
      "+1 dark mode, the all-white dashboard is blinding in the studio at night",
      "req-dark-mode", "clustered", "", "https://discord.com/channels/demo/feedback/1204"),
    fb("fb-discord-203", "discord-community", "discord", "pulseboard", "@tomasz_b", "pro", 12, 3, "positive", "2026-07-01T13:25:00.000Z",
      "loving the new funnels. would honestly pay extra to get the underlying data out as csv and stop copy-pasting numbers",
      "req-csv-export", "clustered", "Willingness to pay signal.", "https://discord.com/channels/demo/feedback/1209"),
    fb("fb-discord-204", "discord-community", "discord", "formora", "@june.builds", "free", 4, 1, "neutral", "2026-06-29T17:45:00.000Z",
      "is there a webhook when a form gets submitted? want to pipe entries straight into my community server",
      "req-webhooks", "clustered", "", "https://discord.com/channels/demo/feedback/1195"),
    fb("fb-discord-205", "discord-community", "discord", "pulseboard", "@overclockedowl", "free", 1, 1, "negative", "2026-07-02T08:40:00.000Z",
      "the date picker keeps resetting to last-7-days whenever i switch dashboards. super annoying when comparing months",
      "", "new", "", "https://discord.com/channels/demo/feedback/1218"),
    fb("fb-discord-206", "discord-community", "discord", "formora", "@metricsmaven", "pro", 10, 3, "positive", "2026-06-28T20:05:00.000Z",
      "realized you can use hidden fields to A/B test form copy — sharing my setup in #tips if anyone wants it",
      "", "insight", "Power-user pattern worth a docs article; not a feature request.", "https://discord.com/channels/demo/tips/1188"),

    fb("fb-slack-301", "slack-beta", "slack", "pulseboard", "Priya N. (Northstar Labs)", "team", 14, 5, "neutral", "2026-06-27T11:30:00.000Z",
      ...
      "req-dark-mode", "clustered", "Enterprise rollout blocker (soft).", "https://slack.com/archives/demo/p301"),
    fb("fb-slack-302", "slack-beta", "slack", "pulseboard", "Diego M. (Brightdesk)", "pro", 9, 3, "neutral", "2026-07-01T08:05:00.000Z",
      ...
      "req-mobile-app", "clustered", "", "https://slack.com/archives/demo/p302"),
    fb("fb-slack-303", "slack-beta", "slack", "pulseboard", "Priya N. (Northstar Labs)", "team", 14, 5, "negative", "2026-07-01T18:20:00.000Z",
      ...
      "req-api-rate-limits", "clustered", "Second report from the same Team account.", "https://slack.com/archives/demo/p303"),

    fb("fb-x-401", "x-mentions", "x", "pulseboard", "@shipfastio", "free", 5, 1, "positive", "2026-06-30T12:00:00.000Z",
      "@pulseboard funnels are great — now let me export the raw numbers and it's perfect",
      "req-csv-export", "clustered", "", "https://x.com/shipfastio/status/9001"),
    fb("fb-x-402", "x-mentions", "x", "pulseboard", "@nadia_codes", "free", 8, 1, "negative", "2026-06-28T21:15:00.000Z",
      "@pulseboard your dashboard on mobile safari is pain. native app when?",
      "req-mobile-app", "clustered", "", "https://x.com/nadia_codes/status/9014"),
    fb("fb-x-403", "x-mentions", "x", "formora", "@formsnerd", "pro", 16, 3, "neutral", "2026-06-27T14:50:00.000Z",
      "would love to skin @formora forms to match my brand's dark palette — a proper theme switcher, not just accent colors",
      "req-theme-switcher", "clustered", "", "https://x.com/formsnerd/status/9022"),
    fb("fb-x-404", "x-mentions", "x", "formora", "@caffeinated_pm", "free", 3, 1, "negative", "2026-07-02T06:25:00.000Z",
      "@formora why does duplicating a form drop all the logic jumps? lost an hour rebuilding them",
      "", "new", "", "https://x.com/caffeinated_pm/status/9031"),
    fb("fb-x-405", "x-mentions", "x", "pulseboard", "@growth_rocket_x", "free", 0, 1, "neutral", "2026-07-01T04:00:00.000Z",
      "@pulseboard dm me to get 10k real followers fast, link in bio",
      "", "ignored", "Promotional spam, no product signal.", "https://x.com/growth_rocket_x/status/9040"),

    fb("fb-app-501", "appstore-reviews", "appstore", "pulseboard", "GrowthGuy88", "pro", 8, 3, "negative", "2026-06-26T10:00:00.000Z",
      "3 stars. The web app is excellent but there's no real mobile experience. The 'add to home screen' trick isn't it.",
      "req-mobile-app", "clustered", "", "https://apps.example.com/pulseboard/review/501"),
    fb("fb-app-502", "appstore-reviews", "appstore", "formora", "TinaMakes", "free", 1, 1, "positive", "2026-06-30T08:20:00.000Z",
      "Five stars. The onboarding checklist got my first form live in ten minutes. More of this please.",
      "req-onboarding", "clustered", "Validates the shipped checklist.", "https://apps.example.com/formora/review/502"),
    fb("fb-app-503", "appstore-reviews", "appstore", "pulseboard", "dashboard_dan", "pro", 5, 3, "neutral", "2026-06-24T19:40:00.000Z",
      "Great tool. Would be 5 stars with a dark theme and OLED-friendly chart colors.",
      "req-dark-mode", "clustered", "", "https://apps.example.com/pulseboard/review/503"),

    fb("fb-survey-601", "in-app-survey", "survey", "pulseboard", "NPS 9 · team admin", "team", 10, 5, "positive", "2026-07-01T09:00:00.000Z",
      "Almost perfect. Export to CSV or Sheets is the one thing keeping us tied to our old BI tool.",
      "req-csv-export", "clustered", "", ""),
    fb("fb-survey-602", "in-app-survey", "survey", "formora", "NPS 6 · pro user", "pro", 4, 3, "negative", "2026-06-29T09:00:00.000Z",
      "Not sure what I'm paying for — the plan comparison table doesn't mention response limits until checkout.",
      "req-pricing-clarity", "clustered", "", ""),
    fb("fb-survey-603", "in-app-survey", "survey", "pulseboard", "NPS 8 · pro user", "pro", 6, 3, "neutral", "2026-06-26T09:00:00.000Z",
      "Please add a dark/auto theme that follows system settings. Everything else is solid.",
      "req-theme-switcher", "clustered", "", ""),

    fb("fb-int-701", "user-interviews", "interview", "pulseboard", "Head of Data, Northstar Labs", "team", 14, 5, "neutral", "2026-06-27T15:00:00.000Z",
      ...
      "req-api-rate-limits", "clustered", "Expansion revenue tied to limits.", ""),
    fb("fb-int-702", "user-interviews", "interview", "formora", "Solo founder, Quietloop Studio", "free", 2, 1, "positive", "2026-06-25T16:00:00.000Z",
      "Said the checklist 'felt like a colleague setting things up with me' and wants the same guidance for the embed flow.",
      "req-onboarding", "clustered", "Follow-up idea: guided embed flow.", "")
  ];

  const requests = [
    request("req-csv-export", "CSV export for dashboard data", "pulseboard", "candidate", "up",
      ...
      "M (1-2 weeks)", ["fb-email-101", "fb-email-102", "fb-survey-601"],
    ...
    request("req-dark-mode", "Dark mode across the app", "pulseboard", "candidate", "up",
    ...
    request("req-theme-switcher", "Theme switcher", "formora", "candidate", "flat",
      ...
      "", ["fb-x-403"],
      [event("2026-06-27T16:00:00.000Z", "agent", "created", "Clustered 2 feedback items; flagged as likely duplicate of req-dark-mode.")],
      "2026-06-27T16:00:00.000Z"),
    request("req-api-rate-limits", "Raise API rate limits for Team plan", "pulseboard", "needs_info", "up",
      ...
      "L (3-4 weeks)", ["fb-int-701", "fb-email-104"],
      [event("2026-06-28T12:00:00.000Z", "agent", "created", "Clustered 2 feedback items."),
       event("2026-07-02T08:10:00.000Z", "agent", "needs_info", "Marked needs_info: waiting on 30 days of per-account API usage.")],
      "2026-06-28T12:00:00.000Z"),
    request("req-mobile-app", "Native mobile app", "pulseboard", "candidate", "flat",
      ...
      "XL (6+ weeks)", ["fb-slack-302", "fb-app-501"],
      [event("2026-06-29T10:30:00.000Z", "agent", "created", "Clustered 3 feedback items."),
       event("2026-07-01T09:00:00.000Z", "agent", "proposed_decline", "Drafted decline reply; weighted demand is low vs. cost.")],
      "2026-06-29T10:30:00.000Z"),
    request("req-pricing-clarity", "Clarify pricing and seat billing", "formora", "roadmap", "flat",
      ...
      "S (2-3 days)", ["fb-email-103", "fb-survey-602"],
    ...
    request("req-onboarding", "Guided onboarding checklist", "formora", "roadmap", "down",
      ...
      [event("2026-06-10T09:00:00.000Z", "agent", "created", "Clustered onboarding friction reports."),
       ...
       event("2026-06-24T09:00:00.000Z", "agent", "shipped", "Checklist live for all new workspaces; changelog drafted in proposal #5.")],
      "2026-06-10T09:00:00.000Z"),
    request("req-webhooks", "Outgoing webhooks on form submit", "formora", "candidate", "flat",
  ...
  const roadmap = {
    now: [
      lane("rm-now-1", "Guided onboarding checklist", "req-onboarding", "Shipped 2026-06-24; changelog note pending (proposal #5)."),
      lane("rm-now-2", "Dashboard performance pass", "", "Sub-second loads for dashboards under 50 widgets.")
    ],
    next: [
      lane("rm-next-1", "Clarify pricing and seat billing", "req-pricing-clarity", "Pricing page rewrite plus response limits in the comparison table."),
  ...
  const proposals = [
    proposal("prop-promote-csv", 1, "promote_request", "Promote 'CSV export' to Next", "needs_review", {
      ...
      target_lane: "next",
      reason: "Highest weighted demand this month (score 17 across 5 users, 3 on paid plans). Finance and month-end reporting workflows are blocked without it, and one NPS 9 admin names it the last reason they keep their old BI tool.",
      evidence: "5 feedback items across email, Discord, X, and the NPS survey; 2 Team accounts (Northstar Labs, Render Bay side) raised it directly. Trend is up two weeks in a row.",
      draft_kind: "changelog_note",
      draft: "Next up: CSV export. Export any dashboard widget's underlying data as CSV, or grab the whole dashboard in one file. Scheduled pushes to Google Sheets are on the shortlist right after. Rolling out to all plans.",
      created_at: "2026-07-02T08:00:00.000Z"
    }),
    proposal("prop-decline-mobile", 2, "decline_request", "Decline 'Native mobile app' with a drafted reply", "changes_requested", {
      request_id: "req-mobile-app",
      reason: "3 requests but weighted score only 7, and 2 of 3 come from viewers rather than admins. A responsive dashboard pass covers most of the ask at a fraction of a native app's build and maintenance cost.",
      evidence: "Feedback from Slack beta, X, and one 3-star App Store review. No paying admin has made it a renewal condition.",
      draft_kind: "decline_reply",
      draft: "Thanks for pushing us on mobile — you're right that today's phone experience falls short. We're not building a native app this year: for a two-person team it would slow everything else down. Instead, a responsive dashboard pass is scheduled for Q3 that makes viewing (not editing) genuinely good on phones. If that still doesn't cover how you use PulseBoard on the go, tell us what you check most from your phone and we'll design for it.",
      review_note: "Don't say 'no native app ever'. Mention the responsive pass shipping in Q3 explicitly and end by asking what they check most from their phone.",
      created_at: "2026-07-01T09:00:00.000Z",
      decided_at: "2026-07-01T17:30:00.000Z"
    }),
    proposal("prop-merge-dark", 3, "merge_requests", "Merge 'Theme switcher' into 'Dark mode across the app'", "approved", {
      request_id: "req-dark-mode",
      request_ids: ["req-dark-mode", "req-theme-switcher"],
      reason: "Same underlying need: both 'Theme switcher' items ask for a dark palette. Merging lifts dark mode to frequency 6 and weighted score 18 — the top cluster overall.",
      evidence: "fb-x-403 and fb-survey-603 both describe dark/system themes; only brand-theming of published Formora forms is distinct and stays noted on the merged request.",
      draft_kind: "merge_note",
      draft: "Merged 'Theme switcher' into 'Dark mode across the app'. Kept the Formora brand-theming remainder as a note on the merged request.",
    ...
    proposal("prop-promote-api", 4, "promote_request", "Schedule 'API rate limits' for Later", "blocked", {
      ...
      target_lane: "later",
      reason: "All three requests come from Team accounts and one ties an expansion decision to it, but we don't know real per-account request volumes. Raising limits blindly risks the ingest cluster.",
      evidence: "Weighted score 15 from 3 items — every reporter is on Team. Northstar Labs raised it twice in one week.",
      draft_kind: "",
      draft: "",
      review_note: "Blocked: need 30 days of per-account API usage from the metrics pipeline before sizing new limits. Re-propose once the data lands.",
      created_at: "2026-07-02T08:10:00.000Z",
      decided_at: "2026-07-02T08:40:00.000Z"
    }),
    proposal("prop-changelog-onboarding", 5, "publish_changelog", "Publish changelog note for the shipped onboarding checklist", "done", {
      request_id: "req-onboarding",
      reason: "The guided checklist shipped on June 24 and reviews are positive. Publishing the note closes the loop with the three users who reported onboarding friction.",
      evidence: "One five-star App Store review and one interview quote directly credit the checklist.",
      draft_kind: "changelog_note",
      draft: "Shipped: guided onboarding checklist. New workspaces now get a step-by-step checklist from signup to your first live form — most makers finish in about ten minutes. Thanks to everyone who told us the first evening felt like homework.",
  ...
  const sync_log = [
    ...
    log("2026-07-02T07:15:00.000Z", "kelly-feedback", "ingest", "Ingested 5 support emails via kelly-email handoff.", 5),
    log("2026-07-02T08:00:00.000Z", "agent", "cluster", "Applied cluster assignments: 23 items across 8 requests; drafted proposals #1-#4.", 23),
    log("2026-07-02T08:50:00.000Z", "kelly-feedback", "ingest", "Ingested 11 community items from Discord, Slack, and X handoffs.", 11)
  ];
...
function fb(feedback_id, source_id, channel, product, handle, plan, tenure_months, weight, sentiment, received_at, text, request_id, triage, agent_note, permalink) {
  return {
    feedback_id,
    source_id,
    channel,
...
function request(request_id, title, product, status, trend, problem_statement, spec_summary, effort_estimate, representative_feedback_ids, decision_history, created_at) {
  return {
    request_id,
    title,
    product,
