...
export const BUSABASE_SCHEMA = {
  provider: "busabase",
  schema_id: "kelly-feedback.storage",
  schema_version: "1",
  folder: {
    default_slug: "kelly-feedback-workspace",
    children: ["base", "drive"],
  },
  base: {
    id: "kelly-feedback",
    slug: "kelly-feedback",
    name: "Kelly Feedback Records",
    fields: [
      "record_id",
      "kind",
      "title",
  ...
  related_bases: [],
  drive: {
    id: "kelly-feedback-files",
    slug: "kelly-feedback-workspace-files",
