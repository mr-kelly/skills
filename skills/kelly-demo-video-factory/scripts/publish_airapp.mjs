#!/usr/bin/env node
// Push this skill's current local content/kelly-demo-video-factory-app/ code to its deployed AirApp: creates it
...
// change takes effect. Use this after editing content/kelly-demo-video-factory-app/ files; scripts/setup.mjs
...
import { appConfig } from "../content/kelly-demo-video-factory-app/app/js/config.js";

const appRoot = path.join(
  path.dirname(fileURLToPath(import.meta.url)),
  "..",
  "content",
  "kelly-demo-video-factory-app",
);
