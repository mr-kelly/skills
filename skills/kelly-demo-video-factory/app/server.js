...
const AIRAPP_ID = "kelly-demo-video-factory";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-demo-video-factory" }));
...
app.onError((error, context) => {
  console.error("Kelly Demo Video Factory server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3171", 10);
