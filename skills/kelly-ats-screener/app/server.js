...
const AIRAPP_ID = "kelly-ats-screener";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-ats-screener" }));
...
app.onError((error, context) => {
  console.error("ATS Resume Screener & Evaluation Desk server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3181", 10);
