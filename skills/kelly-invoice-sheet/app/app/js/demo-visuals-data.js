...
const SKILL_NAME = "kelly-invoice-sheet";
const ACCENTS = ["#16a34a", "#0f766e"];
const VISUAL_DEFS = [
  {
    id: "kelly-invoice-sheet-visual-1",
    title: "Invoice scan",
    caption: "Synthetic vendor invoice image with extracted field boxes.",
    kind: "document",
  },
  {
    id: "kelly-invoice-sheet-visual-2",
    title: "Spreadsheet extract",
    caption: "Mock sheet rows populated from invoice OCR output.",
    kind: "sheet",
  },
  {
    id: "kelly-invoice-sheet-visual-3",
    title: "Receipt photo",
    caption: "Simulated receipt capture with low-confidence marker.",
    kind: "receipt",
  },
];
...
function motif(kind, accent, secondary) {
  if (kind === "receipt") {
    return `<rect x="258" y="56" width="444" height="420" rx="18" fill="#f8fafc"/><path d="M258 56 h444 v420 l-34 -18 -34 18 -34 -18 -34 18 -34 -18 -34 18 -34 -18 -34 18 -34 -18 -34 18 -34 -18 -34 18 -34 -18 -34 18 -34 -18 -34 18z" fill="#f8fafc"/><rect x="314" y="116" width="220" height="28" rx="10" fill="${accent}"/><rect x="314" y="184" width="330" height="18" rx="9" fill="#cbd5e1"/><rect x="314" y="228" width="298" height="18" rx="9" fill="#cbd5e1"/><rect x="314" y="272" width="330" height="18" rx="9" fill="#cbd5e1"/><rect x="314" y="348" width="170" height="34" rx="12" fill="${secondary}"/>`;
  }
  if (kind === "sheet") {
