...
└── js/
    ...
    ├── busabase.js        # connection/resource readiness helpers
...
responsibility lines the app itself already has (routing, i18n, Busabase
readiness, one module per major screen/section). Keep server-side `lib/` (Node)
...
- Load the app fresh in a real browser with a clean session and confirm
