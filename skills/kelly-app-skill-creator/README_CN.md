...
默认流程是 Research -> Plan -> Action -> Retrospective。这个 skill 拥有完整的产品 UI 契约：编辑风视觉体系（六套配色家族、三档版式、杂志排版、暗色模式、录屏可读性规则）、信息架构、人工注意力侧栏、工作流导航、桌面列表/详情布局、hash 路由、Help & Settings、无障碍、手机抽屉与独立详情流程，以及 1280x820、1280x720、390px、360px 的视觉验收。只有 AirApp 运行时工程委托给 `$busabase-app-creator`。
