#!/usr/bin/env node
// Push this skill's current local content/kelly-pmo-app/ code to its deployed AirApp: creates it
...
// change takes effect. Use this after editing content/kelly-pmo-app/ files; scripts/setup.mjs
