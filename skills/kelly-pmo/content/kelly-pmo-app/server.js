...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-pmo" }));
...
app.onError((error, context) => {
  console.error("kelly-pmo server error", error instanceof Error ? error.message : error);
