...
import { appConfig } from "../content/kelly-financial-services-intel-app/app/js/config.js";
import { operationForDecision } from "../content/kelly-financial-services-intel-app/app/js/financial-model.js";
...
async function markDone(client, existing, fields, message) {
  return client.records.changeRequest({
    ...
    message,
    author: "kelly-financial-services-intel-execute-decisions",
...
async function main() {
  ...
  if (!resources.folder || resources.missing.length) {
    throw new Error(
      "Kelly Financial Services Intel Busabase resources are not provisioned yet; run the AirApp setup first.",
    );
  }
