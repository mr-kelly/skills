// Pure, storage-agnostic domain logic for kelly-financial-services-intel — no
...
export function parseBatchMeta(payload = "") {
  ...
  return {
    ...
    source: meta.source || "kelly-financial-services-intel",
    vertical: meta.vertical || "financial services, investment advisory, and family offices",
    buyer: meta.buyer || "",
    offer: meta.offer || "",
  };
}
