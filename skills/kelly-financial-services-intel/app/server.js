...
const AIRAPP_ID = "kelly-financial-services-intel";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-financial-services-intel" }));
...
app.onError((error, context) => {
  console.error("Kelly Financial Services Intel server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3175", 10);
