...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Behavior Predict must be Cloud-only");
if (/KELLY_BEHAVIOR_PREDICT_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Behavior Predict AirApp checks OK (${files.length} files)`);
