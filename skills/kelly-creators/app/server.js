...
const AIRAPP_ID = "kelly-creators";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-creators" }));
...
app.onError((error, context) => {
  console.error("Kelly Creators server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3130", 10);
