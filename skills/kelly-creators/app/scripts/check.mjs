...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Creators must be Cloud-only");
if (/KELLY_CREATORS_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Creators AirApp checks OK (${files.length} files)`);
