...
export const BUSABASE_SCHEMA = {
  provider: "busabase",
  schema_id: "kelly-creators.storage",
  schema_version: "1",
  folder: {
    default_slug: "kelly-creators-workspace",
    children: ["base", "drive"],
  },
  base: {
    id: "kelly-creators",
    slug: "kelly-creators",
    name: "Kelly Creators Records",
    fields: [
      "record_id",
      "kind",
      "title",
  ...
  related_bases: [],
  drive: {
    id: "kelly-creators-files",
    slug: "kelly-creators-workspace-files",
