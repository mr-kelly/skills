// Filesystem layout for the kelly-creators data-provider layer.
//
...
export const snapshotPath = path.join(dataDir, "creator_snapshot.json");
...
export const defaultPort = 3200;
export const preferredPortMin = 3200;
