...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Standup must be Cloud-only");
if (/KELLY_WRITER_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Standup AirApp checks OK (${files.length} files)`);
