...
export const BUSABASE_SCHEMA = {
  provider: "busabase",
  schema_id: "kelly-standup.storage",
  schema_version: "1",
  folder: {
    default_slug: "kelly-standup-workspace",
    children: ["base", "drive"],
  },
  base: {
    id: "kelly-standup",
    slug: "kelly-standup",
    name: "Kelly Standup Records",
    fields: [
      "record_id",
      "kind",
      "title",
  ...
  related_bases: [],
  drive: {
    id: "kelly-standup-files",
    slug: "kelly-standup-workspace-files",
