...
const AIRAPP_ID = "kelly-school-k12-attendance";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-school-k12-attendance" }));
...
app.onError((error, context) => {
  console.error("K-12 Attendance, Behavior & Portal Desk server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "33298", 10);
