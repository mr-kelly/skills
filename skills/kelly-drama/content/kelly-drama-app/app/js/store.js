...
// Generation-backend settings now live on the project record itself
// (`project()._settings`, written by js/providers/busabase-provider.js's
// saveImageConfig) instead of a separate `/api/image-config` round trip.
