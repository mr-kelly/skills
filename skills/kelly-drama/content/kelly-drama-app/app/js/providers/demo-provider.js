...
// Synthetic placeholder image for a demo asset id — a hash-tinted SVG data
// URL, ported from the retired app/server/demo.ts's demoAsset()/placeholderSvg().
function ph(label) {
...
function demoProject(zh) {
  ...
  const series = {
    ...
    tone: L(
      "Taut, glossy, emotionally loaded; every episode ends on a hook.",
      "紧凑、精致、情绪浓烈；每集结尾必留钩子。",
    ),
    ...
    visual_bible: {
      ...
      background_reference_assets: [
        { title: L("Lin family mansion hall", "林家老宅大厅"), path: ph("bible-mansion-hall") },
        { title: L("Harbor-view CEO office", "临港总裁办公室"), path: ph("bible-ceo-office") },
      ],
    },
  };
  ...
  const characters = [
    character(
      "char-lin-wan",
      L("Lin Wan", "林晚"),
      L("protagonist / substitute bride", "女主 / 替嫁新娘"),
      "approved",
      {
        identity: L(
          "Disinherited eldest daughter, works as a restoration artist.",
          "被除名的林家长女，职业是文物修复师。",
        ),
        motivation: L("Reclaim her mother's name and the estate stolen from her.", "夺回母亲的名誉和被侵吞的遗产。"),
        wound: L(
          "Watched her mother signed out of the family ledger at twelve.",
          "十二岁那年亲眼看着母亲被从家族账册中除名。",
        ),
        secret: L("She holds the original will her father thinks was burned.", "她手里有父亲以为已烧毁的遗嘱原件。"),
        arc: L(
          "From invisible substitute to the one holding every contract.",
          "从无人在意的替身，到握住所有契约的人。",
        ),
        voice: L(
          "Quiet, precise, devastating when she finally raises her voice.",
          "安静、精准，一旦提高声音便一击致命。",
        ),
      },
      {
        front: L(
          "Slender, porcelain complexion, collarbone-length black hair, wine-red lips.",
          "身形清瘦，肤色冷白，锁骨黑发，酒红唇色。",
        ),
        side: L(
          "Straight nose bridge, small jade earring, always upright posture.",
          "鼻梁挺直，佩小玉耳钉，站姿始终笔直。",
        ),
        back: L("Thin scar behind the left shoulder, hair usually half tied.", "左肩后有细疤，头发常半束。"),
        wardrobe: L(
          "Ivory silk blouse, tailored black trousers, her mother's jade bracelet.",
          "米白真丝衬衫、黑色西裤、母亲留下的玉镯。",
        ),
        anchors: [
          L("jade bracelet never leaves her wrist", "玉镯从不离腕"),
          L("wine-red lips in every scene", "每场戏都是酒红唇色"),
        ],
    ...
    character(
      "char-gu-chenzhou",
      L("Gu Chenzhou", "顾沉舟"),
      L("male lead / cold-blooded CEO", "男主 / 冷面总裁"),
      "approved",
      {
        identity: L(
          "Chairman of Chenzhou Capital, the Lin family's largest creditor.",
          "沉舟资本董事长，林家最大的债主。",
        ),
        motivation: L(
          "Repay a debt he owes to Lin Wan's mother from twenty years ago.",
          "偿还二十年前欠林晚母亲的一份恩情。",
        ),
        ...
        arc: L(
          "From creditor with a plan to partner who risks the plan for her.",
          "从按计划行事的债主，到为她赌上计划的同盟。",
        ),
        voice: L(
          "Clipped sentences, zero small talk, dry humor at knife's edge.",
          "句子极短，从不寒暄，刀锋边缘的冷幽默。",
        ),
      },
      {
        front: L(
          "Tall, sharp jawline, rimless glasses, charcoal three-piece suit.",
          "身材高大，下颌线利落，无框眼镜，炭灰三件套西装。",
        ),
        side: L("Faint scar through right eyebrow, mechanical watch on left wrist.", "右眉有淡疤，左腕戴机械表。"),
        back: L(
          "Broad shoulders, coat always draped, never worn through the sleeves.",
          "肩宽背直，大衣永远披着从不穿袖。",
        ),
    ...
    character(
      "char-su-man",
      L("Su Man", "苏曼"),
      L("antagonist / scheming half-sister", "反派 / 心机继姐"),
      "needs_review",
      {
      ...
      {
        front: L(
          "Soft curls, peach makeup, designer dresses a size too loud.",
          "柔软卷发，蜜桃系妆容，用力过猛的名牌裙装。",
        ),
    ...
    character(
      "char-lin-guodong",
      L("Lin Guodong", "林国栋"),
      L("patriarch / compromised father", "家主 / 妥协的父亲"),
      "approved",
      {
        identity: L(
          "Head of the Lin family, publicly respectable, privately in debt.",
          "林家家主，人前体面，人后负债。",
        ),
        motivation: L("Protect the family name at any daughter's expense.", "不惜牺牲任何一个女儿也要保全家族名声。"),
        wound: L(
          "He signed the erasure himself and has never slept well since.",
          "除名文件是他亲手签的，从此夜不能寐。",
        ),
        secret: L("The company has been insolvent for three years.", "公司实际已资不抵债三年。"),
        arc: L(
          "From untouchable patriarch to the man begging his erased daughter.",
          "从高高在上的家主，到向被除名的女儿低头的人。",
        ),
    ...
    character(
      "char-qin-yue",
      L("Qin Yue", "秦悦"),
      L("ally / lawyer best friend", "盟友 / 律师闺蜜"),
      "draft",
      {
    ...
    character(
      "char-shen-huilan",
      L("Shen Huilan", "沈慧兰"),
      L("the erased mother (flashbacks)", "被抹去的母亲（闪回）"),
      "approved",
      {
        identity: L(
          "Founder of the original Lin workshop, died 'in debt' — on paper.",
          "林家工坊真正的创始人，账面上'负债而终'。",
        ),
        ...
        arc: L(
          "Her handwriting resurfaces episode by episode until it convicts.",
          "她的笔迹逐集重现，直到成为定罪的证据。",
        ),
      ...
      {
        front: L(
          "Qipao-era elegance, hair in a low bun, ink-stained fingertips.",
          "旗袍式端庄，低发髻，指尖常沾墨渍。",
        ),
    ...
    character(
      "char-zhao-ming",
      L("Zhao Ming", "赵铭"),
      L("rival investor / Su Man's fiancé", "对手投资人 / 苏曼未婚夫"),
      "needs_review",
      {
  ...
  const relationships = [
    relationship(
      "rel-linwan-guchenzhou",
      "char-lin-wan",
      "char-gu-chenzhou",
      L("contract spouses", "契约夫妻"),
      ...
      L(
        "He holds the debt; she holds the will — the leverage keeps flipping.",
        "他握着债权，她握着遗嘱，主动权不断易手。",
      ),
      L("simmering", "暗流升温"),
      L("Neither will admit the contract stopped being the point.", "谁都不肯承认这段婚姻早已不只是契约。"),
      [
        L("Ep 1: he corrects the officiant — 'the name is Lin Wan.'", "第1集：他纠正司仪——'新娘的名字是林晚。'"),
        L("Ep 3: he keeps her mother's photo in his safe.", "第3集：他的保险柜里存着她母亲的照片。"),
      ],
    ),
    relationship(
      "rel-linwan-suman",
      "char-lin-wan",
      "char-su-man",
      L("half-sisters, blood rivals", "同父异母的宿敌姐妹"),
    ...
    relationship(
      "rel-linwan-linguodong",
      "char-lin-wan",
      "char-lin-guodong",
      L("estranged father and daughter", "决裂的父女"),
      ...
      L(
        "The insolvent company needs the trademark registered in her name.",
        "资不抵债的公司离不开注册在她名下的商标。",
      ),
    ...
    relationship(
      ...
      "char-su-man",
      "char-zhao-ming",
      L("engaged co-conspirators", "同谋未婚夫妻"),
    ...
    relationship(
      "rel-guchenzhou-zhaoming",
      "char-gu-chenzhou",
      "char-zhao-ming",
      L("rival bidders", "竞购对手"),
    ...
    relationship(
      ...
      "char-qin-yue",
      "char-lin-wan",
      L("best friends, counsel and client", "闺蜜兼律师与委托人"),
  ...
  const episodes = [
    episode(
      1,
      "ep-001",
      L("The Substitute Bride", "替嫁"),
      "approved",
      L(
        "Su Man flees the wedding; the Lin family shoves Lin Wan into the dress, but at the altar Gu Chenzhou reads out the name he actually wrote into the contract: Lin Wan.",
        "苏曼临阵逃婚，林家把婚纱塞给林晚顶替；礼堂上顾沉舟却念出契约里本来写着的名字——林晚。",
      ),
      L("A substitute bride discovers the groom asked for her by name.", "替嫁的新娘发现，新郎点名要的就是她。"),
      L(
        "Signing the register, Gu Chenzhou whispers: 'Your mother sent me.'",
        "签字时顾沉舟低声说：'是你母亲让我来的。'",
      ),
      [
        beat(
          "b-001-1",
          L("Cold open: the dress", "冷开场：婚纱"),
          L(
            "Lin Wan is zipped into a stranger's wedding dress mid-argument.",
            "争吵声中，林晚被强行套上不属于她的婚纱。",
          ),
          L("Family vs. Lin Wan: no consent, no time.", "家族逼迫 vs 林晚：没有同意，也没有时间。"),
        ),
        beat(
          "b-001-2",
          L("The altar swap", "礼堂换人"),
          L("Guests whisper as the veil lifts on the wrong sister.", "头纱掀起，来宾哗然——新娘换了人。"),
          L("Public humiliation flips into public leverage.", "公开羞辱瞬间变成公开筹码。"),
        ),
        beat(
          "b-001-3",
          L("The name in the contract", "契约上的名字"),
          L(
            "Gu Chenzhou corrects the officiant without raising his voice.",
            "顾沉舟没有提高音量，只纠正了司仪一个名字。",
          ),
          L("The family's plan was never their plan.", "家族的算计从头到尾不在他的剧本里。"),
        ),
      ],
    ),
    episode(
      2,
      "ep-002",
      L("A Paper Marriage", "一纸契约"),
      "approved",
      L(
        "The newlyweds negotiate house rules like a merger; Lin Wan trades obedience clauses for one thing — access to the family archive.",
        "新婚夫妻像谈并购一样谈家规；林晚用'听话条款'只换一样东西——进入家族档案室的权限。",
      ),
    ...
    episode(
      3,
      "ep-003",
      L("The Old Photograph", "旧照重现"),
      "approved",
      L(
        "A photo in Gu Chenzhou's safe shows his father and Shen Huilan outside the original workshop; Lin Wan realizes the debt runs the other way.",
        "顾沉舟保险柜里的旧照拍着他父亲与沈慧兰站在老工坊门口；林晚意识到，欠债的另有其人。",
      ),
    ...
    episode(
      4,
      "ep-004",
      L("Banquet Ambush", "宴会风波"),
      "needs_review",
      L(
        "At the family banquet Su Man plays the leaked photo as a scandal; Lin Wan answers by returning the dowry — publicly, to the cent.",
        "家宴上苏曼用照片做局造谣；林晚当众连本带息退还聘礼，一分不差。",
      ),
      L("A trap sprung in public is repaid in public.", "当众设局，就当众还击。"),
      L(
        "The transfer slip shows the dowry account was Su Man's private card.",
        "转账单显示聘礼收款账户是苏曼的私人卡。",
      ),
      [],
    ),
    episode(
      ...
      "needs_review",
      L(
        "Qin Yue traces three years of fake profits; Lin Guodong quietly asks his erased daughter for a loan.",
        "秦悦追出连续三年的假利润；林国栋放下身段，向被他除名的女儿开口借钱。",
      ),
    ...
    episode(
      6,
      "ep-006",
      L("Mother's File", "母亲的病历"),
      "needs_review",
      L(
        "The hospital file shows Shen Huilan's final signature was made two days after her death — the forgery has a date.",
        "病历显示沈慧兰的'最后签名'落款在她去世两天后——伪造有了时间戳。",
      ),
    ...
    episode(
      7,
      "ep-007",
      L("Turning the Tables", "反将一军"),
      "draft",
      L(
        "Gu Chenzhou floats a fake bid ceiling; Zhao Ming leverages everything to beat it and mortgages Su Man's dowry to do so.",
        "顾沉舟放出假竞价上限；赵铭加满杠杆迎战，甚至抵押了苏曼的聘礼。",
      ),
    ...
    episode(
      8,
      "ep-008",
      L("The Alliance Cracks", "联盟破裂"),
      "draft",
      L(
        "Zhao Ming's transfer to Su Man bounces; each starts shredding documents that incriminate the other.",
        "赵铭给苏曼的转账被退回；两人开始互相销毁能咬死对方的文件。",
      ),
    ...
    episode(
      ...
      "draft",
      L(
        "The mailed original lands with Qin Yue; Lin Guodong learns his 'obedient' daughter has been building a case for eight episodes.",
        "原件寄到了秦悦手上；林国栋这才发现'听话'的女儿已经收集了八集的证据。",
      ),
    ...
    episode(
      ...
      "draft",
      L(
        "At the shareholders' meeting, Gu Chenzhou converts debt to shares and hands the votes to Lin Wan.",
        "股东会上顾沉舟债转股，将投票权全部交给林晚。",
      ),
    ...
    episode(
      11,
      "ep-011",
      L("The Last Testimony", "最后的证词"),
      "draft",
      L(
        "In court the forged date, the bounced transfer, and the fake audit converge; Su Man's own protection letter convicts her.",
        "庭审上伪造日期、退回转账与假审计三线汇合；苏曼寄出的自保信成了定罪证据。",
      ),
    ...
    episode(
      12,
      "ep-012",
      L("Into the Light", "逆光而行"),
      "draft",
      L(
        "Lin Wan reopens the workshop under her mother's name; Gu Chenzhou brings a new contract — one page, no clauses, just a question.",
        "林晚以母亲之名重开工坊；顾沉舟带来一份新契约——只有一页，没有条款，只有一个问题。",
      ),
  ...
  const shots = [
    shot(
      ...
      6,
      L(
        "Extreme close-up: a zipper drags up the back of a borrowed wedding dress, fabric straining.",
        "大特写：借来的婚纱背后拉链被强行拉起，布料紧绷。",
      ),
      L("extreme close-up", "大特写"),
      L("slow push-in", "缓慢推近"),
      L("Lin family dressing room, morning", "林家更衣室，清晨"),
      L("hard window light, cold", "冷硬窗光"),
      L(
        "Hands force the zipper; Lin Wan's breath catches; the jade bracelet knocks against the mirror.",
        "有人强行拉上拉链；林晚呼吸一滞；玉镯磕在镜面上。",
      ),
      ph("shot-001-01"),
    ),
    shot(
      ...
      "ep-001",
      "b-001-1",
      L("Mirror argument", "镜中争执"),
      "approved",
      8,
      L(
        "Over-the-shoulder into the mirror: three family members argue behind Lin Wan's still face.",
        "过肩镜头拍镜面：林晚面无表情，身后三个家人争执不休。",
      ),
      L("medium close-up", "中近景"),
      L("locked off", "固定机位"),
      L("Lin family dressing room, morning", "林家更衣室，清晨"),
      L("mixed practicals, mirror bounce", "混合实用光，镜面反射"),
      L(
        "The argument peaks; Lin Wan slowly puts on the veil herself, silencing the room.",
        "争吵到顶点；林晚自己缓缓戴上头纱，全场安静。",
      ),
      ph("shot-001-02"),
    ),
    shot(
      ...
      8,
      L(
        "Low angle from the aisle: the veil lifts, guests' phones rise in the background bokeh.",
        "红毯低机位：头纱掀起，背景虚化中来宾手机纷纷举起。",
      ),
      L("close-up", "特写"),
      L("slow tilt up", "缓慢上摇"),
      L("Hotel wedding hall, noon", "酒店礼堂，正午"),
      L("warm key from chandeliers", "枝形吊灯暖主光"),
    ...
    shot(
      ...
      5,
      L(
        "Tight two-shot at the altar: Gu Chenzhou leans toward the officiant's microphone.",
        "礼台紧凑双人镜头：顾沉舟俯身靠近司仪话筒。",
      ),
      L("two-shot", "双人镜头"),
      L("none", "无运动"),
      L("Hotel wedding hall, noon", "酒店礼堂，正午"),
      L("spotlight, cool rim", "追光加冷轮廓光"),
      L(
        "He corrects one word — the bride's name — and steps back as if nothing happened.",
        "他只纠正了一个词——新娘的名字——随后若无其事退回原位。",
      ),
      ph("shot-001-04"),
      {
        srt: [
          {
            time: "00:00:01,000 --> 00:00:03,400",
            text: L("Gu Chenzhou: The name is Lin Wan.", "顾沉舟：新娘的名字，是林晚。"),
          },
        ],
        audio: {
          dialogue: [
            {
              speaker: L("Gu Chenzhou", "顾沉舟"),
              tone: L("flat, final", "平静而不容置疑"),
              line: L("The name is Lin Wan.", "新娘的名字，是林晚。"),
            },
          ],
    ...
    shot(
      ...
      6,
      L(
        "Insert: pen signs 'Lin Wan' on the register; the jade bracelet rests beside the line.",
        "插入镜头：钢笔在登记册上签下'林晚'，玉镯正搁在签名栏旁。",
      ),
      L("insert", "插入特写"),
      L("rack focus to bracelet", "焦点移向玉镯"),
      L("Registry table, wedding hall", "礼堂登记台"),
      L("soft top light", "柔和顶光"),
      L(
        "The pen pauses over the surname, then commits; a whispered line lands off-screen.",
        "笔尖在姓氏上停顿，随后落笔；画外传来一句耳语。",
      ),
      ph("shot-001-05"),
    ),
    shot(
      ...
      "ep-001",
      "b-001-3",
      L("Cliffhanger look", "结尾对视"),
      "draft",
      4,
      L(
        "Split-lit close-up: Lin Wan turns, half her face in shadow, eyes fixed past camera.",
        "阴阳光特写：林晚转头，半张脸没入阴影，目光越过镜头。",
      ),
      L("close-up", "特写"),
      L("slow push-in", "缓慢推近"),
      L("Wedding hall exit", "礼堂出口"),
      L("split key, amber vs steel blue", "琥珀与钢蓝的阴阳光"),
      L(
        "Her expression shifts from shock to calculation as the episode cuts to black.",
        "她的神情从震惊转为盘算，画面切黑。",
      ),
      "",
    ),
    shot(
      ...
      "ep-002",
      "",
      L("Terms across the table", "隔桌谈判"),
      "approved",
      10,
      L(
        "Wide symmetrical frame: the newlyweds at opposite ends of a twelve-seat dining table, one contract between them.",
        "对称大全景：新婚夫妻分坐十二人长桌两端，中间只有一份契约。",
      ),
      L("wide shot", "大全景"),
      L("slow dolly right", "缓慢右移"),
      L("Gu residence dining room, night", "顾宅餐厅，夜"),
      L("single pendant lamp, pools of dark", "单吊灯，四周暗部"),
      L(
        "Pages slide down the table like a chess move; each clause is initialed without a word.",
        "契约像棋子般沿长桌推过去；每一条款无言签署。",
      ),
      ph("shot-002-01"),
    ),
    shot(
      ...
      "ep-002",
      "",
      L("One condition", "唯一条件"),
      "approved",
      5,
      L(
        "Close-up on Lin Wan's hand crossing out a clause and writing one word: archive.",
        "特写：林晚划掉一条条款，写下两个字：档案。",
      ),
      L("insert", "插入特写"),
      L("locked off", "固定机位"),
      L("Gu residence dining room, night", "顾宅餐厅，夜"),
      L("pendant key, warm", "吊灯暖主光"),
      L(
        "The pen strikes through obedience; the replacement word is short and non-negotiable.",
        "笔尖划掉'服从'，替换的词很短，且没有商量余地。",
      ),
      ph("shot-002-02"),
    ),
    shot(
      ...
      "ep-002",
      "",
      L("Archive door", "档案室之门"),
      "needs_review",
      8,
      L(
        "Tracking shot behind Lin Wan as a brass-and-oak archive door swings open into darkness.",
        "跟拍林晚背影：铜饰橡木档案门缓缓打开，门内一片深暗。",
      ),
      L("medium shot", "中景"),
      L("steadicam follow", "斯坦尼康跟随"),
      L("Lin family archive corridor", "林家档案室走廊"),
      L("practical sconces, deep shadow", "壁灯实用光，深阴影"),
      L(
        "Dust drifts in the doorway light; she steps in without hesitation.",
        "门口光柱里尘埃浮动；她毫不迟疑地走进去。",
      ),
      "",
    ),
    shot(
      ...
      6,
      L(
        "Overhead insert: fingers find the ledger year 2008 — the page is a torn stub.",
        "俯拍插入：手指翻到账册 2008 年——那一页只剩撕痕。",
      ),
      L("overhead insert", "俯拍特写"),
      L("slow push-in", "缓慢推近"),
      L("Lin family archive, night", "林家档案室，夜"),
      L("flashlight beam only", "仅手电光"),
      L(
        "Her fingertip traces the torn edge; somewhere behind her, a floorboard creaks.",
        "指尖抚过撕痕；身后某处地板轻响。",
      ),
      "",
    ),
    shot(
      ...
      8,
      L(
        "Medium shot: Gu Chenzhou opens a wall safe; inside, one photograph faces outward.",
        "中景：顾沉舟打开墙内保险柜，唯一一张照片正面朝外。",
      ),
      L("medium shot", "中景"),
      L("slow arc left", "缓慢左弧移"),
      L("Gu's study, night", "顾沉舟书房，夜"),
      L("desk lamp, cool moonlight fill", "台灯加冷月光补光"),
    ...
    shot(
      ...
      "ep-003",
      "",
      L("Workshop 1998", "1998 的工坊"),
      "needs_review",
      12,
      L(
        "Flashback wide: a young Shen Huilan and Gu's father outside the original workshop, warm film grain.",
        "闪回大全景：年轻的沈慧兰与顾父站在老工坊门前，暖调胶片颗粒。",
      ),
      L("wide shot", "大全景"),
      L("slow zoom out", "缓慢变焦拉远"),
      L("Old workshop street, 1998, dusk", "老工坊街道，1998，黄昏"),
      L("golden hour, film emulation", "黄金时刻，胶片质感"),
      L(
        "The signboard is raised; the same jade bracelet catches the last light.",
        "招牌升起；那只玉镯映着最后一缕天光。",
      ),
      "",
    ),
  ...
  const tasks = [
    {
      ...
      note: L(
        "The dowry-return beat may land too early; confirm against hook rules.",
        "退还聘礼的桥段可能出现过早，请对照钩子规则确认。",
      ),
    },
    {
      id: "task-suman-card",
      ...
      note: L(
        "Back view missing; wardrobe drifts from the pastel rule set for her.",
        "背面视图缺失；服装与她的马卡龙色设定不一致。",
      ),
    },
    {
      ...
      note: L(
        "Six shots boarded; cliffhanger close-up approved for generation.",
        "六个镜头已出板；结尾特写已批准进入生成。",
      ),
    },
  ];
