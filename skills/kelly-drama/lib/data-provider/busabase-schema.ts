...
export const BUSABASE_SCHEMA = {
  provider: "busabase",
  schema_id: "kelly-drama.storage",
  schema_version: "1",
  folder: {
    default_slug: "kelly-drama-workspace",
    children: ["base", "drive"],
  },
  base: {
    id: "kelly-drama",
    slug: "kelly-drama",
    name: "Kelly Drama Records",
    fields: [
      "record_id",
      "kind",
      "title",
  ...
  related_bases: [],
  drive: {
    id: "kelly-drama-files",
    slug: "kelly-drama-workspace-files",
