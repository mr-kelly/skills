...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Social must be Cloud-only");
if (/KELLY_SOCIAL_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Social AirApp checks OK (${files.length} files)`);
