// Pure, storage-agnostic domain logic for kelly-ecommerce-intel — no fs, no
...
export function parseBatchMeta(payload = "") {
  ...
  return {
    ...
    source: meta.source || "kelly-ecommerce-intel",
    vertical: meta.vertical || "e-commerce and cross-border sellers",
    buyer: meta.buyer || "",
    offer: meta.offer || "",
  };
}
