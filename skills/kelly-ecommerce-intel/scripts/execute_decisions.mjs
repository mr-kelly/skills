...
import { operationForDecision } from "../content/kelly-ecommerce-intel-app/app/js/ecommerce-model.js";
...
async function markDone(client, existing, fields, message) {
  return client.records.changeRequest({
    ...
    message,
    author: "kelly-ecommerce-intel-execute-decisions",
...
async function main() {
  ...
  if (!resources.folder || resources.missing.length) {
    throw new Error("Kelly Ecommerce Intel Busabase resources are not provisioned yet; run the AirApp setup first.");
  }
