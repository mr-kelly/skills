...
const AIRAPP_ID = "kelly-contractor-vms";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-contractor-vms" }));
...
app.onError((error, context) => {
  console.error("Contingent Workforce & VMS Vendor Desk server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "33347", 10);
