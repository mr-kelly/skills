...
const AIRAPP_ID = "kelly-patent-radar";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-patent-radar" }));
...
app.onError((error, context) => {
  console.error("IP Patent Landscape & FTO Freedom Desk server error", error instanceof Error ? error.message : error);
