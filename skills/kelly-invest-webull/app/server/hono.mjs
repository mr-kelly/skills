...
import { attachInsights, readConfig, readLock, readOnboarding, readSnapshot, summarizeConfig } from "./store.mjs";
...
async function state() {
  ...
  return {
    ...
    data_provider:
      process.env.KELLY_INVEST_WEBULL_DATA_PROVIDER || configResult.config.data_provider || "local",
    onboarding,
    lock,
