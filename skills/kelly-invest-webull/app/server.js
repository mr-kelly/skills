...
const AIRAPP_ID = "kelly-invest-webull";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-invest-webull" }));
...
app.onError((error, context) => {
  console.error("Kelly Invest (Webull) server error", error instanceof Error ? error.message : error);
