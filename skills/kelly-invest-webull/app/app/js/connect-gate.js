...
function renderWorkspaceScreen(error, onRetry) {
  ...
  const body = canProvision
    ? "<p>Kelly Invest (Webull) will create its Folder and Bases in the current Space.</p><p>Submitted as one idempotent Busabase ChangeRequest; nothing existing is deleted or repurposed. Portfolio data itself is populated only by a trusted Webull sync script, never by this app.</p>"
    : `<p>${escapeHtml(reason)}</p><p>Kelly Invest (Webull) never asks you to create Nodes/Bases by hand or switches to local data.</p>`;
