...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Legal Contracts must be Cloud-only");
if (/KELLY_LEGAL_CONTRACTS_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Legal Contracts AirApp checks OK (${files.length} files)`);
