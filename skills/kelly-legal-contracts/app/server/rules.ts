// Deterministic contract-risk engine. Shared by scripts/run_checks.ts,
...
// applies to the draft's workstream. `claims` is the clause playbook
// (approved fallback clauses + banned/restricted-phrase rules); when supplied,
// the claims_registry rule flags language that trips a rule or leans on a clause
