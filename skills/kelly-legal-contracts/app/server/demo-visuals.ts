...
const SKILL_NAME = "kelly-legal-contracts";
const ACCENTS = ["#1d4ed8", "#be123c"];
const VISUAL_DEFS = [
  {
    id: "kelly-legal-contracts-visual-1",
    title: "Redline page",
    caption: "Synthetic clause redline with risk and fallback annotations.",
    kind: "document",
  },
  {
    id: "kelly-legal-contracts-visual-2",
    title: "Clause checklist",
    caption: "Mock playbook comparison for required contract terms.",
    kind: "sheet",
  },
  {
    id: "kelly-legal-contracts-visual-3",
    title: "Signature packet",
    caption: "Visual contract export packet with attachments and evidence.",
    kind: "gallery",
  },
];
