// Core domain types shared across the kelly-legal-contracts server, rules engine, demo
// scenes, and scripts. These model the ACTUAL shapes produced by demo.ts /
// rules.ts / store.ts and the contract_snapshot.json in references/contracts-schema.md.
// Kept loose (optional fields + index signatures) because snapshots on disk
// evolve and drafts differ by platform.

export type Platform = "nda" | "msa" | "dpa" | "sow" | "amazon" | "shopify" | "tiktok_shop" | "ebay";
