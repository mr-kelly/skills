...
const AIRAPP_ID = "kelly-portrait-retouch";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-portrait-retouch" }));
...
app.onError((error, context) => {
  console.error("Kelly Portrait Retouch server error", error instanceof Error ? error.message : error);
