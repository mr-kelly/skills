#!/usr/bin/env node
// Push this skill's current local content/kelly-disclosure-tracker-app/ code to its deployed AirApp: creates it
...
// change takes effect. Use this after editing content/kelly-disclosure-tracker-app/ files; scripts/setup.mjs
