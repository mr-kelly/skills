...
const AIRAPP_ID = "kelly-disclosure-tracker";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-disclosure-tracker" }));
...
app.onError((error, context) => {
  console.error("Kelly Disclosure Tracker server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3155", 10);
