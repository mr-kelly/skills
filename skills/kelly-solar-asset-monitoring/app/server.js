...
const AIRAPP_ID = "kelly-solar-asset-monitoring";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-solar-asset-monitoring" }));
...
app.onError((error, context) => {
  console.error("Solar Photovoltaic Plant & Health Desk server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "33295", 10);
