...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Radar must be Cloud-only");
if (/KELLY_RADAR_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Radar AirApp checks OK (${files.length} files)`);
