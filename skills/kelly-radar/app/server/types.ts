// Core domain types shared across the kelly-radar server and scripts. These model
// the ACTUAL shapes produced by demo.ts / store.ts / decisions.ts and the
// normalized radar snapshot validated in scripts/validate_ui_schema.ts.
