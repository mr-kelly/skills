...
export function demoStatePayload(query = {}) {
  ...
  return {
    ...
    agent_tasks: { updated_at: now, tasks: [
      { task_id: "task-demo-1", kind: "research_followup", ref_id: "q-mobile-app", note: "Which competitor mobile apps have meaningful ratings volume?", created_at: now, status: "queued" }
    ] },
...
function demoConfigSummary() {
  return {
    ...
    profile: {
      products: [
        { name: "Formlet", positioning: "AI-assisted form builder for docs-first indie teams" }
      ]
    },
    watchlist: [
      ...
      { target_id: "docupad", name: "DocuPad", type: "competitor", source_count: 2, methods: ["browser_agent", "manual"] },
      { target_id: "kw-ai-form-builder", name: "ai form builder", type: "keyword", source_count: 2, methods: ["browser_agent"] },
      { target_id: "community-formbuilders", name: "r/formbuilders", type: "community", source_count: 1, methods: ["browser_agent"] }
    ],
    research_defaults: { default_depth: "standard", source_policy: "public_pages_only", require_citations: true, max_sources: 8 },
    trend_sources: [
      { source_id: "search-rising", kind: "search", name: "Rising search queries", method: "browser_agent" },
      { source_id: "community-hn-reddit", kind: "community", name: "HN / Reddit topic volume", method: "browser_agent" },
...
export function demoSnapshot(scenario = "overview") {
  ...
  return {
    ...
    trends,
    sync_log: [
      { at: "2026-07-02T07:55:00.000Z", actor: "kelly-radar-agent", action: "ingest_signals", detail: "3 new signals from Formora pricing + changelog check, 1 duplicate skipped." },
      { at: "2026-07-01T21:10:00.000Z", actor: "kelly-radar-agent", action: "ingest_trends", detail: "8 trend movers refreshed; 2 rising queries imported from kelly-seo snapshot." },
      { at: "2026-07-01T09:40:00.000Z", actor: "kelly-radar-agent", action: "file_report", detail: "Filed report for 'Should we build a mobile app?' with 5 cited sources." }
    ]
  };
}
...
function demoWatchlist() {
  return [
    target("formora", "Formora", "competitor", "ok", "Closest direct competitor. Watch pricing and AI roadmap weekly.", "2026-07-02T07:50:00.000Z", 4, [
      source("formora-pricing", "pricing", "https://formora.example.com/pricing", "browser_agent", "2026-07-02T07:50:00.000Z", "2026-07-01T18:00:00.000Z"),
      source("formora-changelog", "changelog", "https://formora.example.com/changelog", "browser_agent", "2026-07-02T07:50:00.000Z", "2026-06-30T12:00:00.000Z"),
      source("formora-g2", "reviews", "https://www.g2.example.com/products/formora/reviews", "browser_agent", "2026-07-01T20:15:00.000Z", "2026-06-29T00:00:00.000Z")
    ]),
    target("tallyforge", "TallyForge", "competitor", "ok", "Fast-moving competitor; repositioning toward a docs+forms workspace.", "2026-07-01T20:30:00.000Z", 3, [
      source("tallyforge-pricing", "pricing", "https://tallyforge.example.com/pricing", "browser_agent", "2026-07-01T20:30:00.000Z", "2026-06-28T09:00:00.000Z"),
      source("tallyforge-landing", "landing", "https://tallyforge.example.com", "browser_agent", "2026-07-01T20:30:00.000Z", "2026-06-30T10:00:00.000Z"),
      source("tallyforge-hiring", "hiring", "https://tallyforge.example.com/careers", "browser_agent", "2026-07-01T20:28:00.000Z", "2026-06-27T00:00:00.000Z")
    ]),
    target("docupad", "DocuPad", "competitor", "warning", "Adjacent big player. Their embedded-forms beta could collapse our wedge.", "2026-06-30T22:00:00.000Z", 2, [
      source("docupad-changelog", "changelog", "https://docupad.example.com/whats-new", "browser_agent", "2026-06-30T22:00:00.000Z", "2026-06-30T16:00:00.000Z"),
      source("docupad-news", "news", "https://news.example.com/company/docupad", "manual", "2026-06-29T08:00:00.000Z", "2026-06-26T00:00:00.000Z")
    ]),
    target("kw-ai-form-builder", "ai form builder", "keyword", "ok", "Category keyword. Track launches and SERP movement.", "2026-07-01T21:00:00.000Z", 1, [
      source("ph-ai-forms", "launch", "https://producthunt.example.com/topics/forms", "browser_agent", "2026-07-01T21:00:00.000Z", "2026-06-30T14:00:00.000Z"),
      source("serp-ai-form-builder", "news", "https://search.example.com/?q=ai+form+builder", "browser_agent", "2026-07-01T21:00:00.000Z", "2026-07-01T21:00:00.000Z")
    ]),
    target("community-formbuilders", "r/formbuilders", "community", "stale", "Community pulse. Last crawl older than cadence; re-check due.", "2026-06-28T10:00:00.000Z", 1, [
      source("reddit-formbuilders", "community", "https://reddit.example.com/r/formbuilders", "browser_agent", "2026-06-28T10:00:00.000Z", "2026-06-28T10:00:00.000Z")
    ])
  ];
}
...
function demoSignals() {
  return [
    {
      ...signal("sig-formora-pricing", "formora", "formora-pricing", "pricing", "high", "2026-07-01T18:04:00.000Z", "needs_review",
      ...
      proposed_action: "act",
      handoff: { operation: "handoff_content_brief", target: "kelly-writer", summary: "Comparison page: Formlet vs Formora after the price increase." },
      diff: {
    ...
    {
      ...signal("sig-formora-ai-autofill", "formora", "formora-changelog", "changelog", "high", "2026-06-30T12:20:00.000Z", "needs_review",
    ...
    {
      ...signal("sig-ph-launch-fieldnote", "kw-ai-form-builder", "ph-ai-forms", "launch", "medium", "2026-06-30T14:05:00.000Z", "needs_review",
    ...
    {
      ...signal("sig-formora-reviews", "formora", "formora-g2", "reviews", "medium", "2026-06-29T09:15:00.000Z", "approved",
      ...
      proposed_action: "act",
      handoff: { operation: "handoff_content_brief", target: "kelly-writer", summary: "Migration guide targeting Formora editor complaints, with importer CTA." },
      triage: { kind: "signal", action: "approve", status: "approved", comment: "Yes — brief kelly-writer, lead with the conditional-logic loss.", decided_at: "2026-06-29T10:02:00.000Z" },
      evidence: [
        evidence("G2 reviews, filtered 1-2 stars", "https://www.g2.example.com/products/formora/reviews?stars=1,2"),
        evidence("Reddit thread on the editor migration", "https://reddit.example.com/r/formbuilders/comments/editor_migration")
      ]
    },
    {
      ...signal("sig-docupad-changelog", "docupad", "docupad-changelog", "changelog", "high", "2026-06-30T16:40:00.000Z", "approved",
      ...
      proposed_action: "act",
      handoff: { operation: "add_watch_source", target: "docupad", summary: "Add DocuPad beta docs page as a monitored source (weekly)." },
      triage: { kind: "signal", action: "approve", status: "approved", comment: "Add the beta docs page as a source. Weekly is enough for now.", decided_at: "2026-07-01T08:44:00.000Z" },
      evidence: [
    ...
    {
      ...signal("sig-tallyforge-landing", "tallyforge", "tallyforge-landing", "landing", "medium", "2026-06-30T10:12:00.000Z", "needs_review",
    ...
    {
      ...signal("sig-tallyforge-hiring", "tallyforge", "tallyforge-hiring", "hiring", "low", "2026-06-27T11:00:00.000Z", "done",
      ...
      triage: { kind: "signal", action: "ignore", status: "done", comment: "Covered by the mobile research report. No action.", decided_at: "2026-06-28T09:20:00.000Z" },
      evidence: [evidence("TallyForge careers", "https://tallyforge.example.com/careers/senior-mobile-engineer")]
    },
    {
      ...signal("sig-formora-funding", "formora", "formora-changelog", "news", "medium", "2026-06-26T15:30:00.000Z", "done",
      ...
      proposed_action: "ignore",
      triage: { kind: "signal", action: "ignore", status: "done", comment: "Context only. The pricing and AI signals carry the actions.", decided_at: "2026-06-27T08:10:00.000Z" },
      evidence: [evidence("TechPress: Formora seed extension", "https://news.example.com/2026/06/formora-seed-extension")]
    },
    {
      ...signal("sig-community-thread", "community-formbuilders", "reddit-formbuilders", "community", "low", "2026-06-28T10:05:00.000Z", "needs_review",
      ...
      proposed_action: "watch",
      evidence: [evidence("Thread on r/formbuilders", "https://reddit.example.com/r/formbuilders/comments/client_intake")]
    },
    {
      ...signal("sig-tallyforge-pricing-test", "tallyforge", "tallyforge-pricing", "pricing", "medium", "2026-06-28T09:22:00.000Z", "blocked",
      ...
      triage: { kind: "signal", action: "block", status: "blocked", comment: "Re-crawl over 4 days from two regions, then bring it back.", decided_at: "2026-06-29T07:55:00.000Z" },
      evidence: [
...
function demoResearch() {
  const questions = [
    ...
    },
    {
      ...
      confidence: 4,
      followups: [
        { followup_id: "fu-mobile-ratings", question: "Which competitor mobile apps have meaningful ratings volume?", status: "queued", asked_at: "2026-07-01T09:50:00.000Z" }
      ]
    },
    {
  ...
  const briefs = [
    {
      ...
      depth: "standard",
      scope: "Size the SEA opportunity for form/docs tooling across ID, SG, VN, PH, TH. Segment by solo operators, agencies, and SMB ops teams. Exclude enterprise procurement-led deals.",
      planned_sources: [
      ...
      expected_deliverable: "Cited report: market sizing ranges, top-2 entry segments, localization/payment blockers, and a go/no-go recommendation.",
    ...
    },
    {
      ...
      depth: "quick",
      scope: "Catalog Formora editor complaints from G2, Reddit, and X since the migration. Classify by lost feature, quantify mentions, and map each to our importer coverage.",
      planned_sources: ["G2 review stream", "r/formbuilders threads", "X keyword search", "Our importer feature matrix"],
      expected_deliverable: "Short memo: top complaint clusters with counts, importer gap list, and suggested landing-page claims we can support.",
    ...
    },
    {
      ...
      depth: "deep",
      scope: "Compare native app vs mobile web for form filling and light editing. Benchmark competitor apps, store ratings, and published mobile usage shares for form tools.",
      planned_sources: ["App store listings and ratings", "Competitor changelogs", "Public mobile usage benchmarks", "Our own analytics (mobile share)", "Support ticket themes"],
    ...
    },
    {
      ...
      depth: "standard",
      scope: "Survey pricing models across 12 form-builder competitors; correlate model with public revenue/growth signals where available.",
  ...
  const reports = [
    {
      ...
      summary: "Respondents fill forms on mobile constantly, but creators build on desktop. Competitor native apps are poorly rated and mostly wrap the web view. Recommendation: hold on native for 12 months, ship a best-in-class mobile web filler, and define two triggers that would flip the call.",
      confidence: 4,
      sections: [
        {
      ...
      sources: [
        reportSource("src-benchmark", "Form completion device-share benchmarks 2025", "https://benchmarks.example.com/forms-device-share-2025"),
        reportSource("src-analytics", "Formlet internal analytics: device mix, May-Jun 2026", "local://analytics/device-mix-2026-06"),
        reportSource("src-appstore", "App Store + Play listings: Formora, FormRail", "https://appstore.example.com/formora"),
        reportSource("src-hiring", "TallyForge careers: senior mobile engineer", "https://tallyforge.example.com/careers/senior-mobile-engineer"),
    ...
    },
    {
      ...
      summary: "Category rewards response/feature limits over per-seat pricing for indie and SMB segments. Informed the June pricing revision; kept for reference.",
      confidence: 3,
      sections: [
        {
      ...
      sources: [reportSource("src-pricing-pages", "Competitor pricing page survey, June 2026", "https://archive.example.com/pricing-survey-2026-06")],
      annotations: []
    }
  ];
...
function demoTrends() {
  const movers = [
    mover("mv-ai-form-builder", "ai form builder", "search", 9200, 64, [34, 38, 45, 52, 58, 71, 84, 100], "opp-ai-form-builder"),
    mover("mv-typeform-alternative", "typeform alternative", "search", 6100, 22, [58, 60, 57, 64, 66, 70, 69, 74], ""),
    mover("mv-hipaa-forms", "hipaa compliant forms", "search", 2400, 41, [40, 42, 47, 45, 55, 61, 68, 72], "opp-hipaa-forms"),
    ...
    mover("mv-docs-embedded-forms", "docs with embedded forms", "category", 540, 35, [30, 33, 31, 38, 41, 44, 48, 52], ""),
    mover("mv-conversational-forms", "conversational forms", "community", 460, -12, [66, 61, 58, 60, 54, 50, 49, 47], ""),
  ...
  const opportunities = [
    {
      ...
      rationale: "Search interest up 64% in 8 weeks and three AI-native launches this month. The comparison/alternatives surface is still winnable; in two quarters it will not be.",
      proposed_next_step: {
    ...
    },
    {
      ...
      rationale: "Steady 41% rise from health/wellness solo practices. Competitors gate HIPAA behind $99+ tiers; a $29 HIPAA add-on would undercut the category.",
      proposed_next_step: {
      ...
      triage: { kind: "opportunity", action: "approve", status: "approved", comment: "Queue it for roadmap review with the compliance cost estimate attached.", decided_at: "2026-07-01T08:50:00.000Z" }
    }
  ];
...
function localizeSnapshotZh(snapshot) {
  const signalText = {
    "sig-formora-pricing": ["Formora 将 Pro 价格从 $12 提到 $15/月", "Pro 档涨价 25%，年付折扣从 20% 降到 15%。免费档限制不变。", "$15 以下出现了我们可以占领的价格空档。如果随之出现流失讨论，一个对比页加迁移优惠就能转化他们的年付续费用户。"],
    "sig-formora-ai-autofill": ["Formora 上线 AI 表单自动填充", "更新日志宣布 AI 自动填充：从粘贴文本或上传文档预填答题字段，Pro 及以上可用。", "与我们 Q3 的 AI 收集方向直接重叠。本周应实测，并决定跟进、以文档上下文差异化、还是重新定位。"],
    "sig-ph-launch-fieldnote": ["Product Hunt 新品：Fieldnote — AI 原生表单工具", "新玩家以当日第 3 名、412 票上线。卖点：从一句目标自动生成表单，测试期免费。", "本月第三个 AI 原生表单发布。品类关注度上升，我们的 'ai form builder' 关键词投入会更贵。"],
    "sig-formora-reviews": ["Formora 新编辑器在 G2 出现差评潮", "五天内六条 1-2 星差评，均指向强制迁移到新块编辑器：条件逻辑丢失、加载变慢、无法回滚。", "流失窗口期。他们不满的重度用户正是我们的目标客户——一篇迁移指南加导入工具入口就能承接。"],
    "sig-docupad-changelog": ["DocuPad 开放内嵌表单 Beta", "更新公告：文档内原生表单块，waitlist 制 Beta，暂无逻辑编辑器。定位是『在工作发生的地方收集答案』。", "平台风险。如果 DocuPad 免费捆绑表单，我们文档优先的切入点会收窄。需要把他们的 Beta 文档页纳入每周监控。"],
    "sig-tallyforge-landing": ["TallyForge 重新定位：『文档 + 表单工作台』", "首页主文案从『几分钟做出漂亮表单』改为『现代团队的文档 + 表单工作台』，新增文档与回复表格并排的区块。", "他们在向我们的定位靠拢。一个季度内大概率发生信息对撞——值得立一个研究问题：客户如何描述我们两家。"],
    "sig-tallyforge-hiring": ["TallyForge 招聘资深移动端工程师", "新职位：资深 React Native 工程师，『端到端负责移动填表体验』。", "预示 2-3 个季度后的移动端动作。对我们urgency不高；移动端决策已由研究报告覆盖。"],
    "sig-formora-funding": ["Formora 完成 $4M 种子轮延伸", "TechPress 报道现有投资人领投 $4M，用于『AI 功能和向上市场走』。", "解释了涨价与 AI 速度。作为背景记录即可；行动已由涨价与 AI 两条信号承载。"],
    "sig-community-thread": ["热帖：『我为什么把客户 intake 从大厂表单搬走』", "帖子 280 赞。自由职业者抱怨大厂表单太企业化，评论区在找轻量、可定制、贴近文档的替代品。", "是 intake 机会卡的一手用户声音；多位评论者描述的正是我们的场景。"],
    "sig-tallyforge-pricing-test": ["TallyForge 疑似在 A/B 测试仅年付定价", "相隔一小时的两次抓取返回不同定价页：一个含月付，一个仅年付并把月付改为『联系我们』。", "单一样本无法区分测试与全量。需要跨天、跨地区再抓 3-4 次才能进入 triage。"]
  };
...
function target(target_id, name, type, status, notes, last_check_at, signals_7d, sources) {
  return { target_id, name, type, status, notes, last_check_at, signals_7d, sources };
}

function source(source_id, kind, url, method, last_check_at, last_change_at) {
  return { source_id, kind, url, method, last_check_at, last_change_at };
}

function signal(signal_id, target_id, source_id, source_kind, severity, detected_at, status, headline, summary, why_it_matters) {
  return {
    signal_id,
    target_id,
    source_id,
...
function evidence(title, url) {
  return { title, url };
}

function reportSource(source_id, title, url) {
  return { source_id, title, url, accessed_at: now };
}

function mover(mover_id, keyword, sourceKind, volume_proxy, delta_pct, momentum, opportunity_id) {
  return {
    mover_id,
    keyword,
    source: sourceKind,
