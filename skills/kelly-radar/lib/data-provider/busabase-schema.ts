...
export const BUSABASE_SCHEMA = {
  provider: "busabase",
  schema_id: "kelly-radar.storage",
  schema_version: "1",
  folder: {
    default_slug: "kelly-radar-workspace",
    children: ["base", "drive"],
  },
  base: {
    id: "kelly-radar",
    slug: "kelly-radar",
    name: "Kelly Radar Records",
    fields: [
      "record_id",
      "kind",
      "title",
  ...
  related_bases: [],
  drive: {
    id: "kelly-radar-files",
    slug: "kelly-radar-workspace-files",
