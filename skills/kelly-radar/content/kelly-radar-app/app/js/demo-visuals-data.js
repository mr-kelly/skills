...
const SKILL_NAME = "kelly-radar";
const ACCENTS = ["#7c3aed", "#0f766e"];
const VISUAL_DEFS = [
  {
    id: "kelly-radar-visual-1",
    title: "Signal screenshot",
    caption: "Synthetic market signal capture with source and confidence.",
    kind: "document",
  },
  {
    id: "kelly-radar-visual-2",
    title: "Watchlist card",
    caption: "Mock product/company watch card with follow-up questions.",
    kind: "profile",
  },
  {
    id: "kelly-radar-visual-3",
    title: "Trend report",
    caption: "Visual trend brief with chart and evidence links.",
    kind: "chart",
  },
];
