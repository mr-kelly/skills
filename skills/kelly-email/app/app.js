...
const I18N = {
  en: {
    ...
    "filter.approved.tooltip": "You approved an action. /kelly-email can execute approved archive/mark-read actions when asked.",
    "filter.done": "Done",
    ...
    "bulk.approve.tooltip": "Approve each selected item's current plan in the local file. /kelly-email will execute approved archive/mark-read actions when asked.",
    ...
    "detail.approve.tooltip": "Approve the suggested plan for this message. This only writes a local decision; /kelly-email executes approved archive/mark-read actions when asked.",
  ...
  "zh-CN": {
    ...
    "filter.approved": "已批准",
    "filter.approved.tooltip": "你已批准操作。/kelly-email 会在你要求处理时执行已批准的归档/已读操作。",
    "filter.done": "完成",
    ...
    "bulk.approve.tooltip": "批准所选项目当前的方案，只写入本地文件。你要求处理时，/kelly-email 会执行已批准的归档/已读操作。",
    "bulk.review.tooltip": "把所选邮件交回 /kelly-email 等待人工查看；不会执行邮箱操作。",
    "bulk.no_action.tooltip": "在这个批次里记录所选邮件无需操作。",
    "detail.approve.tooltip": "批准这封邮件的建议方案。这只写入本地决定；你要求处理时，/kelly-email 会执行已批准的归档/已读操作。",
