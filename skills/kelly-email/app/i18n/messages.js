export const I18N = {
  en: {
    "brand.subtitle": "Email review desk",
    "filter.all": "All",
    "filter.all.tooltip": "Everything in the current provider batch.",
    ...
    "lock.title": "Locked",
    "lock.default": "The provider state is locked for a moment.",
    ...
    "guide.how_body":
      "<code>/kelly-email</code> reads mail and writes review state through the selected data provider. After you approve items here, ask <code>/kelly-email</code> to execute approved decisions.",
    ...
    "files.title": "Data Provider Files",
    "files.data_reader": "Data reader",
    "files.data_provider": "Data provider",
    "files.provider_status": "Provider status",
    "files.folder_node": "Folder node",
    "files.base_node": "Base node",
    "files.contacts_base_node": "Contacts Base node",
    "files.drive_node": "Drive node",
    "files.batch_file": "Batch file",
    "files.contacts_file": "Contacts table",
    ...
    "files.no_contacts": "No contacts table",
    ...
    "config.recommended": "Busabase provider storage:",
    "config.alternative": "Local provider files:",
    "config.reader":
      "Kelly Email reads configuration and review state through the selected data provider. Local mode uses app files; Busabase mode stores config and app state in Drive, structured rows in Base, and secrets in Busabase Vault.",
    "config.json":
      "JSON stores accounts, aliases, identities, user profile, brands, official URLs, knowledge sources, style, CTA URLs, and risk keywords. Busabase mode stores secret values in Busabase Vault and references them by vault_ref.",
    "provider.banner.title": "Data Provider Not Ready",
    "provider.banner.action": "Open Settings",
    "provider.gate.title": "Set up Kelly Email",
    "setup.title": "Set up Kelly Email",
    "setup.choose_provider":
      "Choose where Kelly Email should store review data, then let /kelly-email finish account setup.",
    "setup.choose_action":
      "Pick Local files for a private single-machine setup, or Busabase for shared Bases, Drive, and Vault.",
    "setup.next_action": "Use the suggested prompt below, or open Help & Settings for exact storage paths.",
    "setup.local.title": "Local files",
    "setup.local.body": "Private on this Mac. Fastest way to start.",
    "setup.busabase.title": "Busabase",
    "setup.busabase.body": "Shared workspace with Bases, Drive, and Vault.",
    "setup.busabase.hosting.cloud": "Cloud / Enterprise",
    "setup.busabase.hosting.cloud_body": "Hosted Busabase. Needs a Space ID and an API key.",
    "setup.busabase.hosting.self_hosted": "Open Source / Personal",
    "setup.busabase.hosting.self_hosted_body": "Self-hosted Busabase you run yourself. Only needs a Base URL, no key.",
    ...
    "setup.busabase.base_url_required": "Base URL is required.",
    "setup.busabase.space_id_required": "Space ID is required for Busabase Cloud.",
    "setup.busabase.hosting_aria": "Busabase hosting",
    "setup.provider_choices_aria": "Data provider choices",
    "setup.next": "Next",
    "setup.back": "Back",
    "setup.busabase.connect_title": "Connect Busabase",
    "setup.busabase.continue": "Continue",
    "setup.busabase.reconfigure": "Change Busabase connection",
    "setup.change_provider": "Change data provider",
    "setup.busabase.autosave_saving": "Saving…",
    "setup.busabase.autosave_saved": "Saved",
    "setup.busabase.autosave_error": "Couldn't save — check the fields above.",
    ...
    "setup.prompt_title.provider": "Suggested prompt · {provider}",
    "setup.copy_prompt": "Copy prompt",
    "setup.prompt_copied": "Prompt copied",
    "setup.provider_saved": "{provider} provider selected",
    "setup.ready": "Ready",
    "setup.todo": "Todo",
    "setup.choose_first": "Choose a provider first",
    "setup.local_storage": "Local provider uses files",
    "setup.check.provider": "Provider selected",
    "setup.check.connection": "Storage connection",
    "setup.check.folder": "Workspace folder",
    "setup.check.base": "Emails Base",
    "setup.check.contacts": "Contacts Base",
    "setup.check.drive": "Drive",
    "setup.check.config": "Email account config",
    "setup.check.secrets": "Secrets",
    "setup.list_empty": "Finish setup to load a review batch.",
    "setup.detail_empty": "The setup guide is open. Choose a provider and copy the next prompt.",
    "setup.prompt.choose":
      "/kelly-email 帮我启动 Kelly Email。先引导我选择 local data provider 还是 busabase data provider；不要让我在聊天里贴密码。",
    "setup.prompt.local":
      "/kelly-email 帮我用 Local data provider 配置 Kelly Email 邮箱账号。请把非秘密配置写到 {config}，secret 值用 {env} 里的 env var 引用；不要让我在聊天里贴密码，只告诉我需要哪些 env var。",
    "setup.prompt.busabase":
      "/kelly-email 帮我用 Busabase data provider 配置 Kelly Email 邮箱账号。Busabase URL={baseUrl}，Base ID={baseId}，API key env={apiKeyEnv}。请把非秘密配置写到 {config}，secret 值放在 {vault} 并用 vault_ref 引用；不要让我在聊天里贴密码，只告诉我需要哪些 Vault secret key。",
    "provider.mode": "Mode",
    "provider.state": "State",
    "provider.ready": "Ready",
    "provider.not_ready": "Provider not ready",
    "provider.base_url": "Base URL",
    "provider.base_id": "Base ID",
    "provider.drive_id": "Drive ID",
    "provider.error": "Error",
    "provider.schema": "Schema",
    "provider.ready_message": "Kelly Email can read and write review state.",
    "provider.not_ready_message": "Kelly Email cannot write review state yet.",
    "provider.default_action": "Configure the selected data provider, then refresh this page.",
    "provider.toast": "Data provider is not ready. Open Help & Settings for setup details.",
    ...
    "bulk.approve.tooltip":
      "Approve each selected item's current plan in the selected data provider. /kelly-email still applies the final safety gate before touching email.",
    "bulk.review.tooltip":
    ...
    "detail.approve.tooltip":
      "Approve the suggested plan for this message. This only writes a review decision; /kelly-email still checks safety before execution.",
    ...
    "detail.no_action.tooltip": "Record no action for this message in the current review state.",
    "detail.save.tooltip": "Save this note to the current review state. It does not touch email.",
    ...
    "detail.back_to_list": "← Messages",
    "detail.from": "From",
    "detail.to": "To",
    "detail.source_account": "Source account",
    "detail.reply_identity": "Reply as",
    "detail.date": "Date",
    ...
    "label.status.needs_review": "needs review",
    "label.status.prepared": "prepared",
    "label.status.executed": "executed",
    "label.status.draft_requested": "draft requested",
    "label.category.product": "product",
    "label.category.privacy": "privacy",
    "label.category.newsletter": "newsletter",
    "label.category.money": "money",
    "label.category.security": "security",
    "label.category.partnership": "partnership",
    "label.category.customer": "customer",
    "label.category.ops": "ops",
    "label.category.brand": "brand",
    "label.risk.security": "security",
    "label.risk.identity": "identity",
    ...
    "account.add_body":
      "Tell the agent what mailbox, aliases, identity, folders, and provider you want. Keep passwords in the selected secret store only.",
    ...
    "toast.saved_count": "Saved decision for {count} item(s)",
    "toast.saved_detail": "Saved review note",
  },
  "zh-CN": {
    "brand.subtitle": "邮件审批台",
    "filter.all": "全部",
    "filter.all.tooltip": "当前 provider 批次里的所有项目。",
    ...
    "lock.title": "已锁定",
    "lock.default": "当前 provider 状态暂时被锁定。",
    ...
    "guide.how_body":
      "<code>/kelly-email</code> 读取邮件，并通过当前选择的数据提供方写入审核状态。你在这里批准后，再让 <code>/kelly-email</code> 执行已批准的决定。",
    ...
    "files.data_provider": "数据提供方",
    "files.provider_status": "提供方状态",
    "files.folder_node": "文件夹节点",
    "files.base_node": "邮件 Base 节点",
    "files.contacts_base_node": "联系人 Base 节点",
    "files.drive_node": "Drive 节点",
    "files.batch_file": "批次文件",
    "files.contacts_file": "联系人表",
    "files.decision_file": "决定文件",
    "files.config_source": "配置来源",
    "files.not_loaded": "未加载",
    "files.no_batch": "没有批次文件",
    "files.no_contacts": "没有联系人表",
    ...
    "theme.graphite": "石墨色",
    "config.title": "配置",
    "config.recommended": "Busabase provider 存储：",
    "config.alternative": "Local provider 文件：",
    "config.reader":
      "Kelly Email 会通过当前选择的数据提供方读取配置和审核状态。本地模式使用 app 文件；Busabase 模式把 config 和 app state 放在 Drive、结构化记录放在 Base、密钥放在 Busabase Vault。",
    "config.json":
      "JSON 保存账号、别名、身份、用户资料、品牌、官方链接、知识来源、风格、CTA 链接和风险关键词。Busabase 模式把密钥值放在 Busabase Vault，并用 vault_ref 引用。",
    "provider.banner.title": "数据提供方未就绪",
    "provider.banner.action": "打开设置",
    "provider.gate.title": "设置 Kelly Email",
    "setup.title": "设置 Kelly Email",
    "setup.choose_provider": "请选择 Kelly Email 的审核数据存在哪里，然后让 /kelly-email 继续配置邮箱账号。",
    "setup.choose_action": "Local files 适合本机私有使用；Busabase 适合共享 Base、Drive 和 Vault。",
    "setup.next_action": "复制下面的提示词继续，或打开帮助与设置查看具体存储位置。",
    "setup.local.title": "Local files",
    "setup.local.body": "只在这台 Mac 上使用，最快开始。",
    "setup.busabase.title": "Busabase",
    "setup.busabase.body": "共享工作区，包含 Bases、Drive 和 Vault。",
    "setup.busabase.hosting.cloud": "云版 / 企业版",
    "setup.busabase.hosting.cloud_body": "托管版 Busabase，需要 Space ID 和 API key。",
    "setup.busabase.hosting.self_hosted": "开源版 / 个人版",
    "setup.busabase.hosting.self_hosted_body": "自己部署的开源 Busabase，只需要 Base URL，不需要密钥。",
    "setup.busabase.base_url_label": "Base URL",
    "setup.busabase.space_id_label": "Space ID",
    "setup.busabase.api_key_label": "API key",
    ...
    "setup.busabase.base_url_required": "请填写 Base URL。",
    "setup.busabase.space_id_required": "Busabase 云版需要填写 Space ID。",
    "setup.busabase.hosting_aria": "Busabase 部署方式",
    "setup.provider_choices_aria": "数据 provider 选项",
    "setup.next": "下一步",
    "setup.back": "返回",
    "setup.busabase.connect_title": "连接 Busabase",
    "setup.busabase.continue": "继续",
    "setup.busabase.reconfigure": "修改 Busabase 连接",
    "setup.change_provider": "更换存储方式",
    "setup.busabase.autosave_saving": "保存中…",
    "setup.busabase.autosave_saved": "已保存",
    "setup.busabase.autosave_error": "保存失败，请检查上面的字段。",
    "setup.ready_title": "Kelly Email",
    "setup.state.needs_config":
      "请把 config.example.json 复制为 ~/.config/kelly-email/config.json，填写邮箱账号、身份、用户资料、风格、官方链接和知识来源，再把密钥加到 ~/.config/kelly-email/.env，然后才能扫描邮件。",
    "setup.state.missing_secrets": "配置已存在，但还缺少必需的密钥环境变量或 Vault 引用。",
    "setup.state.ready": "配置已就绪。",
    "setup.busabase.connected": "已连接 Busabase。",
    "setup.prompt_title": "建议提示词",
    "setup.prompt_title.provider": "建议提示词 · {provider}",
    "setup.copy_prompt": "复制提示词",
    "setup.prompt_copied": "提示词已复制",
    "setup.provider_saved": "已选择 {provider} provider",
    "setup.ready": "已就绪",
    "setup.todo": "待处理",
    "setup.choose_first": "请先选择 provider",
    "setup.local_storage": "Local provider 使用本地文件",
    "setup.check.provider": "已选择 provider",
    "setup.check.connection": "存储连接",
    "setup.check.folder": "工作区文件夹",
    "setup.check.base": "邮件 Base",
    "setup.check.contacts": "联系人 Base",
    "setup.check.drive": "Drive",
    "setup.check.config": "邮箱账号配置",
    "setup.check.secrets": "密钥",
    "setup.list_empty": "完成设置后会加载审核批次。",
    "setup.detail_empty": "设置向导已打开。请选择 provider，并复制下一步提示词。",
    "setup.prompt.choose":
      "/kelly-email 帮我启动 Kelly Email。先引导我选择 local data provider 还是 busabase data provider；不要让我在聊天里贴密码。",
    "setup.prompt.local":
      "/kelly-email 帮我用 Local data provider 配置 Kelly Email 邮箱账号。请把非秘密配置写到 {config}，secret 值用 {env} 里的 env var 引用；不要让我在聊天里贴密码，只告诉我需要哪些 env var。",
    ...
    "provider.state": "状态",
    "provider.ready": "已就绪",
    "provider.not_ready": "提供方未就绪",
    "provider.base_url": "Base URL",
    "provider.base_id": "Base ID",
    "provider.drive_id": "Drive ID",
    "provider.error": "错误",
    "provider.schema": "Schema",
    "provider.ready_message": "Kelly Email 可以读写审核状态。",
    "provider.not_ready_message": "Kelly Email 目前还不能写入审核状态。",
    "provider.default_action": "请先配置当前选择的数据提供方，然后刷新页面。",
    "provider.toast": "数据提供方未就绪。请打开帮助与设置查看配置说明。",
    ...
    "detail.no_action.tooltip": "在当前审核状态里记录这封邮件无需操作。",
    "detail.save.tooltip": "把备注保存到当前审核状态；不会碰邮箱。",
    ...
    "detail.review": "审核",
    "detail.back_to_list": "← 邮件列表",
    "detail.from": "发件人",
    "detail.to": "收件人",
    "detail.source_account": "来源账号",
    "detail.reply_identity": "回复身份",
    "detail.date": "日期",
    "detail.status": "状态",
    "detail.next": "下一步",
    ...
    "unknown.sender": "（未知）",
    "unknown.subject": "（无主题）",
    "account.unknown": "未知账号",
    "identity.unknown": "未知身份",
    "badge.new": "新",
    "badge.other": "其他",
    ...
    "label.status.needs_review": "需复核",
    "label.status.prepared": "已准备",
    "label.status.executed": "已执行",
    "label.status.draft_requested": "已请求草稿",
    "label.category.product": "产品",
    "label.category.privacy": "隐私",
    "label.category.newsletter": "简报",
    "label.category.money": "财务",
    "label.category.security": "安全",
    "label.category.partnership": "合作",
    "label.category.customer": "客户",
    "label.category.ops": "运营",
    "label.category.brand": "品牌",
    "label.risk.security": "安全",
    "label.risk.identity": "身份",
    ...
    "toast.saved_count": "已为 {count} 项保存决定",
    "toast.saved_detail": "已保存审核备注",
  },
};
