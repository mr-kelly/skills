...
const SKILL_NAME = "kelly-email";
const ACCENTS = ["#2563eb", "#64748b"];
const VISUAL_DEFS = [
  {
    id: "kelly-email-visual-1",
    title: "Inbox screenshot",
    caption: "Synthetic customer email with safe sender and subject data.",
    kind: "document",
  },
  {
    id: "kelly-email-visual-2",
    title: "Attachment preview",
    caption: "Mock image/PDF attachment card used for reply context.",
    kind: "receipt",
  },
  {
    id: "kelly-email-visual-3",
    title: "Reply draft",
    caption: "Visual approval card with tone, CTA, and citation slots.",
    kind: "sheet",
  },
];
