export const I18N = {
  en: {
    ...
    "list.loaded_items": "{loaded} of {total} items",
    "list.load_more": "Load more",
    "list.loading_more": "Loading...",
    "list.load_more_failed": "Could not load the next page. Try again.",
    ...
    "guide.how_body":
      "<code>/kelly-email</code> reads mail into Busabase. This AirApp proposes review decisions; after they are reviewed, ask <code>/kelly-email</code> to execute approved decisions.",
    ...
    "config.recommended": "Busabase resources:",
    "config.reader":
      "Kelly Email stores settings and structured review state in Bases, file artifacts in Drive, and secret values in Busabase Vault.",
    "config.json":
      "Email Settings stores accounts, aliases, identities, user profile, brands, official URLs, knowledge sources, style, CTA URLs, risk keywords, and Vault references.",
    "provider.banner.title": "Workspace Not Ready",
    "provider.banner.action": "Open Settings",
    "provider.gate.title": "Set up Kelly Email",
    "setup.title": "Set up Kelly Email",
    "setup.next_action": "Use the suggested prompt below, or open Help & Settings for the declared resources.",
    ...
    "local.connect.body": "Local preview needs a Busabase session before it can read app resources.",
    "local.connect.expired": "Your local login expired. Connect again.",
    ...
    "setup.detail_empty": "The setup guide is open. Complete Email Settings and Vault readiness.",
    "provider.mode": "Mode",
    ...
    "provider.default_action": "Complete the declared Busabase resources, Email Settings, and Vault references.",
    "provider.toast": "Kelly Email is not ready. Open Help & Settings for setup details.",
    ...
    "bulk.approve.tooltip":
      "Propose each selected item's current plan in Busabase. /kelly-email still applies the final safety gate before touching email.",
    "bulk.review.tooltip":
    ...
    "account.add_body":
      "Tell the agent what mailbox, aliases, identity, and folders you want. Keep passwords only in Busabase Vault.",
    ...
    "toast.submitted_review": "Change submitted for Busabase review",
    "toast.submitted_review_count": "Submitted {count} decision(s) for Busabase review",
  ...
  "zh-CN": {
    ...
    "list.select": "选择",
    "list.items": "{count} 项",
    "list.loaded_items": "已加载 {loaded} / {total} 项",
    "list.load_more": "加载更多",
    "list.loading_more": "正在加载...",
    "list.load_more_failed": "下一页加载失败，请重试。",
    "list.account": "账号",
    ...
    "guide.how_body":
      "<code>/kelly-email</code> 把邮件写入 Busabase。AirApp 只提交审核决定；决定经审核后，再让 <code>/kelly-email</code> 执行。",
    ...
    "setup.next_action": "复制下面的提示词继续，或打开帮助与设置查看声明资源。",
    "setup.ready_title": "Kelly Email",
    "setup.state.needs_config":
      "请在 Email Settings 新增 kelly-email-config 记录，再把引用的密钥值加入 Busabase Vault，然后才能扫描邮件。",
    "setup.state.missing_secrets": "配置已存在，但还有必需的 Vault 引用未就绪。",
    ...
    "local.connect.body": "本地预览需要先建立 Busabase 会话，之后才会读取应用资源。",
    "local.connect.expired": "本地登录已过期，请重新连接。",
    "local.connect.custom": "自定义服务器",
    "local.connect.custom_hint": "自托管或企业版 Busabase",
    "local.connect.action": "连接 Busabase",
    "local.connect.security": "OAuth 凭证只保存在 ~/.busabase/airapps",
    "local.demo": "进入只读 Demo",
    "local.space.title": "选择 Busabase Space",
    "local.space.body": "已完成 {server} 鉴权。请选择 Kelly Email 读取和初始化资源的 Space。",
    "local.space.action": "使用此 Space",
    "local.space.security": "确认前不会检查或初始化任何应用资源。",
    "local.space.error": "无法选择 Space。",
    "setup.list_empty": "完成设置后会加载审核批次。",
    "setup.detail_empty": "设置向导已打开。请完成 Email Settings 和 Vault 就绪检查。",
    "provider.mode": "模式",
    "provider.state": "状态",
    "provider.ready": "已就绪",
    ...
    "provider.default_action": "请完成声明的 Busabase 资源、Email Settings 和 Vault 引用。",
    "provider.toast": "Kelly Email 尚未就绪。请打开帮助与设置查看配置说明。",
    ...
    "toast.submitted_review": "变更已提交 Busabase 审核",
    "toast.submitted_review_count": "已提交 {count} 项决定，等待 Busabase 审核",
