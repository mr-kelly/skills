...
const ACCENTS = ["#be123c", "#0f766e"];
const VISUAL_DEFS = [
  {
    id: "kelly-brand-visual-1",
    title: "Narrative board",
    caption: "Mock message-house canvas with pillars, proof, and forbidden claims.",
    kind: "board",
  },
  {
    id: "kelly-brand-visual-2",
    title: "Proof-point screenshot",
    caption: "Synthetic customer quote and product proof card.",
    kind: "profile",
  },
  {
    id: "kelly-brand-visual-3",
    title: "Drift examples",
    caption: "Visual comparison between canonical copy and off-brand variants.",
    kind: "gallery",
  },
];
