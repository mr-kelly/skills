...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Brand must be Cloud-only");
if (/KELLY_BRAND_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Brand AirApp checks OK (${files.length} files)`);
