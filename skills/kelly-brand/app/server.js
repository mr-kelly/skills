...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-brand" }));
...
app.onError((error, context) => {
  console.error("Kelly Brand server error", error instanceof Error ? error.message : error);
