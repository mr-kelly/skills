...
const SKILL_NAME = "kelly-brand";
const ACCENTS = ["#2563eb", "#f97316"];
const VISUAL_DEFS = [
  {
    id: "kelly-brand-visual-1",
    title: "Message house diagram",
    caption: "Synthetic positioning-statement roof with value-pillar columns.",
    kind: "gallery",
  },
  {
    id: "kelly-brand-visual-2",
    title: "Story bank cards",
    caption: "Mock customer-story and proof-point cards with evidence chips.",
    kind: "board",
  },
  {
    id: "kelly-brand-visual-3",
    title: "Drift alert compare",
    caption: "Visual offending-usage vs. canonical-guidance comparison.",
    kind: "sheet",
  },
];
