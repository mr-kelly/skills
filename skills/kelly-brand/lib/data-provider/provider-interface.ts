// The data-provider contract for kelly-brand + a runtime consistency guard.
//
// kelly-brand's unit of work is a narrative asset under review-before-adopt.
...
export interface DataProvider {
  ...
  /** Apply a human verdict to a narrative item / drift alert; returns decisions. */
  ...
  /** Persist a brand narrative snapshot (generate_demo_snapshot). */
