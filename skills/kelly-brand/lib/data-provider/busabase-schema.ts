...
export const BUSABASE_SCHEMA = {
  provider: "busabase",
  schema_id: "kelly-brand.storage",
  schema_version: "1",
  folder: {
    default_slug: "kelly-brand-workspace",
    children: ["base", "drive"],
  },
  base: {
    id: "kelly-brand",
    slug: "kelly-brand",
    name: "Kelly Brand Records",
    fields: [
      "record_id",
      "kind",
      "title",
  ...
  related_bases: [],
  drive: {
    id: "kelly-brand-files",
    slug: "kelly-brand-workspace-files",
