...
//
// kelly-brand is an App-in-Skill whose unit of work — a narrative asset under
// review-before-adopt — maps cleanly onto Busabase's review model
...
export async function createProvider(): Promise<DataProvider> {
  ...
  throw new Error(`Unknown KELLY_BRAND_DATA_PROVIDER: "${kind}" (expected "local" or "busabase")`);
}
