...
const AIRAPP_ID = "kelly-local-model-lab";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-local-model-lab" }));
...
app.onError((error, context) => {
  console.error("kelly-local-model-lab server error", error instanceof Error ? error.message : error);
