...
const AIRAPP_ID = "kelly-api-governance";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-api-governance" }));
...
app.onError((error, context) => {
  console.error(
    "API Lifecycle & Schema Governance Console server error",
