...
if (!configText.includes('deployment: "cloud"')) throw new Error("LLM Gateway must be Cloud-only");
if (/KELLY_LLM_GATEWAY_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`LLM Gateway AirApp checks OK (${files.length} files)`);
