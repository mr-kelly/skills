...
const AIRAPP_ID = "kelly-deal-scorer";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-deal-scorer" }));
...
app.onError((error, context) => {
  console.error("Kelly Deal Scorer server error", error instanceof Error ? error.message : error);
