...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Deal Scorer must be Cloud-only");
if (/KELLY_DEAL_SCORER_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Deal Scorer AirApp checks OK (${files.length} files)`);
