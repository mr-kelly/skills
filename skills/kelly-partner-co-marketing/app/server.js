...
const AIRAPP_ID = "kelly-partner-co-marketing";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-partner-co-marketing" }));
...
app.onError((error, context) => {
  console.error("Co-Marketing MDF Request & ROI Console server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "33389", 10);
