// Core domain types shared across the kelly-mv server, services, and scripts.
// These model the ACTUAL shapes produced by project-store.ts / demo.ts / state.ts
// and the project.json snapshot. Kept loose (optional fields + index signatures)
// because projects on disk evolve and older projects carry legacy fields.
