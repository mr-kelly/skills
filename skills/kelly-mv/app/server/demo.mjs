...
export function demoSongConfigPayload(query = {}) {
  return {
...
function completeness(project) {
  ...
  return {
    ...
    characters_missing_refs: (project.characters || []).filter((c) => !c.reference_card?.image_asset?.startsWith("/generated/")).length,
...
function demoProject(zh) {
  ...
  const characters = [
    castMember("char-demo-dreamer", L("The Dreamer", "追光者"), L("lead dancer", "领舞 / 主角"), "approved", {
      front: L("Early 20s, buzzed silver hair, reflective bomber jacket over black.", "二十出头，银色寸头，黑衣外罩反光飞行夹克。"),
      ...
      wardrobe: L("Reflective bomber, black cargo trousers, worn white trainers.", "反光飞行夹克、黑色工装裤、旧白球鞋。"),
    ...
    }, L("Cinematic full-body reference of the lead dancer under mixed neon, 35mm look.", "混合霓虹光下领舞的全身电影感定妆照，35mm 质感。"), "/generated/demo/cast-dreamer.svg"),
    castMember("char-demo-stranger", L("The Stranger", "陌生人"), L("mirrored counterpart", "镜像对手"), "approved", {
      front: L("Ageless, long charcoal coat, face half-lit at all times.", "年龄难辨，炭色长大衣，面部永远只被照亮一半。"),
    ...
    }, L("Half-lit portrait reference, charcoal coat, teal rim light.", "半侧光定妆照，炭色大衣，青色轮廓光。"), "/generated/demo/cast-stranger.svg"),
    castMember("char-demo-tide-girl", L("Tide Girl", "潮汐少女"), L("chorus apparition", "副歌幻影"), "needs_review", {
      front: L("Teenage silhouette in a translucent rain cape that catches every neon color.", "少女剪影，半透明雨披映出所有霓虹色。"),
      ...
      forbidden_drift: [],
    }, L("Backlit reference through a translucent cape, prismatic neon spill.", "逆光透过半透明雨披的定妆照，霓虹折射成棱镜色。"), "/generated/demo/cast-tide-girl.svg"),
    castMember("char-demo-band", L("The Band", "乐队"), L("rooftop performers (finale)", "天台演出者（终章）"), "draft", {
      front: L("Three-piece band in matching workwear, instruments taped with reflective strips.", "三人乐队着同款工装，乐器贴反光条。"),
      side: "",
      back: "",
    ...
    castMember("char-demo-night-runner", L("Night Runner", "夜跑者"), L("recurring background motif", "反复出现的背景符号"), "draft", {
      front: L("Runner in a light-strip vest who passes through every chorus street.", "身穿灯带背心的跑者，每段副歌的街道都会经过。"),
      side: "",
      back: "",
  ...
  const shots = [
    mvShot("shot-demo-01", L("Dusk skyline (establishing)", "黄昏天际线（建立镜）"), "approved", 8,
      L("Wide static frame: the coastal city at dusk, first neon signs flickering on street by street.", "大全景固定机位：黄昏的海滨城市，霓虹招牌一条街一条街依次亮起。"),
      L("Neon signs ignite in sequence toward the camera.", "霓虹由远及近依次点亮。"),
      ["char-demo-dreamer"], "/generated/demo/shot-dusk-skyline.svg"),
    mvShot("shot-demo-02", L("Bus door opens", "巴士开门"), "approved", 4,
      L("Medium shot: the Dreamer steps off the last bus into a puddle of amber light.", "中景：追光者走下末班巴士，踏进一滩琥珀色灯光。"),
      L("Door hiss, one step down, puddle ripples with light.", "车门嘶响，迈步而下，水洼里光纹荡开。"),
      ["char-demo-dreamer"], "/generated/demo/shot-bus-door.svg"),
    mvShot("shot-demo-03", L("Shop-glass reflections", "橱窗倒影"), "approved", 6,
      L("Tracking along shop windows: the Dreamer's reflection multiplies across five panes of glass.", "沿橱窗横移：追光者的倒影在五面玻璃间层层复制。"),
      L("Lateral tracking, reflections walking out of sync.", "横向跟拍，倒影彼此错拍行走。"),
      ["char-demo-dreamer"], "/generated/demo/shot-shop-glass.svg"),
    mvShot("shot-demo-04", L("First chorus: tide line", "第一段副歌：潮线"), "approved", 10,
      L("Low wide shot: a line of neon light rises up the street like a tide mark, the Dreamer dancing at its edge.", "低机位大全景：霓虹光线如潮痕沿街升起，追光者在光线边缘起舞。"),
      L("Light line rises steadily; dance steps trace the waterline.", "光线稳定上升，舞步沿'水线'展开。"),
      ["char-demo-dreamer", "char-demo-tide-girl"], "/generated/demo/shot-tide-line.svg"),
    mvShot("shot-demo-05", L("Crosswalk surge", "斑马线人潮"), "needs_review", 5,
      L("Overhead shot: a crosswalk crowd surges around the motionless Dreamer.", "俯拍：人潮涌过斑马线，追光者静止其中。"),
      L("Crowd in 2x speed, subject at normal speed.", "人群两倍速，主体正常速。"),
      ["char-demo-dreamer"], "/generated/demo/shot-crosswalk.svg"),
    mvShot("shot-demo-06", L("The Stranger's glance", "陌生人的一瞥"), "needs_review", 6,
      L("Close-up across the street: the Stranger's half-lit face turns toward camera for the first time.", "街对面特写：陌生人半明半暗的脸第一次转向镜头。"),
      L("Slow head turn, neon flicker across the lit half.", "缓慢转头，霓虹在受光半脸上闪烁。"),
      ["char-demo-stranger"], "/generated/demo/shot-stranger-glance.svg"),
    mvShot("shot-demo-07", L("Arcade duet", "电玩厅双人舞"), "approved", 12,
      L("Steadicam through a closed arcade: the Dreamer and their own reflection dance a duet between machines.", "斯坦尼康穿过打烊的电玩厅：追光者与自己的倒影在机台间共舞。"),
      L("One continuous move weaving between cabinets.", "一镜到底穿行于机台之间。"),
      ["char-demo-dreamer"], "/generated/demo/shot-arcade-duet.svg"),
    mvShot("shot-demo-08", L("Rain begins", "雨落"), "draft", 4,
      L("Insert: first raindrops hit a neon-lit puddle, colors shattering.", "插入镜头：第一滴雨落入霓虹水洼，色彩碎裂。"),
      L("Macro splash, colors ripple outward.", "微距水花，色彩向外荡开。"),
      [], ""),
    mvShot("shot-demo-09", L("Umbrella bloom", "伞开如花"), "draft", 6,
      L("Top-down: dozens of umbrellas bloom at once; only the Stranger's stays closed.", "垂直俯拍：无数伞面同时撑开，唯有陌生人的伞仍收着。"),
      L("Umbrellas open in a radial wave.", "伞面呈放射状依次撑开。"),
      ["char-demo-stranger"], ""),
    mvShot("shot-demo-10", L("Subway light streaks", "地铁光轨"), "draft", 8,
      L("Long exposure look: train windows streak past the platform where the Dreamer stands still.", "长曝光质感：列车车窗化作光轨掠过站台，追光者伫立不动。"),
      L("Light streaks accelerate with the bridge section.", "光轨随桥段加速。"),
      ["char-demo-dreamer"], ""),
    mvShot("shot-demo-11", L("Tide Girl apparition", "潮汐少女现身"), "draft", 5,
      L("Backlit medium shot: the Tide Girl appears in the flooded street's glow, cape refracting the skyline.", "逆光中景：潮汐少女出现在漫光的街道中，雨披折射整片天际线。"),
      L("She raises an arm; the light line surges to rooftop height.", "她抬起手臂，光线瞬间涨至天台高度。"),
      ["char-demo-tide-girl"], ""),
    mvShot("shot-demo-12", L("Sunrise rooftop hold", "日出天台长镜"), "draft", 12,
      L("Final wide hold: the band plays on the rooftop as sunrise washes the neon tide out to sea.", "结尾大全景长镜：乐队在天台演奏，日出将霓虹潮水'退'回海面。"),
