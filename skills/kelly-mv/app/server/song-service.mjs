...
function mergeSong(current, patch) {
  const next = { ...current };
  ...
  if (Array.isArray(patch.lyric_lines)) next.lyric_lines = patch.lyric_lines;
...
export async function importSong(input = {}) {
