...
const SKILL_NAME = "kelly-mv";
const ACCENTS = ["#db2777", "#0ea5e9"];
const VISUAL_DEFS = [
  {
    id: "kelly-mv-visual-1",
    title: "Storyboard frame",
    caption: "Synthetic music-video shot image for review.",
    kind: "video",
  },
  {
    id: "kelly-mv-visual-2",
    title: "Cast reference",
    caption: "Mock artist and dancer reference cards.",
    kind: "profile",
  },
  {
    id: "kelly-mv-visual-3",
    title: "Audio waveform",
    caption: "Visual song timeline with chorus and shot beats.",
    kind: "timeline",
  },
];
