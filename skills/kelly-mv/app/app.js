...
function openSettings() {
  ...
  document.getElementById("imageSettingsMount").innerHTML = `
    <div class="image-config">
      ...
      <label class="field"><span>API Key ${ic.has_api_key ? t("img_key_configured").replace("{preview}", esc(ic.api_key_preview)) : t("img_key_missing")}</span><input id="imgKey" type="password" placeholder="${t("img_key_placeholder")}" /></label>
