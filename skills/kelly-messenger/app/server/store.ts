...
export async function readSnapshot(): Promise<MessagesSnapshot> {
...
export async function readAgentTasks(): Promise<AgentTasks> {
...
export async function readExecutionReport(): Promise<unknown> {
...
export async function decideReply({ reply_id, action, comment = "", text }: DecideReplyInput): Promise<Reply> {
...
async function appendAgentTask(reply: Reply, comment: string): Promise<void> {
