...
const SKILL_NAME = "kelly-messenger";
const ACCENTS = ["#16a34a", "#2563eb"];
const VISUAL_DEFS = [
  {
    id: "kelly-messenger-visual-1",
    title: "Chat screenshot",
    caption: "Synthetic buyer conversation with safe names and timestamps.",
    kind: "mobile",
  },
  {
    id: "kelly-messenger-visual-2",
    title: "Screenshot evidence",
    caption: "Mock attachment card linked to the conversation.",
    kind: "receipt",
  },
  {
    id: "kelly-messenger-visual-3",
    title: "Reply queue",
    caption: "Visual approval queue for outbound message drafts.",
    kind: "sheet",
  },
];
