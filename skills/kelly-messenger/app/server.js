...
const AIRAPP_ID = "kelly-messenger";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-messenger" }));
...
app.onError((error, context) => {
  console.error("Kelly Messenger server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3135", 10);
