...
export const BUSABASE_SCHEMA = {
  provider: "busabase",
  schema_id: "kelly-messenger.storage",
  schema_version: "1",
  folder: {
    default_slug: "kelly-messenger-workspace",
    children: ["base", "drive"],
  },
  base: {
    id: "kelly-messenger",
    slug: "kelly-messenger",
    name: "Kelly Messenger Records",
    fields: [
      "record_id",
      "kind",
      "title",
  ...
  related_bases: [],
  drive: {
    id: "kelly-messenger-files",
    slug: "kelly-messenger-workspace-files",
