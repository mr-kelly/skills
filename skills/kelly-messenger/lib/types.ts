// Core domain types shared across the kelly-messenger server, data providers,
// and scripts. These model the ACTUAL shapes produced by demo.ts /
// local-file-provider.ts / sync_messages.ts / ingest_messages.ts and the
// normalized snapshot in references/messenger-schema.md.
...
// ---- Config (as it appears in the providers / the scripts) ----
...
// Busabase connection block, read from config.busabase (env overrides win).
...
export interface ConfigSummary {
  ...
  // Present only for remote providers (e.g. busabase).
