...
const AIRAPP_ID = "kelly-churn-predictor";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-churn-predictor" }));
...
app.onError((error, context) => {
  console.error(
    "Customer Churn Predictor & Retention Desk server error",
