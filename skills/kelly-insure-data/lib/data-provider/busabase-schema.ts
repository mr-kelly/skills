...
export const BUSABASE_SCHEMA = {
  provider: "busabase",
  schema_id: "kelly-insure-data.storage",
  schema_version: "1",
  folder: {
    default_slug: "kelly-insure-data-workspace",
    children: ["base", "drive"],
  },
  base: {
    id: "kelly-insure-data",
    slug: "kelly-insure-data",
    name: "Kelly Insure Data Records",
    fields: [
      "record_id",
      "kind",
      "title",
  ...
  related_bases: [],
  drive: {
    id: "kelly-insure-data-files",
    slug: "kelly-insure-data-workspace-files",
