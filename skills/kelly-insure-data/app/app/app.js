...
function applyDemoRoute() {
  ...
  const route = map[state.settings.demo_scenario] || "#/overview";
...
async function loadState() {
  ...
  window.dispatchEvent(new CustomEvent("kelly-insure-data:state", { detail: data }));
  applyDemoRoute();
  render();
}
    ...
    <section class="settings-grid">
      <article class="settings-card">
        ...
        ${keyValueTable({
          ...
          [t("configPath")]: summary.config_path || "",
          drive: summary.drive?.slug || "",
          featured: summary.bases?.featured || "",
          notices: summary.bases?.notices || "",
          qa: summary.bases?.qa || "",
          feedback: summary.bases?.feedback || "",
        })}
      </article>
      <article class="settings-card">
