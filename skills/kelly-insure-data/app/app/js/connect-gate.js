...
function renderWorkspaceScreen(error, onRetry) {
  ...
  const body = canProvision
    ? "<p>Kelly Insure Data expects its Drive node and Bases to already exist in the current Space, created by an operator script.</p><p>Nothing is auto-created by the AirApp itself.</p>"
    : `<p>${escapeHtml(reason)}</p><p>Kelly Insure Data never switches to local data; it only reads the Busabase workspace configured by an operator.</p>`;
