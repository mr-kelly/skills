...
const AIRAPP_ID = "kelly-insure-data";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-insure-data" }));
...
app.onError((error, context) => {
  console.error("Kelly Insure Data server error", error instanceof Error ? error.message : error);
