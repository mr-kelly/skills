...
// SVG-motif generator), re-themed for Kelly Insure Data's file/QA/news
// governance domain.
const SKILL_NAME = "kelly-insure-data";
const ACCENTS = ["#0a84ff", "#18794e"];
const VISUAL_DEFS = [
  {
    id: "kelly-insure-data-visual-1",
    title: "Policy document",
    caption: "Synthetic insurance PDF with metadata governance fields.",
    kind: "document",
  },
  {
    id: "kelly-insure-data-visual-2",
    title: "QA record",
    caption: "Mock question/answer pair with source traceability.",
    kind: "sheet",
  },
  {
    id: "kelly-insure-data-visual-3",
    title: "Governance trend",
    caption: "Simulated data quality score over recent reviews.",
    kind: "chart",
  },
];
...
function visualSvg(title, caption, kind, index) {
  const accent = ACCENTS[index % ACCENTS.length] || "#0a84ff";
  const secondary = ACCENTS[(index + 1) % ACCENTS.length] || "#18794e";
