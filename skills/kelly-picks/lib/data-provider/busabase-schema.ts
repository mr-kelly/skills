...
export const BUSABASE_SCHEMA = {
  provider: "busabase",
  schema_id: "kelly-picks.storage",
  schema_version: "1",
  folder: {
    default_slug: "kelly-picks-workspace",
    children: ["base", "drive"],
  },
  base: {
    id: "kelly-picks",
    slug: "kelly-picks",
    name: "Kelly Picks Records",
    fields: [
      "record_id",
      "kind",
      "title",
  ...
  related_bases: [],
  drive: {
    id: "kelly-picks-files",
    slug: "kelly-picks-workspace-files",
