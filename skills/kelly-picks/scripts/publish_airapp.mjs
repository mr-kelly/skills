#!/usr/bin/env node
// Push this skill's current local content/kelly-picks-app/ code to its deployed AirApp: creates it
...
// change takes effect. Use this after editing content/kelly-picks-app/ files; scripts/setup.mjs
...
const appRoot = path.join(path.dirname(fileURLToPath(import.meta.url)), "..", "content", "kelly-picks-app");
