// Core domain types shared across the kelly-picks server, scripts, and demo
// builder. These model the ACTUAL shapes produced by store.ts / decisions.ts /
// demo.ts and the scripts (compute_margins / ingest_trends / execute_decisions),
// plus the snapshot validated by scripts/validate_ui_schema.ts. Fields the agent
// pipeline fills in progressively are optional.
