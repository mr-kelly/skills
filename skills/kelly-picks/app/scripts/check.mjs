...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Picks must be Cloud-only");
if (/KELLY_PICKS_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Picks AirApp checks OK (${files.length} files)`);
