...
const SKILL_NAME = "kelly-picks";
const ACCENTS = ["#f97316", "#16a34a"];
const VISUAL_DEFS = [
  {
    id: "kelly-picks-visual-1",
    title: "Product photo",
    caption: "Synthetic product discovery card with marketplace crop.",
    kind: "gallery",
  },
  {
    id: "kelly-picks-visual-2",
    title: "Trend screenshot",
    caption: "Mock social trend capture with velocity markers.",
    kind: "mobile",
  },
  {
    id: "kelly-picks-visual-3",
    title: "Sourcing board",
    caption: "Visual margin, supplier, and risk comparison sheet.",
    kind: "sheet",
  },
];
