...
if (!configText.includes('deployment: "cloud"')) throw new Error("Legal Matter Strategy must be Cloud-only");
if (/KELLY_LEGAL_MATTER_STRATEGY_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Legal Matter Strategy AirApp checks OK (${files.length} files)`);
