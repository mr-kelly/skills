...
const RAW_SNAPSHOT = {
  ...
  checks: [
    ...
    },
    {
      ...
      item_id: "strategy-shareholder-exit",
      severity: "warning",
    },
    {
      id: "chk-client",
...
function demoConfigSummary() {
  return {
    config_path: "demo://kelly-legal-matter-strategy/config.json",
    is_example: false,
    firm_profile: {
      firm_name: "泰和泰（深圳）律师事务所",
      branch: "Shenzhen",
      reviewer_role: "responsible partner",
      default_jurisdictions: ["Guangdong", "Shenzhen"],
    },
    strategy_policy: {
      require_precedent_links: true,
      require_evidence_map: true,
      default_risk_scale: ["low", "medium", "high", "critical"],
      approval_required_for_client_facing: true,
    },
    templates: {
      enabled: ["litigation_claim", "defense", "arbitration", "legal_opinion"],
    },
    export: { format: "markdown+json", out_dir: "exports/strategy-packs" },
  };
}
