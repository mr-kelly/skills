...
const AIRAPP_ID = "kelly-legal-matter-strategy";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-legal-matter-strategy" }));
...
app.onError((error, context) => {
  console.error("Legal Matter Strategy server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3162", 10);
