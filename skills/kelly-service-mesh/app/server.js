...
const AIRAPP_ID = "kelly-service-mesh";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-service-mesh" }));
...
app.onError((error, context) => {
  console.error(
    "Service Mesh Policy & Traffic Telemetry Desk server error",
