// Pure, storage-agnostic domain logic for kelly-insurance-intel — no
...
export function parseBatchMeta(payload = "") {
  ...
  return {
    ...
    source: meta.source || "kelly-insurance-intel",
    vertical: meta.vertical || "insurance and wealth advisory",
    buyer: meta.buyer || "",
    offer: meta.offer || "",
  };
}
