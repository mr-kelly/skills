#!/usr/bin/env node
// Push this skill's current local content/kelly-insurance-intel-app/ code to its deployed AirApp: creates it
...
// change takes effect. Use this after editing content/kelly-insurance-intel-app/ files; scripts/setup.mjs
...
import { appConfig } from "../content/kelly-insurance-intel-app/app/js/config.js";

const appRoot = path.join(path.dirname(fileURLToPath(import.meta.url)), "..", "content", "kelly-insurance-intel-app");
