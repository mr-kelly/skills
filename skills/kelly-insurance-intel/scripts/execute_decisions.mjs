...
import { operationForDecision } from "../content/kelly-insurance-intel-app/app/js/insurance-model.js";
...
async function markDone(client, existing, fields, message) {
  return client.records.changeRequest({
    ...
    message,
    author: "kelly-insurance-intel-execute-decisions",
...
async function main() {
  ...
  if (!resources.folder || resources.missing.length) {
    throw new Error("Kelly Insurance Intel Busabase resources are not provisioned yet; run the AirApp setup first.");
  }
