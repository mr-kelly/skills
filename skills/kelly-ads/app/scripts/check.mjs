...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Ads must be Cloud-only");
if (/KELLY_ADS_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Ads AirApp checks OK (${files.length} files)`);
