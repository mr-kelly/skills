...
const SKILL_NAME = "kelly-ads";
const ACCENTS = ["#2563eb", "#f97316"];
const VISUAL_DEFS = [
  {
    id: "kelly-ads-visual-1",
    title: "Campaign creative mockup",
    caption: "Synthetic product ad cards with headline, offer, and placement crop.",
    kind: "gallery",
  },
  {
    id: "kelly-ads-visual-2",
    title: "Search term evidence",
    caption: "Mock search-term rows annotated with waste and conversion signals.",
    kind: "sheet",
  },
  {
    id: "kelly-ads-visual-3",
    title: "Budget heatmap",
    caption: "Simulated daily spend pacing with risk bands for review.",
    kind: "chart",
  },
];
