...
export const busabaseProvider = {
  ...
  async getState() {
    ...
    const [platforms, campaigns, anomalies, adjustments, sync_log, settings] = await Promise.all([
      readAllRecords("platforms"),
      readAllRecords("campaigns"),
      readAllRecords("anomalies"),
      readAllRecords("adjustments"),
      readAllRecords("sync_log"),
      readSettingsRow(),
    ]);
    const snapshot = buildSnapshot({ platforms, campaigns, anomalies, adjustments, sync_log, settings });
