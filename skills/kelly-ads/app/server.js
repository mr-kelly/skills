...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-ads" }));
...
app.onError((error, context) => {
  console.error("Kelly Ads server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3146", 10);
