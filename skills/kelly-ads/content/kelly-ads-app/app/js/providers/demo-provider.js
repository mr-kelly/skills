...
// retired app/server/demo.ts; persona: "Nimbus Home", a cross-border home &
// kitchen gadget seller running Amazon Ads US, Meta (IG), TikTok Ads, and
...
function demoCampaigns() {
  return [
    campaign(
      "amz-sp-auto-lunchbox",
      "amazon",
      "SP Auto — Silicone Bento Lunchbox",
      ...
      [
        ...
        target(
          "amz-lb-auto-sub",
          "search_term",
          "substitutes: leakproof lunch containers",
          "auto",
          "enabled",
          96.1,
          101,
    ...
    campaign(
      "amz-sp-manual-lunchbox",
      "amazon",
      "SP Manual — Lunchbox Keywords",
      "Silicone Bento Lunchbox",
      "NH-LB-01",
      "active",
      45,
    ...
    campaign(
      "amz-sp-auto-spicerack",
      "amazon",
      "SP Auto — Rotating Spice Rack",
      "Rotating Spice Rack",
      "NH-SR-02",
      "active",
      25,
    ...
    campaign(
      "meta-ig-creative-test",
      "meta",
      "IG Creative Test — Lunchbox Reels",
      "Silicone Bento Lunchbox",
      "NH-LB-01",
      "active",
      25,
      ...
      30,
      makeDaily(
        [19.2, 20.4, 19.8, 20.9, 19.5, 20.2, 21.1, 19.7, 20.6, 20.1, 19.9, 20.8, 20.3, 19.6],
        0.55,
        0.035,
        24.9,
      ),
    ...
    campaign(
      "meta-retargeting",
      "meta",
      "Meta Retargeting — Site Visitors",
      "Nimbus Home Store",
      "",
      "active",
      18,
    ...
    campaign(
      "tt-spark-lunchbox",
      "tiktok",
      "Spark Ads — Viral Lunchbox Video",
      "Silicone Bento Lunchbox",
      "NH-LB-01",
      "active",
      30,
      ...
      [
        target(
          "tt-spark-video",
          "creative",
          "Spark — @lunchboxdad packing video",
          "",
          "enabled",
          417.5,
          1298,
    ...
    campaign(
      "g-pmax",
      "google",
      "Performance Max — Kitchen Gadgets",
      "Nimbus Home Store",
      "",
      "active",
      25,
...
function demoAnomalies() {
  return [
    anomaly(
      "anm-zeroconv-lunchbox-kids",
      "zero_conversion_spend",
      "critical",
      "open",
      "amz-sp-manual-lunchbox",
      "amazon",
      "amz-lb-kw-lunchbox-kids",
    ...
    anomaly(
      ...
      "2026-07-02T08:10:00.000Z",
      "2026-06-26T08:10:00.000Z",
      "adj-budget-shift-tt",
    ),
    anomaly(
      "anm-rejected-meta-reel",
      "rejected",
      "critical",
      "open",
      "meta-ig-creative-test",
      ...
      "2026-07-02T07:52:00.000Z",
      "2026-07-01T14:20:00.000Z",
      "adj-creative-refresh-meta",
    ),
    anomaly(
      "anm-cpc-spike-spicerack",
      "cpc_spike",
      "warning",
      "open",
      "amz-sp-auto-spicerack",
...
function demoAdjustments() {
  return [
    adjustment(
      ...
      1,
      "negative_keyword",
      "Add 'lunch box kids' as a negative exact keyword",
      "needs_review",
      "amz-sp-manual-lunchbox",
      "amazon",
      { kind: "term", id: "amz-lb-kw-lunchbox-kids", text: "lunch box kids" },
      "Broad-match term, enabled",
      "Negative exact on SP Manual — Lunchbox Keywords",
    ...
    adjustment(
      ...
      2,
      "bid_down",
      "Lower bids 15% on SP Manual — Lunchbox Keywords",
      "needs_review",
      "amz-sp-manual-lunchbox",
      "amazon",
    ...
    adjustment(
      ...
      3,
      "budget_shift",
      "Shift $10/day from Google Brand Search to TikTok Spark Ads",
      "approved",
      "tt-spark-lunchbox",
      "tiktok",
      { kind: "budget", id: "g-brand-search", text: "→ tt-spark-lunchbox" },
      "Google Brand $20/day (spending ~$9) · TikTok $30/day (capped)",
      "Google Brand $10/day · TikTok $40/day",
      ...
      "anm-budget-tt-spark",
      "Approved. Shift it and watch ROAS for 3 days.",
      {
        verdict: "approve",
        note: "Approved. Shift it and watch ROAS for 3 days.",
    ...
    adjustment(
      ...
      4,
      "creative_refresh",
      "Replace the rejected Meta reel with compliant UGC creative",
      "blocked",
      "meta-ig-creative-test",
      "meta",
      { kind: "creative", id: "meta-reel-v3", text: "Before/After Reel v3" },
      "Before/After Reel v3 (rejected)",
      "New UGC packing-routine reel, no before/after claims",
      ...
      "anm-rejected-meta-reel",
      "Blocked until the new UGC creative batch lands (due Jul 8).",
      {
        verdict: "block",
        note: "Blocked until the new UGC creative batch lands (due Jul 8).",
        decided_at: "2026-07-01T16:40:00.000Z",
      },
      null,
    ),
    adjustment(
      ...
      5,
      "pause_target",
      "Pause the TikTok Kitchen & Dining interest ad group",
      "done",
      "tt-interest-test",
      "tiktok",
      { kind: "term", id: "tt-interest-kitchen", text: "Interest — Kitchen & Dining" },
      "Ad group enabled, $12/day",
      "Ad group paused",
    ...
    adjustment(
      ...
      6,
      "bid_up",
      "Raise bids 10% on SP Auto — Silicone Bento Lunchbox",
      "changes_requested",
      "amz-sp-auto-lunchbox",
      "amazon",
      ...
      "Show projected daily spend at +10% before I approve.",
      {
        ...
        note: "Show projected daily spend at +10% before I approve.",
...
function demoSyncLog() {
  return [
    sync(
      "sync-amazon-0702",
      "2026-07-02T07:45:00.000Z",
      "amazon",
      "ingest",
      "Amazon Ads report ingested: 4 campaigns, 14 days, 12 search terms.",
      56,
    ),
    sync(
      "sync-meta-0702",
      ...
      "meta",
      "ingest",
      "Meta Ads insights ingested: 2 campaigns, 14 days, 5 creatives/audiences.",
      28,
    ),
    sync(
      "sync-tiktok-0702",
      "2026-07-02T07:58:00.000Z",
      "tiktok",
      "ingest",
      "TikTok Ads report ingested: 2 campaigns, 14 days.",
      28,
    ),
    sync(
      "sync-google-0702",
      "2026-07-02T08:04:00.000Z",
      "google",
      "ingest",
      "Google Ads report ingested: 2 campaigns, 14 days, 3 asset groups/terms.",
      28,
    ),
    sync(
      "sync-checks-0702",
      ...
      "",
      "checks",
      "Anomaly checks completed: 7 anomalies (2 critical), 1 skeleton adjustment drafted.",
      0,
    ),
    sync(
      "sync-exec-0626",
      ...
      "tiktok",
      "execution",
      "Adjustment #5 executed: paused TikTok interest ad group.",
      0,
    ),
  ];
}
...
export const demoProvider = {
  ...
  async getState() {
    ...
    const visuals = demoVisualsForApp("kelly-ads");
    return {
      demo: true,
      ...
      config_summary: {
        ...
        is_example: false,
        currency: "USD",
        targets: { default_acos_pct: 25, default_roas: 4, per_platform: {}, per_product: [] },
        thresholds: {
          acos_breach_days: 3,
