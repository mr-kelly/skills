// Core domain types shared across the kelly-ads data-provider layer, server,
// and scripts. These model the ACTUAL shapes produced by demo.ts / the providers
// / the ingest and check scripts and the normalized snapshot in
...
// Result of loadConfig()/readConfig(), passed to each provider factory.
