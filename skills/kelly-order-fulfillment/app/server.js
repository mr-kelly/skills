...
const AIRAPP_ID = "kelly-order-fulfillment";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-order-fulfillment" }));
...
app.onError((error, context) => {
  console.error(
    "Omnichannel Order Fulfillment & Exception Desk server error",
