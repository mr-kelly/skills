...
const SKILL_NAME = "kelly-scale-pptx";
const ACCENTS = ["#2563eb", "#ca8a04"];
const VISUAL_DEFS = [
  {
    id: "kelly-scale-pptx-visual-1",
    title: "Slide preview",
    caption: "Synthetic courseware slide with bilingual content blocks.",
    kind: "gallery",
  },
  {
    id: "kelly-scale-pptx-visual-2",
    title: "Style board",
    caption: "Mock palette, components, and typography reference.",
    kind: "board",
  },
  {
    id: "kelly-scale-pptx-visual-3",
    title: "Worksheet image",
    caption: "Visual student handout page generated from slide cards.",
    kind: "sheet",
  },
];
