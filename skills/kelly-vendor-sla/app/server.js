...
const AIRAPP_ID = "kelly-vendor-sla";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-vendor-sla" }));
...
app.onError((error, context) => {
  console.error("Supplier SLA & Quality Performance Desk server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3196", 10);
