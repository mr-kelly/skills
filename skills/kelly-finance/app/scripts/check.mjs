...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Finance must be Cloud-only");
if (/KELLY_FINANCE_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Finance AirApp checks OK (${files.length} files)`);
