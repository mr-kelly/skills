...
const SKILL_NAME = "kelly-finance";
const ACCENTS = ["#0f766e", "#1d4ed8"];
const VISUAL_DEFS = [
  {
    id: "kelly-finance-visual-1",
    title: "Workbook preview",
    caption: "Synthetic three-statement model tabs and highlighted checks.",
    kind: "sheet",
  },
  {
    id: "kelly-finance-visual-2",
    title: "Check evidence",
    caption: "Mock formula audit callout and source cell trace.",
    kind: "document",
  },
  {
    id: "kelly-finance-visual-3",
    title: "Scenario chart",
    caption: "Simulated base, upside, and downside cash trajectories.",
    kind: "chart",
  },
];
