...
import { appConfig } from "../content/kelly-sales-outreach-app/app/js/config.js";

export { appConfig };

const appRoot = path.join(path.dirname(fileURLToPath(import.meta.url)), "..", "content", "kelly-sales-outreach-app");
