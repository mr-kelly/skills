...
if (appConfig.bases.length !== 3) {
  throw new Error("Template manifest Base count does not match the app declaration");
}
if ((manifest.template.secrets ?? []).length !== 4) {
  throw new Error("Template Vault declarations are incomplete");
}
if (
...
console.log("Kelly Sales Outreach checks OK");
