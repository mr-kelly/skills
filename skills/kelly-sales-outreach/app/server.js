...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-sales-outreach", mode: "outreach-desk" }));
...
app.onError((error, context) => {
  console.error("kelly-sales-outreach server error", error instanceof Error ? error.message : error);
