...
const SKILL_NAME = "kelly-support";
const ACCENTS = ["#2563eb", "#16a34a"];
const VISUAL_DEFS = [
  {
    id: "kelly-support-visual-1",
    title: "Ticket screenshot",
    caption: "Synthetic customer support ticket with SLA timer.",
    kind: "document",
  },
  {
    id: "kelly-support-visual-2",
    title: "Knowledge article",
    caption: "Mock help-center article linked to proposed reply.",
    kind: "sheet",
  },
  {
    id: "kelly-support-visual-3",
    title: "SLA chart",
    caption: "Simulated first-response and resolution trend.",
    kind: "chart",
  },
];
