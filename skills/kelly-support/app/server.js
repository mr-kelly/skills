...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-support" }));
...
app.onError((error, context) => {
  console.error("Kelly DevOps server error", error instanceof Error ? error.message : error);
