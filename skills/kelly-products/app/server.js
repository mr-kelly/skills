...
const AIRAPP_ID = "kelly-products";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-products" }));
...
app.onError((error, context) => {
  console.error("Kelly Products server error", error instanceof Error ? error.message : error);
