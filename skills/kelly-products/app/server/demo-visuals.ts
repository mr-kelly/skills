...
const SKILL_NAME = "kelly-products";
const ACCENTS = ["#16a34a", "#2563eb"];
const VISUAL_DEFS = [
  {
    id: "kelly-products-visual-1",
    title: "Product image gallery",
    caption: "Synthetic SKU image set with hero, lifestyle, and packaging frames.",
    kind: "gallery",
  },
  {
    id: "kelly-products-visual-2",
    title: "Inventory health board",
    caption: "Mock stock, inbound, and channel readiness cards for product ops.",
    kind: "dashboard",
  },
  {
    id: "kelly-products-visual-3",
    title: "Channel listing matrix",
    caption: "Simulated marketplace status table with review and compliance flags.",
    kind: "sheet",
  },
];
