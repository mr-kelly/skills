...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Campaigns must be Cloud-only");
if (/KELLY_CAMPAIGNS_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Campaigns AirApp checks OK (${files.length} files)`);
