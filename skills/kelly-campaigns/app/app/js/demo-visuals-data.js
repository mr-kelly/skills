...
// from the retired app/server/demo-visuals.ts's VISUAL_DEFS/motif definitions.
const SKILL_NAME = "kelly-campaigns";
const ACCENTS = ["#7c3aed", "#059669"];
const VISUAL_DEFS = [
  {
    id: "kelly-campaigns-visual-1",
    title: "Email hero preview",
    caption: "Synthetic campaign header, CTA, and mobile-safe fold.",
    kind: "mobile",
  },
  {
    id: "kelly-campaigns-visual-2",
    title: "Segment card",
    caption: "Mock audience slice with suppression and deliverability notes.",
    kind: "profile",
  },
  {
    id: "kelly-campaigns-visual-3",
    title: "Deliverability trend",
    caption: "Simulated opens, clicks, bounces, and spam-risk movement.",
    kind: "chart",
  },
];
