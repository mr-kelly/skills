...
const AIRAPP_ID = "kelly-campaigns";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-campaigns" }));
...
app.onError((error, context) => {
  console.error("Kelly Campaigns server error", error instanceof Error ? error.message : error);
