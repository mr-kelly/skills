...
export const BUSABASE_SCHEMA = {
  provider: "busabase",
  schema_id: "kelly-campaigns.storage",
  schema_version: "1",
  folder: {
    default_slug: "kelly-campaigns-workspace",
    children: ["base", "drive"],
  },
  base: {
    id: "kelly-campaigns",
    slug: "kelly-campaigns",
    name: "Kelly Campaigns Records",
    fields: [
      "record_id",
      "kind",
      "title",
  ...
  related_bases: [],
  drive: {
    id: "kelly-campaigns-files",
    slug: "kelly-campaigns-workspace-files",
