...
//
// kelly-campaigns' unit of work is an email send under approve-before-send.
...
export interface DataProvider {
  ...
  /** Apply a human verdict to a send; returns the updated decisions file. */
  ...
  /** Persist a campaign snapshot (generate_demo_snapshot). */
