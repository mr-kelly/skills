...
const AIRAPP_ID = "kelly-partner-channel";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-partner-channel" }));
...
app.onError((error, context) => {
  console.error("Channel Reseller Deal Registration Desk server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "33364", 10);
