...
const AIRAPP_ID = "kelly-relocation-mobility";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-relocation-mobility" }));
...
app.onError((error, context) => {
  console.error("Global Mobility & Visa Compliance Desk server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "33345", 10);
