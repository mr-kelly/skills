...
import { isoStamp, slugify } from "../lib/common.ts";
...
function makeItem({ channel, index, batchId, title, summary, keywords, audience, cta }: MakeItemArgs) {
...
function hashtags(items: string[]) {
