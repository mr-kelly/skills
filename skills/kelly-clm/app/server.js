...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-clm" }));
...
app.onError((error, context) => {
  console.error("Kelly CLM server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3170", 10);
