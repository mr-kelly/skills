...
const SKILL_NAME = "kelly-clm";
const ACCENTS = ["#1d4ed8", "#64748b"];
const VISUAL_DEFS = [
  {
    id: "kelly-clm-visual-1",
    title: "Contract PDF preview",
    caption: "Synthetic MSA page with redline and fallback markers.",
    kind: "document",
  },
  {
    id: "kelly-clm-visual-2",
    title: "Obligation calendar",
    caption: "Mock renewal and notice dates plotted for owner handoff.",
    kind: "timeline",
  },
  {
    id: "kelly-clm-visual-3",
    title: "Signature packet",
    caption: "Simulated approval packet with exhibits and evidence tabs.",
    kind: "sheet",
  },
];
