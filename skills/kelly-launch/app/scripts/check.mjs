...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Launch must be Cloud-only");
if (/KELLY_LAUNCH_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Launch AirApp checks OK (${files.length} files)`);
