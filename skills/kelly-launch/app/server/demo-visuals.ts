...
const SKILL_NAME = "kelly-launch";
const ACCENTS = ["#2563eb", "#f97316"];
const VISUAL_DEFS = [
  {
    id: "kelly-launch-visual-1",
    title: "Landing hero preview",
    caption: "Synthetic launch page hero with CTA and demo media slot.",
    kind: "gallery",
  },
  {
    id: "kelly-launch-visual-2",
    title: "Press kit thumbnails",
    caption: "Mock assets for logo, screenshot, founder quote, and GIF.",
    kind: "board",
  },
  {
    id: "kelly-launch-visual-3",
    title: "Launch checklist",
    caption: "Visual go/no-go checklist with blockers and owners.",
    kind: "sheet",
  },
];
