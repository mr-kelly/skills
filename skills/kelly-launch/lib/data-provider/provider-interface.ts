// The data-provider contract for kelly-launch + a runtime consistency guard.
//
// kelly-launch's unit of work is a launch item under review-before-ship. Every
...
export interface DataProvider {
  ...
  /** Apply a human verdict to a launch item; returns the updated decisions file. */
  ...
  /** Persist a launch snapshot (generate_demo_snapshot). */
