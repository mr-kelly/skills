...
export const BUSABASE_SCHEMA = {
  provider: "busabase",
  schema_id: "kelly-launch.storage",
  schema_version: "1",
  folder: {
    default_slug: "kelly-launch-workspace",
    children: ["base", "drive"],
  },
  base: {
    id: "kelly-launch",
    slug: "kelly-launch",
    name: "Kelly Launch Records",
    fields: [
      "record_id",
      "kind",
      "title",
  ...
  related_bases: [],
  drive: {
    id: "kelly-launch-files",
    slug: "kelly-launch-workspace-files",
