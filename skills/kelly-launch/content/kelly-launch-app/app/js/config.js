export const appConfig = {
  ...
  airApp: { name: "Kelly Launch", slug: "kelly-launch-app", resourceKey: "kelly-launch-app" },
  bases: [
    {
      key: "items",
      name: "Launch Items",
