...
const AIRAPP_ID = "kelly-followups";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-followups" }));
...
app.onError((error, context) => {
  console.error("kelly-followups server error", error instanceof Error ? error.message : error);
