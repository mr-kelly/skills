...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Followups must be Cloud-only");
if (/KELLY_CRM_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Followups AirApp checks OK (${files.length} files)`);
