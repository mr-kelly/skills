...
const AIRAPP_ID = "kelly-gdpr-privacy";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-gdpr-privacy" }));
...
app.onError((error, context) => {
  console.error("GDPR / Data Privacy & DSAR Request Desk server error", error instanceof Error ? error.message : error);
