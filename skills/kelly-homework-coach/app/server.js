...
const AIRAPP_ID = "kelly-homework-coach";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-homework-coach" }));
...
app.onError((error, context) => {
  console.error("Kelly Homework Coach server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3157", 10);
