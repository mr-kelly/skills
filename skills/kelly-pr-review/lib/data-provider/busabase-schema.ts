...
export const BUSABASE_SCHEMA = {
  provider: "busabase",
  schema_id: "kelly-pr-review.storage",
  schema_version: "1",
  folder: {
    default_slug: "kelly-pr-review-workspace",
    children: ["base", "drive"],
  },
  base: {
    id: "kelly-pr-review",
    slug: "kelly-pr-review",
    name: "Kelly Pr Review Records",
    fields: [
      "record_id",
      "kind",
      "title",
  ...
  related_bases: [],
  drive: {
    id: "kelly-pr-review-files",
    slug: "kelly-pr-review-workspace-files",
