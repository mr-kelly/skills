...
// definitions (the "document" / "gallery" / "sheet" motifs it used).
const SKILL_NAME = "kelly-pr-review";
const ACCENTS = ["#334155", "#2563eb"];
const VISUAL_DEFS = [
  {
    id: "kelly-pr-review-visual-1",
    title: "PR diff screenshot",
    caption: "Synthetic code review diff with risk markers.",
    kind: "document",
  },
  {
    id: "kelly-pr-review-visual-2",
    title: "Test evidence image",
    caption: "Mock browser screenshot attached to merged PR verification.",
    kind: "gallery",
  },
  {
    id: "kelly-pr-review-visual-3",
    title: "Review queue",
    caption: "Visual PR triage table with approvals and blockers.",
    kind: "sheet",
  },
];
