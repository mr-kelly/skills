...
console.log(`Sites: ${snapshot.metrics.site_count}, queries: ${snapshot.metrics.query_count}, pages: ${snapshot.metrics.page_count}, opportunities: ${snapshot.metrics.opportunity_count}`);
