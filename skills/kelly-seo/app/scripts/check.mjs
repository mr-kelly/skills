...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly SEO must be Cloud-only");
if (/KELLY_SEO_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly SEO AirApp checks OK (${files.length} files)`);
