...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-seo" }));
...
app.onError((error, context) => {
  console.error("Kelly SEO server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3150", 10);
