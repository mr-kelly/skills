...
const AIRAPP_ID = "kelly-emr-compliance";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-emr-compliance" }));
...
app.onError((error, context) => {
  console.error("EMR Interoperability & HIPAA Audit Desk server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "33302", 10);
