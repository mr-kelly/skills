...
function chaseDraft(company: string, invoice: Invoice, order: Order | undefined): string {
  return [
...
function detectAnomalies(snapshot: AuditSnapshot, rules: Rules, now: string): Anomaly[] {
