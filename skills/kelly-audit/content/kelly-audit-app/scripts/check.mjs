...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly Audit must be Cloud-only");
if (/KELLY_AUDIT_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly Audit AirApp checks OK (${files.length} files)`);
