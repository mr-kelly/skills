...
// retired app/server/demo.ts; buildDemoSnapshot() calls deriveSnapshot()
// from audit-model.js exactly like the retired demo.ts called compute.ts's
...
function buildTables() {
  ...
  const invoices = INVOICE_ROWS.map(
    ([invoice_no, order_no, customer, issue_date, due_date, amount, currency, kind]) => ({
...
export const demoProvider = {
  ...
  async getState() {
    ...
    const visuals = demoVisualsForApp("kelly-audit");
    return {
      demo: true,
