...
const AIRAPP_ID = "kelly-digital-human";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-digital-human" }));
...
app.onError((error, context) => {
  console.error("Kelly Digital Human server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "3172", 10);
