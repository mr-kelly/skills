...
const VISUAL_DEFS = [
  {
    id: "kelly-digital-human-visual-1",
    title: "AI host portrait",
    caption: "Synthetic presenter card with disclosure and voice route.",
    kind: "profile",
  },
  {
    id: "kelly-digital-human-visual-2",
    title: "Streaming stage",
    caption: "Mock RTC video stage with latency and lip-sync overlays.",
    kind: "video",
  },
  {
    id: "kelly-digital-human-visual-3",
    title: "Vendor route map",
    caption: "Visual comparison of 2D stream and custom 3D paths.",
    kind: "board",
  },
];
