...
const state = {
  ...
  query: "",
  lang: normalizeLang(
    new URLSearchParams(location.search).get("lang") || localStorage.getItem("kelly-retail-intel-language") || "auto",
  ),
...
els.language.addEventListener("change", () => {
  ...
  localStorage.setItem("kelly-retail-intel-language", state.lang);
  render();
});
