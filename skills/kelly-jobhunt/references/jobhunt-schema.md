...
| `onboarding-version` | number | no | v4. Positive version of the product onboarding contract that has materialized. Version 1 means all three readiness fields below were saved successfully. |
...
as the three readiness fields; submitting a pending ChangeRequest is not
