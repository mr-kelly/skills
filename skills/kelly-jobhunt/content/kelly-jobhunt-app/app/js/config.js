export const appConfig = {
  ...
  airApp: { name: "Kelly JobHunt", slug: "kelly-jobhunt-app", resourceKey: "kelly-jobhunt-app" },
  bases: [
    {
      key: "profile",
      name: "求职档案",
      slug: "kelly-jobhunt-profile",
