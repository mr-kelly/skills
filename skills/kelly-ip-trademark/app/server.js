...
const AIRAPP_ID = "kelly-ip-trademark";
...
app.get("/health", (context) => context.json({ ok: true, app: "kelly-ip-trademark" }));
...
app.onError((error, context) => {
  console.error("Global Trademark Portfolio Radar server error", error instanceof Error ? error.message : error);
  return context.json({ error: "Internal server error" }, 500);
});

const port = Number.parseInt(process.env.PORT || "33351", 10);
