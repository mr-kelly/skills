...
if (!configText.includes('deployment: "cloud"')) throw new Error("Kelly DevOps must be Cloud-only");
if (/KELLY_DEVOPS_DATA_PROVIDER|local-file-provider|config\.local\.json/.test(configText)) {
...
console.log(`Kelly DevOps AirApp checks OK (${files.length} files)`);
