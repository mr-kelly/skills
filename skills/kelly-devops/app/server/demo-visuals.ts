...
const SKILL_NAME = "kelly-devops";
const ACCENTS = ["#334155", "#16a34a"];
const VISUAL_DEFS = [
  {
    id: "kelly-devops-visual-1",
    title: "Service status board",
    caption: "Synthetic uptime cards with incident and owner markers.",
    kind: "dashboard",
  },
  {
    id: "kelly-devops-visual-2",
    title: "Certificate expiry card",
    caption: "Mock domain and SSL timeline with urgency bands.",
    kind: "timeline",
  },
  {
    id: "kelly-devops-visual-3",
    title: "Spend alert",
    caption: "Simulated cloud spend spike and action proposal.",
    kind: "chart",
  },
];
