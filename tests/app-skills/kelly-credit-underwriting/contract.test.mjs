...
const appRoot = join(repoRoot, "skills", "kelly-credit-underwriting", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/credit-underwriting-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-credit-underwriting contract validation", async () => {
...
test("kelly-credit-underwriting resource-map alignment", async () => {
...
test("kelly-credit-underwriting no browser secret leaks", async () => {
