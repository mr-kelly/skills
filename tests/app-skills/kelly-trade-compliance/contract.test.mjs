...
const appRoot = join(repoRoot, "skills", "kelly-trade-compliance", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/trade-compliance-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-trade-compliance contract validation", async () => {
...
test("kelly-trade-compliance resource-map alignment", async () => {
...
test("kelly-trade-compliance no browser secret leaks", async () => {
