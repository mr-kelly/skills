...
const appRoot = join(repoRoot, "skills", "kelly-contractor-vms", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/contractor-vms-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-contractor-vms contract validation", async () => {
...
test("kelly-contractor-vms resource-map alignment", async () => {
...
test("kelly-contractor-vms no browser secret leaks", async () => {
