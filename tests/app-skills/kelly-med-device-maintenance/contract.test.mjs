...
const appRoot = join(repoRoot, "skills", "kelly-med-device-maintenance", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/med-device-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-med-device-maintenance contract validation", async () => {
...
test("kelly-med-device-maintenance resource-map alignment", async () => {
...
test("kelly-med-device-maintenance no browser secret leaks", async () => {
