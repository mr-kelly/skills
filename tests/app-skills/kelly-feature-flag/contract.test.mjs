...
const appRoot = join(repoRoot, "skills", "kelly-feature-flag", "app");
...
test("kelly-feature-flag contract validation", async () => {
...
test("kelly-feature-flag resource-map alignment", async () => {
...
test("kelly-feature-flag no browser secret leaks", async () => {
