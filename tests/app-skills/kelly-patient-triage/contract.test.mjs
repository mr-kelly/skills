...
const appRoot = join(repoRoot, "skills", "kelly-patient-triage", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/patient-triage-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-patient-triage contract validation", async () => {
...
test("kelly-patient-triage resource-map alignment", async () => {
...
test("kelly-patient-triage no browser secret leaks", async () => {
