...
const appRoot = join(repoRoot, "skills", "kelly-sub-processor-dpa", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/sub-processor-dpa-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-sub-processor-dpa contract validation", async () => {
...
test("kelly-sub-processor-dpa resource-map alignment", async () => {
...
test("kelly-sub-processor-dpa no browser secret leaks", async () => {
