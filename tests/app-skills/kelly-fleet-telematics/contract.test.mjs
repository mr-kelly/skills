...
const appRoot = join(repoRoot, "skills", "kelly-fleet-telematics", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/fleet-telematics-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-fleet-telematics contract validation", async () => {
...
test("kelly-fleet-telematics resource-map alignment", async () => {
...
test("kelly-fleet-telematics no browser secret leaks", async () => {
