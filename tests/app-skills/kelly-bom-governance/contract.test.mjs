...
const appRoot = join(repoRoot, "skills", "kelly-bom-governance", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/bom-governance-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-bom-governance contract validation", async () => {
...
test("kelly-bom-governance resource-map alignment", async () => {
...
test("kelly-bom-governance no browser secret leaks", async () => {
