...
const appRoot = join(repoRoot, "skills", "kelly-campaign-attribution", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/campaign-attribution-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-campaign-attribution contract validation", async () => {
...
test("kelly-campaign-attribution resource-map alignment", async () => {
...
test("kelly-campaign-attribution no browser secret leaks", async () => {
