...
const appRoot = join(repoRoot, "skills", "kelly-db-privacy-masking", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/db-masking-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-db-privacy-masking contract validation", async () => {
...
test("kelly-db-privacy-masking resource-map alignment", async () => {
...
test("kelly-db-privacy-masking no browser secret leaks", async () => {
