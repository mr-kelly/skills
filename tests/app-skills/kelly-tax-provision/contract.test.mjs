...
const appRoot = join(repoRoot, "skills", "kelly-tax-provision", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/tax-provision-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-tax-provision contract validation", async () => {
...
test("kelly-tax-provision resource-map alignment", async () => {
...
test("kelly-tax-provision no browser secret leaks", async () => {
