...
const appRoot = join(repoRoot, "skills", "kelly-api-security-gateway", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/api-security-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-api-security-gateway contract validation", async () => {
...
test("kelly-api-security-gateway resource-map alignment", async () => {
...
test("kelly-api-security-gateway no browser secret leaks", async () => {
