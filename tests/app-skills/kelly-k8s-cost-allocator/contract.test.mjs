...
const appRoot = join(repoRoot, "skills", "kelly-k8s-cost-allocator", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/k8s-cost-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-k8s-cost-allocator contract validation", async () => {
...
test("kelly-k8s-cost-allocator resource-map alignment", async () => {
...
test("kelly-k8s-cost-allocator no browser secret leaks", async () => {
