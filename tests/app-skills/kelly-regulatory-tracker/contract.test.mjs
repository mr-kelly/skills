...
const appRoot = join(repoRoot, "skills", "kelly-regulatory-tracker", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/regulatory-tracker-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-regulatory-tracker contract validation", async () => {
...
test("kelly-regulatory-tracker resource-map alignment", async () => {
...
test("kelly-regulatory-tracker no browser secret leaks", async () => {
