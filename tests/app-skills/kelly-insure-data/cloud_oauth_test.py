...
APP_ROOT = REPO_ROOT / "skills" / "kelly-insure-data" / "content" / "kelly-insure-data-app"
REQUIRED_ENV = (
...
def run_cloud_oauth(config: dict) -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="kelly-insure-data-cloud-home-") as app_home:
        env = {
            "HOME": app_home,
            "PORT": str(port),
            "BUSABASE_BASE_URL": "",
