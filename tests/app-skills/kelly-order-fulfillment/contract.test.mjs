...
const appRoot = join(repoRoot, "skills", "kelly-order-fulfillment", "app");
...
test("kelly-order-fulfillment contract validation", async () => {
...
test("kelly-order-fulfillment resource-map alignment", async () => {
...
test("kelly-order-fulfillment no browser secret leaks", async () => {
