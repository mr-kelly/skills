...
const appRoot = join(repoRoot, "skills", "kelly-content-governance", "app");
...
test("kelly-content-governance contract validation", async () => {
...
test("kelly-content-governance resource-map alignment", async () => {
...
test("kelly-content-governance no browser secret leaks", async () => {
