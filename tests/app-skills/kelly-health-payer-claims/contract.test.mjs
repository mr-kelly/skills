...
const appRoot = join(repoRoot, "skills", "kelly-health-payer-claims", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/claims-adjudication-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-health-payer-claims contract validation", async () => {
...
test("kelly-health-payer-claims resource-map alignment", async () => {
...
test("kelly-health-payer-claims no browser secret leaks", async () => {
