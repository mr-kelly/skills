...
APP_ROOT = REPO_ROOT / "skills" / "kelly-ai-newsroom" / "app"
RESULTS_ROOT = REPO_ROOT / "test-results" / "kelly-ai-newsroom"
...
def test_demo_ui(browser, base_url: str) -> None:
    ...
    page.wait_for_load_state("networkidle")
    assert "Publisher and AI-search licensing moves" in page.locator("#page-title").inner_text()
...
def test_busabase_provisioning(browser) -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="kelly-ai-newsroom-busabase-") as data_dir:
        busabase_command = [
            "npx",
            "-y",
        ...
        with managed_process(
            ...
            with tempfile.TemporaryDirectory(prefix="kelly-ai-newsroom-home-") as app_home:
                ...
                record_cr = post_json(
                    f"{busabase_url}/api/v1/bases/{signals_base['baseId']}/change-requests",
                    {
                        "fields": {
                            ...
                            "ref": 1,
                            "title": "Fixture pricing licensing change",
                        ...
                        "message": "Seed Kelly AI Newsroom integration fixture signal",
