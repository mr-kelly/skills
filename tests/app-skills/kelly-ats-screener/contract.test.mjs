...
const appRoot = join(repoRoot, "skills", "kelly-ats-screener", "app");
...
test("kelly-ats-screener contract validation", async () => {
...
test("kelly-ats-screener resource-map alignment", async () => {
...
test("kelly-ats-screener no browser secret leaks", async () => {
