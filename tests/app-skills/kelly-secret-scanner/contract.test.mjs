...
const appRoot = join(repoRoot, "skills", "kelly-secret-scanner", "app");
...
test("kelly-secret-scanner contract validation", async () => {
...
test("kelly-secret-scanner resource-map alignment", async () => {
...
test("kelly-secret-scanner no browser secret leaks", async () => {
