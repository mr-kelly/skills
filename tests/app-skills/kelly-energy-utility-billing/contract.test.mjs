...
const appRoot = join(repoRoot, "skills", "kelly-energy-utility-billing", "app");
...
test("kelly-energy-utility-billing contract validation", async () => {
...
test("kelly-energy-utility-billing resource-map alignment", async () => {
...
test("kelly-energy-utility-billing no browser secret leaks", async () => {
