...
const appRoot = join(repoRoot, "skills", "kelly-churn-predictor", "app");
...
test("kelly-churn-predictor contract validation", async () => {
...
test("kelly-churn-predictor resource-map alignment", async () => {
...
test("kelly-churn-predictor no browser secret leaks", async () => {
