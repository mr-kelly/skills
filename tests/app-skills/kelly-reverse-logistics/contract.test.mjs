...
const appRoot = join(repoRoot, "skills", "kelly-reverse-logistics", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/reverse-logistics-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-reverse-logistics contract validation", async () => {
...
test("kelly-reverse-logistics resource-map alignment", async () => {
...
test("kelly-reverse-logistics no browser secret leaks", async () => {
