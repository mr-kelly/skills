...
const appRoot = join(repoRoot, "skills", "kelly-microservice-registry", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/microservice-registry-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-microservice-registry contract validation", async () => {
...
test("kelly-microservice-registry resource-map alignment", async () => {
...
test("kelly-microservice-registry no browser secret leaks", async () => {
