...
const appRoot = join(repoRoot, "skills", "kelly-patent-radar", "app");
...
test("kelly-patent-radar contract validation", async () => {
...
test("kelly-patent-radar resource-map alignment", async () => {
...
test("kelly-patent-radar no browser secret leaks", async () => {
