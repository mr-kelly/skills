...
const appRoot = join(repoRoot, "skills", "kelly-dlp-audit", "app");
...
test("kelly-dlp-audit contract validation", async () => {
...
test("kelly-dlp-audit resource-map alignment", async () => {
...
test("kelly-dlp-audit no browser secret leaks", async () => {
