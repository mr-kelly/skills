...
const appRoot = join(repoRoot, "skills", "kelly-fixed-income-risk", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/fixed-income-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-fixed-income-risk contract validation", async () => {
...
test("kelly-fixed-income-risk resource-map alignment", async () => {
...
test("kelly-fixed-income-risk no browser secret leaks", async () => {
