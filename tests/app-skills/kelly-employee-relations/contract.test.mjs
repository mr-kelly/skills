...
const appRoot = join(repoRoot, "skills", "kelly-employee-relations", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/employee-relations-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-employee-relations contract validation", async () => {
...
test("kelly-employee-relations resource-map alignment", async () => {
...
test("kelly-employee-relations no browser secret leaks", async () => {
