...
const appRoot = join(repoRoot, "skills", "kelly-cashflow-forecast", "app");
...
test("kelly-cashflow-forecast contract validation", async () => {
...
test("kelly-cashflow-forecast resource-map alignment", async () => {
...
test("kelly-cashflow-forecast no browser secret leaks", async () => {
