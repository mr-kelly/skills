...
const appRoot = join(repoRoot, "skills", "kelly-secops-soar", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/secops-soar-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-secops-soar contract validation", async () => {
...
test("kelly-secops-soar resource-map alignment", async () => {
...
test("kelly-secops-soar no browser secret leaks", async () => {
