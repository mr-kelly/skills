...
const appRoot = join(repoRoot, "skills", "kelly-sustainability-esg", "app");
...
test("kelly-sustainability-esg contract validation", async () => {
...
test("kelly-sustainability-esg resource-map alignment", async () => {
...
test("kelly-sustainability-esg no browser secret leaks", async () => {
