...
const appRoot = join(repoRoot, "skills", "kelly-insurance-claims-loss", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/loss-adjustment-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-insurance-claims-loss contract validation", async () => {
...
test("kelly-insurance-claims-loss resource-map alignment", async () => {
...
test("kelly-insurance-claims-loss no browser secret leaks", async () => {
