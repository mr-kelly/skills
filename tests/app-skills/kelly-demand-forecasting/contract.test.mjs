...
const appRoot = join(repoRoot, "skills", "kelly-demand-forecasting", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/demand-forecasting-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-demand-forecasting contract validation", async () => {
...
test("kelly-demand-forecasting resource-map alignment", async () => {
...
test("kelly-demand-forecasting no browser secret leaks", async () => {
