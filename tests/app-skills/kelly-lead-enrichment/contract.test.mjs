...
const appRoot = join(repoRoot, "skills", "kelly-lead-enrichment", "app");
...
test("kelly-lead-enrichment contract validation", async () => {
...
test("kelly-lead-enrichment resource-map alignment", async () => {
...
test("kelly-lead-enrichment no browser secret leaks", async () => {
