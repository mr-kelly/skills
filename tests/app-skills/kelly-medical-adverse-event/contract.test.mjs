...
const appRoot = join(repoRoot, "skills", "kelly-medical-adverse-event", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/adverse-event-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-medical-adverse-event contract validation", async () => {
...
test("kelly-medical-adverse-event resource-map alignment", async () => {
...
test("kelly-medical-adverse-event no browser secret leaks", async () => {
