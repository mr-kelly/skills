...
const appRoot = join(repoRoot, "skills", "kelly-telehealth-consent", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/telehealth-consent-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-telehealth-consent contract validation", async () => {
...
test("kelly-telehealth-consent resource-map alignment", async () => {
...
test("kelly-telehealth-consent no browser secret leaks", async () => {
