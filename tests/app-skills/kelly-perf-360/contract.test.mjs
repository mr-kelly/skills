...
const appRoot = join(repoRoot, "skills", "kelly-perf-360", "app");
...
test("kelly-perf-360 contract validation", async () => {
...
test("kelly-perf-360 resource-map alignment", async () => {
...
test("kelly-perf-360 no browser secret leaks", async () => {
