...
const appRoot = join(repoRoot, "skills", "kelly-ip-trademark", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/trademark-radar-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-ip-trademark contract validation", async () => {
...
test("kelly-ip-trademark resource-map alignment", async () => {
...
test("kelly-ip-trademark no browser secret leaks", async () => {
