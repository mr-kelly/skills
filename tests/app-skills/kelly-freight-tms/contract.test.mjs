...
const appRoot = join(repoRoot, "skills", "kelly-freight-tms", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/freight-tms-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-freight-tms contract validation", async () => {
...
test("kelly-freight-tms resource-map alignment", async () => {
...
test("kelly-freight-tms no browser secret leaks", async () => {
