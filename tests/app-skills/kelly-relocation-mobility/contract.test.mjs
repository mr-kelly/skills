...
const appRoot = join(repoRoot, "skills", "kelly-relocation-mobility", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/relocation-mobility-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-relocation-mobility contract validation", async () => {
...
test("kelly-relocation-mobility resource-map alignment", async () => {
...
test("kelly-relocation-mobility no browser secret leaks", async () => {
