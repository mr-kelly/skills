...
const appRoot = join(repoRoot, "skills", "kelly-solar-asset-monitoring", "app");
...
test("kelly-solar-asset-monitoring contract validation", async () => {
...
test("kelly-solar-asset-monitoring resource-map alignment", async () => {
...
test("kelly-solar-asset-monitoring no browser secret leaks", async () => {
