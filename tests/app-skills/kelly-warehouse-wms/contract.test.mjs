...
const appRoot = join(repoRoot, "skills", "kelly-warehouse-wms", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/warehouse-wms-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-warehouse-wms contract validation", async () => {
...
test("kelly-warehouse-wms resource-map alignment", async () => {
...
test("kelly-warehouse-wms no browser secret leaks", async () => {
