...
APP_ROOT = REPO_ROOT / "skills" / "kelly-homework-coach" / "content" / "kelly-homework-coach-app"
REQUIRED_ENV = (
...
def run_cloud_oauth(config: dict) -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="kelly-homework-coach-cloud-home-") as app_home:
        env = {
            "HOME": app_home,
            "PORT": str(port),
            "BUSABASE_BASE_URL": "",
