...
const appRoot = join(repoRoot, "skills", "kelly-field-service", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/field-service-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-field-service contract validation", async () => {
...
test("kelly-field-service resource-map alignment", async () => {
...
test("kelly-field-service no browser secret leaks", async () => {
