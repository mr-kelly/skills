...
const appRoot = join(repoRoot, "skills", "kelly-construction-project", "app");
...
test("kelly-construction-project contract validation", async () => {
...
test("kelly-construction-project resource-map alignment", async () => {
...
test("kelly-construction-project no browser secret leaks", async () => {
