...
const appRoot = join(repoRoot, "skills", "kelly-talent-succession", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/talent-succession-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-talent-succession contract validation", async () => {
...
test("kelly-talent-succession resource-map alignment", async () => {
...
test("kelly-talent-succession no browser secret leaks", async () => {
