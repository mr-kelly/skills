...
const appRoot = join(repoRoot, "skills", "kelly-convo-intel", "app");
...
test("kelly-convo-intel contract validation", async () => {
...
test("kelly-convo-intel resource-map alignment", async () => {
...
test("kelly-convo-intel no browser secret leaks", async () => {
