...
const appRoot = join(repoRoot, "skills", "kelly-esg-reporting", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/esg-reporting-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-esg-reporting contract validation", async () => {
...
test("kelly-esg-reporting resource-map alignment", async () => {
...
test("kelly-esg-reporting no browser secret leaks", async () => {
