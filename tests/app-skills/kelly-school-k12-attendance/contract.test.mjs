...
const appRoot = join(repoRoot, "skills", "kelly-school-k12-attendance", "app");
...
test("kelly-school-k12-attendance contract validation", async () => {
...
test("kelly-school-k12-attendance resource-map alignment", async () => {
...
test("kelly-school-k12-attendance no browser secret leaks", async () => {
