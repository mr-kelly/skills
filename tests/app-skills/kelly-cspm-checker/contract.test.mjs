...
const appRoot = join(repoRoot, "skills", "kelly-cspm-checker", "app");
...
test("kelly-cspm-checker contract validation", async () => {
...
test("kelly-cspm-checker resource-map alignment", async () => {
...
test("kelly-cspm-checker no browser secret leaks", async () => {
