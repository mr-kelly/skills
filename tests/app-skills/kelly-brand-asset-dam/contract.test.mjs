...
const appRoot = join(repoRoot, "skills", "kelly-brand-asset-dam", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/brand-dam-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-brand-asset-dam contract validation", async () => {
...
test("kelly-brand-asset-dam resource-map alignment", async () => {
...
test("kelly-brand-asset-dam no browser secret leaks", async () => {
