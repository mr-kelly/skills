...
const appRoot = join(repoRoot, "skills", "kelly-property-lease-admin", "app");
...
test("kelly-property-lease-admin contract validation", async () => {
...
test("kelly-property-lease-admin resource-map alignment", async () => {
...
test("kelly-property-lease-admin no browser secret leaks", async () => {
