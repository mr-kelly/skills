...
const appRoot = join(repoRoot, "skills", "kelly-revops-commission", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/revops-commission-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-revops-commission contract validation", async () => {
...
test("kelly-revops-commission resource-map alignment", async () => {
...
test("kelly-revops-commission no browser secret leaks", async () => {
