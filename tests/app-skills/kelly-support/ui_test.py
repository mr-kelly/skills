...
APP_ROOT = REPO_ROOT / "skills" / "kelly-support" / "app"
        ...
        with managed_process(
            ...
            with tempfile.TemporaryDirectory(prefix="kelly-support-home-") as app_home:
                ...
                fixture = next(
                    ...
                    if r.get("headCommit", {}).get("fields", {}).get("ticket-id") == "tk-fixture"
                )
            ...
            assert sorted(keys) == sorted(
                ["app-root", "accounts", "tickets", "messages", "knowledge_base", "sync_log", "settings"]
            ), nodes
