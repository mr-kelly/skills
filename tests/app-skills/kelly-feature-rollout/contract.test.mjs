...
const appRoot = join(repoRoot, "skills", "kelly-feature-rollout", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/feature-rollout-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-feature-rollout contract validation", async () => {
...
test("kelly-feature-rollout resource-map alignment", async () => {
...
test("kelly-feature-rollout no browser secret leaks", async () => {
