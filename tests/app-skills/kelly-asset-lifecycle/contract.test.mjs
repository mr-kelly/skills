...
const appRoot = join(repoRoot, "skills", "kelly-asset-lifecycle", "app");
...
test("kelly-asset-lifecycle contract validation", async () => {
...
test("kelly-asset-lifecycle resource-map alignment", async () => {
...
test("kelly-asset-lifecycle no browser secret leaks", async () => {
