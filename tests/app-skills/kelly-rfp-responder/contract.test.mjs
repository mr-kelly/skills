...
const appRoot = join(repoRoot, "skills", "kelly-rfp-responder", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/rfp-responder-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-rfp-responder contract validation", async () => {
...
test("kelly-rfp-responder resource-map alignment", async () => {
...
test("kelly-rfp-responder no browser secret leaks", async () => {
