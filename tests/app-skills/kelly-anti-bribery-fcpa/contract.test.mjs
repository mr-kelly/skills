...
const appRoot = join(repoRoot, "skills", "kelly-anti-bribery-fcpa", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/fcpa-audit-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-anti-bribery-fcpa contract validation", async () => {
...
test("kelly-anti-bribery-fcpa resource-map alignment", async () => {
...
test("kelly-anti-bribery-fcpa no browser secret leaks", async () => {
