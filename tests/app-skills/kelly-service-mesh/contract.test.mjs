...
const appRoot = join(repoRoot, "skills", "kelly-service-mesh", "app");
...
test("kelly-service-mesh contract validation", async () => {
...
test("kelly-service-mesh resource-map alignment", async () => {
...
test("kelly-service-mesh no browser secret leaks", async () => {
