...
const appRoot = join(repoRoot, "skills", "kelly-pricing-margin", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/pricing-margin-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-pricing-margin contract validation", async () => {
...
test("kelly-pricing-margin resource-map alignment", async () => {
...
test("kelly-pricing-margin no browser secret leaks", async () => {
