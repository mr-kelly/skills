...
const appRoot = join(repoRoot, "skills", "kelly-fund-accounting", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/fund-accounting-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-fund-accounting contract validation", async () => {
...
test("kelly-fund-accounting resource-map alignment", async () => {
...
test("kelly-fund-accounting no browser secret leaks", async () => {
