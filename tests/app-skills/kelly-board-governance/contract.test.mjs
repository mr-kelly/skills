...
const appRoot = join(repoRoot, "skills", "kelly-board-governance", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/board-governance-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-board-governance contract validation", async () => {
...
test("kelly-board-governance resource-map alignment", async () => {
...
test("kelly-board-governance no browser secret leaks", async () => {
