...
const appRoot = join(repoRoot, "skills", "kelly-prompt-regression", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/prompt-regression-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-prompt-regression contract validation", async () => {
...
test("kelly-prompt-regression resource-map alignment", async () => {
...
test("kelly-prompt-regression no browser secret leaks", async () => {
