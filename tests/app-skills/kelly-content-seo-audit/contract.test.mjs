...
const appRoot = join(repoRoot, "skills", "kelly-content-seo-audit", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/content-seo-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-content-seo-audit contract validation", async () => {
...
test("kelly-content-seo-audit resource-map alignment", async () => {
...
test("kelly-content-seo-audit no browser secret leaks", async () => {
