...
const appRoot = join(repoRoot, "skills", "kelly-privacy-dsar", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/privacy-dsar-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-privacy-dsar contract validation", async () => {
...
test("kelly-privacy-dsar resource-map alignment", async () => {
...
test("kelly-privacy-dsar no browser secret leaks", async () => {
