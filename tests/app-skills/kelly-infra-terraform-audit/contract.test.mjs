...
const appRoot = join(repoRoot, "skills", "kelly-infra-terraform-audit", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/terraform-audit-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-infra-terraform-audit contract validation", async () => {
...
test("kelly-infra-terraform-audit resource-map alignment", async () => {
...
test("kelly-infra-terraform-audit no browser secret leaks", async () => {
