...
const appRoot = join(repoRoot, "skills", "kelly-learning-lms", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/learning-lms-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-learning-lms contract validation", async () => {
...
test("kelly-learning-lms resource-map alignment", async () => {
...
test("kelly-learning-lms no browser secret leaks", async () => {
