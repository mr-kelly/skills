...
const appRoot = join(repoRoot, "skills", "kelly-api-governance", "app");
...
test("kelly-api-governance contract validation", async () => {
...
test("kelly-api-governance resource-map alignment", async () => {
...
test("kelly-api-governance no browser secret leaks", async () => {
