...
const appRoot = join(repoRoot, "skills", "kelly-product-usage-health", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/product-health-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-product-usage-health contract validation", async () => {
...
test("kelly-product-usage-health resource-map alignment", async () => {
...
test("kelly-product-usage-health no browser secret leaks", async () => {
