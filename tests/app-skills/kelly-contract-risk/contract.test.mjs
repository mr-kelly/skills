...
const appRoot = join(repoRoot, "skills", "kelly-contract-risk", "app");
...
test("kelly-contract-risk contract validation", async () => {
...
test("kelly-contract-risk resource-map alignment", async () => {
...
test("kelly-contract-risk no browser secret leaks", async () => {
