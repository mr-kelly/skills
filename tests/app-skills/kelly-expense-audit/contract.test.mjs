...
const appRoot = join(repoRoot, "skills", "kelly-expense-audit", "app");
...
test("kelly-expense-audit contract validation", async () => {
...
test("kelly-expense-audit resource-map alignment", async () => {
...
test("kelly-expense-audit no browser secret leaks", async () => {
