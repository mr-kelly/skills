...
const appRoot = join(repoRoot, "skills", "kelly-code-sast-audit", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/sast-audit-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-code-sast-audit contract validation", async () => {
...
test("kelly-code-sast-audit resource-map alignment", async () => {
...
test("kelly-code-sast-audit no browser secret leaks", async () => {
