...
APP_ROOT = REPO_ROOT / "skills" / "kelly-ads" / "content" / "kelly-ads-app"
        ...
        with managed_process(
            ...
            with tempfile.TemporaryDirectory(prefix="kelly-ads-home-") as app_home:
                ...
                fixture = next(
                    ...
                    if (r.get("headCommit", {}).get("payload") or r.get("headCommit", {}).get("fields", {})).get("adjustment-id") == "fixture-neg-keyword"
                )
            ...
            assert sorted(keys) == sorted(
                ["app-root", "platforms", "campaigns", "anomalies", "adjustments", "sync-log", "settings"]
            ), nodes
