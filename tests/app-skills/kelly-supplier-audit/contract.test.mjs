...
const appRoot = join(repoRoot, "skills", "kelly-supplier-audit", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/supplier-audit-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-supplier-audit contract validation", async () => {
...
test("kelly-supplier-audit resource-map alignment", async () => {
...
test("kelly-supplier-audit no browser secret leaks", async () => {
