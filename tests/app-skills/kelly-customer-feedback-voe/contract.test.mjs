...
const appRoot = join(repoRoot, "skills", "kelly-customer-feedback-voe", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/voc-feature-router-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-customer-feedback-voe contract validation", async () => {
...
test("kelly-customer-feedback-voe resource-map alignment", async () => {
...
test("kelly-customer-feedback-voe no browser secret leaks", async () => {
