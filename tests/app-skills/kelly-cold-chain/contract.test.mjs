...
const appRoot = join(repoRoot, "skills", "kelly-cold-chain", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/cold-chain-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-cold-chain contract validation", async () => {
...
test("kelly-cold-chain resource-map alignment", async () => {
...
test("kelly-cold-chain no browser secret leaks", async () => {
