...
const appRoot = join(repoRoot, "skills", "kelly-pharmacy-formulary", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/pharmacy-formulary-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-pharmacy-formulary contract validation", async () => {
...
test("kelly-pharmacy-formulary resource-map alignment", async () => {
...
test("kelly-pharmacy-formulary no browser secret leaks", async () => {
