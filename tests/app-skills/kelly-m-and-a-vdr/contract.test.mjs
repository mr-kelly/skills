...
const appRoot = join(repoRoot, "skills", "kelly-m-and-a-vdr", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/vdr-diligence-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-m-and-a-vdr contract validation", async () => {
...
test("kelly-m-and-a-vdr resource-map alignment", async () => {
...
test("kelly-m-and-a-vdr no browser secret leaks", async () => {
