...
const appRoot = join(repoRoot, "skills", "kelly-retail-store-ops", "app");
...
test("kelly-retail-store-ops contract validation", async () => {
...
test("kelly-retail-store-ops resource-map alignment", async () => {
...
test("kelly-retail-store-ops no browser secret leaks", async () => {
