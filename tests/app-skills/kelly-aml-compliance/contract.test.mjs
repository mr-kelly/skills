...
const appRoot = join(repoRoot, "skills", "kelly-aml-compliance", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/aml-compliance-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-aml-compliance contract validation", async () => {
...
test("kelly-aml-compliance resource-map alignment", async () => {
...
test("kelly-aml-compliance no browser secret leaks", async () => {
