...
const appRoot = join(repoRoot, "skills", "kelly-partner-co-marketing", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/partner-mdf-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-partner-co-marketing contract validation", async () => {
...
test("kelly-partner-co-marketing resource-map alignment", async () => {
...
test("kelly-partner-co-marketing no browser secret leaks", async () => {
