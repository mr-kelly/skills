...
const appRoot = join(repoRoot, "skills", "kelly-pr-media-monitoring", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/pr-media-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-pr-media-monitoring contract validation", async () => {
...
test("kelly-pr-media-monitoring resource-map alignment", async () => {
...
test("kelly-pr-media-monitoring no browser secret leaks", async () => {
