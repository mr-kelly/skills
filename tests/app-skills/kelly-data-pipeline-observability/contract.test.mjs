...
const appRoot = join(repoRoot, "skills", "kelly-data-pipeline-observability", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/data-pipeline-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-data-pipeline-observability contract validation", async () => {
...
test("kelly-data-pipeline-observability resource-map alignment", async () => {
...
test("kelly-data-pipeline-observability no browser secret leaks", async () => {
