...
const appRoot = join(repoRoot, "skills", "kelly-endpoint-edr", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/endpoint-edr-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-endpoint-edr contract validation", async () => {
...
test("kelly-endpoint-edr resource-map alignment", async () => {
...
test("kelly-endpoint-edr no browser secret leaks", async () => {
