...
const appRoot = join(repoRoot, "skills", "kelly-clinical-trials", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/clinical-trials-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-clinical-trials contract validation", async () => {
...
test("kelly-clinical-trials resource-map alignment", async () => {
...
test("kelly-clinical-trials no browser secret leaks", async () => {
