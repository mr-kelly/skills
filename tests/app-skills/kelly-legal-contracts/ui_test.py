...
APP_ROOT = REPO_ROOT / "skills" / "kelly-legal-contracts" / "content" / "kelly-legal-contracts-app"
        ...
        with managed_process(
            ...
            with tempfile.TemporaryDirectory(prefix="kelly-legal-contracts-home-") as app_home:
                ...
                fixture = next(
                    ...
                    if (r.get("headCommit", {}).get("payload") or r.get("headCommit", {}).get("fields", {})).get("issue-id") == "fixture-issue"
                )
            ...
            assert sorted(keys) == sorted(
                ["app-root", "contracts", "issues", "checks", "claims", "claim-rules", "settings"]
            ), nodes
