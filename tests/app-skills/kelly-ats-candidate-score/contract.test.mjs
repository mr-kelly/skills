...
const appRoot = join(repoRoot, "skills", "kelly-ats-candidate-score", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/candidate-scorecard-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-ats-candidate-score contract validation", async () => {
...
test("kelly-ats-candidate-score resource-map alignment", async () => {
...
test("kelly-ats-candidate-score no browser secret leaks", async () => {
