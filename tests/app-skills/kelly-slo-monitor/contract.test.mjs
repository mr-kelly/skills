...
const appRoot = join(repoRoot, "skills", "kelly-slo-monitor", "app");
...
test("kelly-slo-monitor contract validation", async () => {
...
test("kelly-slo-monitor resource-map alignment", async () => {
...
test("kelly-slo-monitor no browser secret leaks", async () => {
