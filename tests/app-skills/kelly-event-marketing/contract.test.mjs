...
const appRoot = join(repoRoot, "skills", "kelly-event-marketing", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/event-marketing-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-event-marketing contract validation", async () => {
...
test("kelly-event-marketing resource-map alignment", async () => {
...
test("kelly-event-marketing no browser secret leaks", async () => {
