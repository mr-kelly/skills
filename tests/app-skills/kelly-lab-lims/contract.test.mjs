...
const appRoot = join(repoRoot, "skills", "kelly-lab-lims", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/lab-lims-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-lab-lims contract validation", async () => {
...
test("kelly-lab-lims resource-map alignment", async () => {
...
test("kelly-lab-lims no browser secret leaks", async () => {
