...
const appRoot = join(repoRoot, "skills", "kelly-nps-survey", "app");
...
test("kelly-nps-survey contract validation", async () => {
...
test("kelly-nps-survey resource-map alignment", async () => {
...
test("kelly-nps-survey no browser secret leaks", async () => {
