...
test("does not persist secrets or a second data provider in browser storage", async () => {
  ...
  assert.doesNotMatch(source, /KELLY_FAMILY_FUND_DATA_PROVIDER|local-file-provider/);
...
test("the trusted CSV importer is the only process that writes ledger rows", async () => {
