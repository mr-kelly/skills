...
const appRoot = join(repoRoot, "skills", "kelly-workforce-attrition", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/attrition-analytics-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-workforce-attrition contract validation", async () => {
...
test("kelly-workforce-attrition resource-map alignment", async () => {
...
test("kelly-workforce-attrition no browser secret leaks", async () => {
