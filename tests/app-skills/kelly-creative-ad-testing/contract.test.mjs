...
const appRoot = join(repoRoot, "skills", "kelly-creative-ad-testing", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/creative-ad-testing-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-creative-ad-testing contract validation", async () => {
...
test("kelly-creative-ad-testing resource-map alignment", async () => {
...
test("kelly-creative-ad-testing no browser secret leaks", async () => {
