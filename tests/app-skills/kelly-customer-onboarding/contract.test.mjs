...
const appRoot = join(repoRoot, "skills", "kelly-customer-onboarding", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/customer-onboarding-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-customer-onboarding contract validation", async () => {
...
test("kelly-customer-onboarding resource-map alignment", async () => {
...
test("kelly-customer-onboarding no browser secret leaks", async () => {
