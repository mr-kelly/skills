...
const appRoot = join(repoRoot, "skills", "kelly-quote-to-cash", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/quote-to-cash-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-quote-to-cash contract validation", async () => {
...
test("kelly-quote-to-cash resource-map alignment", async () => {
...
test("kelly-quote-to-cash no browser secret leaks", async () => {
