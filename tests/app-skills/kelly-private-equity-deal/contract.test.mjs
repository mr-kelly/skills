...
const appRoot = join(repoRoot, "skills", "kelly-private-equity-deal", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/pe-valuation-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-private-equity-deal contract validation", async () => {
...
test("kelly-private-equity-deal resource-map alignment", async () => {
...
test("kelly-private-equity-deal no browser secret leaks", async () => {
