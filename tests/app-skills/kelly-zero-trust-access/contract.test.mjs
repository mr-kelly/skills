...
const appRoot = join(repoRoot, "skills", "kelly-zero-trust-access", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/zero-trust-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-zero-trust-access contract validation", async () => {
...
test("kelly-zero-trust-access resource-map alignment", async () => {
...
test("kelly-zero-trust-access no browser secret leaks", async () => {
