...
const appRoot = join(repoRoot, "skills", "kelly-cloud-finops-advisor", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/finops-advisor-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-cloud-finops-advisor contract validation", async () => {
...
test("kelly-cloud-finops-advisor resource-map alignment", async () => {
...
test("kelly-cloud-finops-advisor no browser secret leaks", async () => {
