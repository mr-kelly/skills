...
const appRoot = join(repoRoot, "skills", "kelly-agriculture-crop-yield", "app");
...
test("kelly-agriculture-crop-yield contract validation", async () => {
...
test("kelly-agriculture-crop-yield resource-map alignment", async () => {
...
test("kelly-agriculture-crop-yield no browser secret leaks", async () => {
