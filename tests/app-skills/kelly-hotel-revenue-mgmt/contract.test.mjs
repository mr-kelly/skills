...
const appRoot = join(repoRoot, "skills", "kelly-hotel-revenue-mgmt", "app");
...
test("kelly-hotel-revenue-mgmt contract validation", async () => {
...
test("kelly-hotel-revenue-mgmt resource-map alignment", async () => {
...
test("kelly-hotel-revenue-mgmt no browser secret leaks", async () => {
