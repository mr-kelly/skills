...
const appRoot = join(repoRoot, "skills", "kelly-key-account-plan", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/key-account-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-key-account-plan contract validation", async () => {
...
test("kelly-key-account-plan resource-map alignment", async () => {
...
test("kelly-key-account-plan no browser secret leaks", async () => {
