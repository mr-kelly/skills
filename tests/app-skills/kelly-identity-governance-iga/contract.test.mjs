...
const appRoot = join(repoRoot, "skills", "kelly-identity-governance-iga", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/iga-governance-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-identity-governance-iga contract validation", async () => {
...
test("kelly-identity-governance-iga resource-map alignment", async () => {
...
test("kelly-identity-governance-iga no browser secret leaks", async () => {
