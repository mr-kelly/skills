...
const appRoot = join(repoRoot, "skills", "kelly-container-security", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/container-security-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-container-security contract validation", async () => {
...
test("kelly-container-security resource-map alignment", async () => {
...
test("kelly-container-security no browser secret leaks", async () => {
