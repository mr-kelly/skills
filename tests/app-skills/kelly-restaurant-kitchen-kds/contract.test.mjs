...
const appRoot = join(repoRoot, "skills", "kelly-restaurant-kitchen-kds", "app");
...
test("kelly-restaurant-kitchen-kds contract validation", async () => {
...
test("kelly-restaurant-kitchen-kds resource-map alignment", async () => {
...
test("kelly-restaurant-kitchen-kds no browser secret leaks", async () => {
