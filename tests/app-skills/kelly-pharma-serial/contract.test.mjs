...
const appRoot = join(repoRoot, "skills", "kelly-pharma-serial", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/pharma-serial-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-pharma-serial contract validation", async () => {
...
test("kelly-pharma-serial resource-map alignment", async () => {
...
test("kelly-pharma-serial no browser secret leaks", async () => {
