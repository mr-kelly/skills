...
APP_ROOT = REPO_ROOT / "skills" / "kelly-listing" / "app"
        ...
        with managed_process(
            ...
            with tempfile.TemporaryDirectory(prefix="kelly-listing-home-") as app_home:
                ...
                fixture = next(
                    ...
                    if r.get("headCommit", {}).get("fields", {}).get("draft-id") == "fixture-draft"
                )
            ...
            assert sorted(keys) == sorted(
                ["app-root", "products", "drafts", "checks", "claims", "claim_rules", "settings"]
            ), nodes
