...
const appRoot = join(repoRoot, "skills", "kelly-inventory-reorder", "app");
...
test("kelly-inventory-reorder contract validation", async () => {
...
test("kelly-inventory-reorder resource-map alignment", async () => {
...
test("kelly-inventory-reorder no browser secret leaks", async () => {
