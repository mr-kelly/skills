...
const appRoot = join(repoRoot, "skills", "kelly-vendor-sla", "app");
...
test("kelly-vendor-sla contract validation", async () => {
...
test("kelly-vendor-sla resource-map alignment", async () => {
...
test("kelly-vendor-sla no browser secret leaks", async () => {
