...
const appRoot = join(repoRoot, "skills", "kelly-treasury-desk", "app");
...
test("kelly-treasury-desk contract validation", async () => {
...
test("kelly-treasury-desk resource-map alignment", async () => {
...
test("kelly-treasury-desk no browser secret leaks", async () => {
