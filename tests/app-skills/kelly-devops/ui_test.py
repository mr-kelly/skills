...
APP_ROOT = REPO_ROOT / "skills" / "kelly-devops" / "content" / "kelly-devops-app"
        ...
        with managed_process(
            ...
            with tempfile.TemporaryDirectory(prefix="kelly-devops-home-") as app_home:
                ...
                fixture = next(
                    ...
                    if (r.get("headCommit", {}).get("payload") or r.get("headCommit", {}).get("fields", {})).get("action-id") == "fixture-restart"
                )
            ...
            assert sorted(keys) == sorted(
                ["app-root", "services", "expiries", "spend-providers", "spend-products", "actions", "events", "settings"]
            ), nodes
