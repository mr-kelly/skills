...
const appRoot = join(repoRoot, "skills", "kelly-threat-intel", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/threat-intel-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-threat-intel contract validation", async () => {
...
test("kelly-threat-intel resource-map alignment", async () => {
...
test("kelly-threat-intel no browser secret leaks", async () => {
