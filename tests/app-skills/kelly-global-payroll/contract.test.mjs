...
const appRoot = join(repoRoot, "skills", "kelly-global-payroll", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/global-payroll-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-global-payroll contract validation", async () => {
...
test("kelly-global-payroll resource-map alignment", async () => {
...
test("kelly-global-payroll no browser secret leaks", async () => {
