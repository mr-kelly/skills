...
const appRoot = join(repoRoot, "skills", "kelly-app-analytics", "app");
...
test("kelly-app-analytics contract validation", async () => {
...
test("kelly-app-analytics resource-map alignment", async () => {
...
test("kelly-app-analytics no browser secret leaks", async () => {
