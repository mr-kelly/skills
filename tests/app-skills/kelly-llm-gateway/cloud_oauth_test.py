...
APP_ROOT = REPO_ROOT / "skills" / "kelly-llm-gateway" / "content" / "kelly-llm-gateway-app"
REQUIRED_ENV = (
...
def run_cloud_oauth(config: dict) -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="kelly-llm-gateway-cloud-home-") as app_home:
        env = {
            "HOME": app_home,
            "PORT": str(port),
            "BUSABASE_BASE_URL": "",
