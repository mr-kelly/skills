...
const appRoot = join(repoRoot, "skills", "kelly-mortgage-origination", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/mortgage-origination-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-mortgage-origination contract validation", async () => {
...
test("kelly-mortgage-origination resource-map alignment", async () => {
...
test("kelly-mortgage-origination no browser secret leaks", async () => {
