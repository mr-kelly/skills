...
const appRoot = join(repoRoot, "skills", "kelly-quote-cpq", "app");
...
test("kelly-quote-cpq contract validation", async () => {
...
test("kelly-quote-cpq resource-map alignment", async () => {
...
test("kelly-quote-cpq no browser secret leaks", async () => {
