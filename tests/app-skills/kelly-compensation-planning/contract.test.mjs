...
const appRoot = join(repoRoot, "skills", "kelly-compensation-planning", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/compensation-planning-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-compensation-planning contract validation", async () => {
...
test("kelly-compensation-planning resource-map alignment", async () => {
...
test("kelly-compensation-planning no browser secret leaks", async () => {
