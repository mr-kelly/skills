...
const appRoot = join(repoRoot, "skills", "kelly-procurement-sourcing", "app");
...
test("kelly-procurement-sourcing contract validation", async () => {
...
test("kelly-procurement-sourcing resource-map alignment", async () => {
...
test("kelly-procurement-sourcing no browser secret leaks", async () => {
