...
const appRoot = join(repoRoot, "skills", "kelly-emr-compliance", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/emr-compliance-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-emr-compliance contract validation", async () => {
...
test("kelly-emr-compliance resource-map alignment", async () => {
...
test("kelly-emr-compliance no browser secret leaks", async () => {
