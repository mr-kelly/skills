...
const appRoot = join(repoRoot, "skills", "kelly-gdpr-privacy", "app");
...
test("kelly-gdpr-privacy contract validation", async () => {
...
test("kelly-gdpr-privacy resource-map alignment", async () => {
...
test("kelly-gdpr-privacy no browser secret leaks", async () => {
