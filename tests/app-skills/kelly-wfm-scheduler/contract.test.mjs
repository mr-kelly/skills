...
const appRoot = join(repoRoot, "skills", "kelly-wfm-scheduler", "app");
...
test("kelly-wfm-scheduler contract validation", async () => {
...
test("kelly-wfm-scheduler resource-map alignment", async () => {
...
test("kelly-wfm-scheduler no browser secret leaks", async () => {
