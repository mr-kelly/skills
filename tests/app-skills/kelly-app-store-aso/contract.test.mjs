...
const appRoot = join(repoRoot, "skills", "kelly-app-store-aso", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/app-store-aso-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-app-store-aso contract validation", async () => {
...
test("kelly-app-store-aso resource-map alignment", async () => {
...
test("kelly-app-store-aso no browser secret leaks", async () => {
