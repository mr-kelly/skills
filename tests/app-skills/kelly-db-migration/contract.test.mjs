...
const appRoot = join(repoRoot, "skills", "kelly-db-migration", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/db-migration-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-db-migration contract validation", async () => {
...
test("kelly-db-migration resource-map alignment", async () => {
...
test("kelly-db-migration no browser secret leaks", async () => {
