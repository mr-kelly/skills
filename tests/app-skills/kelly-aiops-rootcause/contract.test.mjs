...
const appRoot = join(repoRoot, "skills", "kelly-aiops-rootcause", "app");
...
test("kelly-aiops-rootcause contract validation", async () => {
...
test("kelly-aiops-rootcause resource-map alignment", async () => {
...
test("kelly-aiops-rootcause no browser secret leaks", async () => {
