...
const appRoot = join(repoRoot, "skills", "kelly-procurement-rfq", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/procurement-rfq-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-procurement-rfq contract validation", async () => {
...
test("kelly-procurement-rfq resource-map alignment", async () => {
...
test("kelly-procurement-rfq no browser secret leaks", async () => {
