...
const appRoot = join(repoRoot, "skills", "kelly-influencer-kol", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/influencer-kol-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-influencer-kol contract validation", async () => {
...
test("kelly-influencer-kol resource-map alignment", async () => {
...
test("kelly-influencer-kol no browser secret leaks", async () => {
