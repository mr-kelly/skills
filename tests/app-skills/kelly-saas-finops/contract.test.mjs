...
const appRoot = join(repoRoot, "skills", "kelly-saas-finops", "app");
...
test("kelly-saas-finops contract validation", async () => {
...
test("kelly-saas-finops resource-map alignment", async () => {
...
test("kelly-saas-finops no browser secret leaks", async () => {
