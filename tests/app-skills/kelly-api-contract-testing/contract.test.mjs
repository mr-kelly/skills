...
const appRoot = join(repoRoot, "skills", "kelly-api-contract-testing", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/api-contract-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-api-contract-testing contract validation", async () => {
...
test("kelly-api-contract-testing resource-map alignment", async () => {
...
test("kelly-api-contract-testing no browser secret leaks", async () => {
