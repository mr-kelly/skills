...
const appRoot = join(repoRoot, "skills", "kelly-higher-ed-admissions", "app");
...
test("kelly-higher-ed-admissions contract validation", async () => {
...
test("kelly-higher-ed-admissions resource-map alignment", async () => {
...
test("kelly-higher-ed-admissions no browser secret leaks", async () => {
