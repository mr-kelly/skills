...
const appRoot = join(repoRoot, "skills", "kelly-iam-audit", "app");
...
test("kelly-iam-audit contract validation", async () => {
...
test("kelly-iam-audit resource-map alignment", async () => {
...
test("kelly-iam-audit no browser secret leaks", async () => {
