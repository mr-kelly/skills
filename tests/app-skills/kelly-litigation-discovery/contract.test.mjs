...
const appRoot = join(repoRoot, "skills", "kelly-litigation-discovery", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/litigation-discovery-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-litigation-discovery contract validation", async () => {
...
test("kelly-litigation-discovery resource-map alignment", async () => {
...
test("kelly-litigation-discovery no browser secret leaks", async () => {
