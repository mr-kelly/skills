...
const appRoot = join(repoRoot, "skills", "kelly-partner-channel", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/partner-channel-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-partner-channel contract validation", async () => {
...
test("kelly-partner-channel resource-map alignment", async () => {
...
test("kelly-partner-channel no browser secret leaks", async () => {
