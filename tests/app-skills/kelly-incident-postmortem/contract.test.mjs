...
const appRoot = join(repoRoot, "skills", "kelly-incident-postmortem", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/incident-postmortem-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-incident-postmortem contract validation", async () => {
...
test("kelly-incident-postmortem resource-map alignment", async () => {
...
test("kelly-incident-postmortem no browser secret leaks", async () => {
