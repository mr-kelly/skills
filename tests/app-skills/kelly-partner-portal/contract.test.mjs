...
const appRoot = join(repoRoot, "skills", "kelly-partner-portal", "app");
...
test("kelly-partner-portal contract validation", async () => {
...
test("kelly-partner-portal resource-map alignment", async () => {
...
test("kelly-partner-portal no browser secret leaks", async () => {
