...
const appRoot = join(repoRoot, "skills", "kelly-cloud-migration", "app");
...
test("kelly-cloud-migration contract validation", async () => {
...
test("kelly-cloud-migration resource-map alignment", async () => {
...
test("kelly-cloud-migration no browser secret leaks", async () => {
