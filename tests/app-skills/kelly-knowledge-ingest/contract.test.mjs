...
const appRoot = join(repoRoot, "skills", "kelly-knowledge-ingest", "app");
...
test("kelly-knowledge-ingest contract validation", async () => {
...
test("kelly-knowledge-ingest resource-map alignment", async () => {
...
test("kelly-knowledge-ingest no browser secret leaks", async () => {
