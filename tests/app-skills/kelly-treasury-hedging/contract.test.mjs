...
const appRoot = join(repoRoot, "skills", "kelly-treasury-hedging", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/treasury-hedging-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-treasury-hedging contract validation", async () => {
...
test("kelly-treasury-hedging resource-map alignment", async () => {
...
test("kelly-treasury-hedging no browser secret leaks", async () => {
