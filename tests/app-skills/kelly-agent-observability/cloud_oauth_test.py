...
APP_ROOT = REPO_ROOT / "skills" / "kelly-agent-observability" / "content" / "kelly-agent-observability-app"
REQUIRED_ENV = (
...
def run_cloud_oauth(config: dict) -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="kelly-agent-observability-cloud-home-") as app_home:
        env = {
            "HOME": app_home,
            "PORT": str(port),
            "BUSABASE_BASE_URL": "",
