...
const appRoot = join(repoRoot, "skills", "kelly-customer-cdp-segment", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/cdp-segment-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-customer-cdp-segment contract validation", async () => {
...
test("kelly-customer-cdp-segment resource-map alignment", async () => {
...
test("kelly-customer-cdp-segment no browser secret leaks", async () => {
