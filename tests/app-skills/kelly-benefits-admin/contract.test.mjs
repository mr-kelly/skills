...
const appRoot = join(repoRoot, "skills", "kelly-benefits-admin", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/benefits-admin-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-benefits-admin contract validation", async () => {
...
test("kelly-benefits-admin resource-map alignment", async () => {
...
test("kelly-benefits-admin no browser secret leaks", async () => {
