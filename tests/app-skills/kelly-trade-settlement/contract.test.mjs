...
const appRoot = join(repoRoot, "skills", "kelly-trade-settlement", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/trade-settlement-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-trade-settlement contract validation", async () => {
...
test("kelly-trade-settlement resource-map alignment", async () => {
...
test("kelly-trade-settlement no browser secret leaks", async () => {
