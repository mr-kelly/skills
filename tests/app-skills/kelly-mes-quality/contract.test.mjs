...
const appRoot = join(repoRoot, "skills", "kelly-mes-quality", "app");
...
const requiredFiles = [
  ...
  "app/app.js",
  "app/js/config.js",
  "app/js/mes-quality-model.js",
];

const readJson = async (path) => JSON.parse(await readFile(path, "utf8"));

test("kelly-mes-quality contract validation", async () => {
...
test("kelly-mes-quality resource-map alignment", async () => {
...
test("kelly-mes-quality no browser secret leaks", async () => {
