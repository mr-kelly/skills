...
const appRoot = join(repoRoot, "skills", "kelly-hr-onboarding", "app");
...
test("kelly-hr-onboarding contract validation", async () => {
...
test("kelly-hr-onboarding resource-map alignment", async () => {
...
test("kelly-hr-onboarding no browser secret leaks", async () => {
